...
from digital_ocean_python_sdk.model.image_actions_post_request import ImageActionsPostRequest as ImageActionsPostRequestSchema
from digital_ocean_python_sdk.model.action import Action as ActionSchema
...
from digital_ocean_python_sdk.type.action import Action
from digital_ocean_python_sdk.type.image_actions_post_request import ImageActionsPostRequest
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.action import Action as ActionPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.image_actions_post_request import ImageActionsPostRequest as ImageActionsPostRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ImageActionsPostRequestSchema


request_body_image_actions_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ActionSchema
...
class BaseApi(api_client.Api):
    ...
    def _post_mapped_args(
        ...
        body: typing.Optional[ImageActionsPostRequest] = None,
    ...
    async def _apost_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_image_actions_post_request.serialize(body, content_type)
...
class Post(BaseApi):
    ...
    async def apost(
        ...
        **kwargs,
        ...
        if validate:
            return ActionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ActionPydantic, raw_response.body)
