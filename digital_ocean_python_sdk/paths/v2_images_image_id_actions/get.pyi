...
from digital_ocean_python_sdk.model.image_actions_list_response import ImageActionsListResponse as ImageActionsListResponseSchema

from digital_ocean_python_sdk.type.image_actions_list_response import ImageActionsListResponse
...
from digital_ocean_python_sdk.pydantic.image_actions_list_response import ImageActionsListResponse as ImageActionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImageActionsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImageActionsListResponsePydantic:
        raw_response = await self.raw.alist(
            image_id=image_id,
            **kwargs,
        )
        if validate:
            return RootModel[ImageActionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ImageActionsListResponsePydantic, raw_response.body)
