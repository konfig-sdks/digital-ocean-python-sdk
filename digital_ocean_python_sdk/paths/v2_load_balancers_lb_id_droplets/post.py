...
from digital_ocean_python_sdk.model.load_balancers_assign_droplets_request import LoadBalancersAssignDropletsRequest as LoadBalancersAssignDropletsRequestSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.load_balancers_assign_droplets_request import LoadBalancersAssignDropletsRequest
...
from digital_ocean_python_sdk.pydantic.load_balancers_assign_droplets_request import LoadBalancersAssignDropletsRequest as LoadBalancersAssignDropletsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancersAssignDropletsRequestSchema


request_body_load_balancers_assign_droplets_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _assign_droplets_mapped_args(
        self,
    ...
    async def _aassign_droplets_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_load_balancers_assign_droplets_request.serialize(body, content_type)
...
class AssignDropletsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_droplets(
        self,
        droplet_ids: typing.List[int],
        lb_id: str,
        **kwargs,
        ...
        args = self._assign_droplets_mapped_args(
            body=body,
            droplet_ids=droplet_ids,
            lb_id=lb_id,
        )
        return await self._aassign_droplets_oapg(
            body=args.body,
    ...
    def assign_droplets(
        ...
        return self._assign_droplets_oapg(
            body=args.body,
            path_params=args.path,
        )

class AssignDroplets(BaseApi):
    ...
    async def aassign_droplets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aassign_droplets(
            body=body,
            droplet_ids=droplet_ids,
            lb_id=lb_id,
            **kwargs,
    ...
    def assign_droplets(
        ...
        raw_response = self.raw.assign_droplets(
            body=body,
            droplet_ids=droplet_ids,
            lb_id=lb_id,
        )
