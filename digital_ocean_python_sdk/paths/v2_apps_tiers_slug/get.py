...
from digital_ocean_python_sdk.model.apps_get_tier_response import AppsGetTierResponse as AppsGetTierResponseSchema

from digital_ocean_python_sdk.type.apps_get_tier_response import AppsGetTierResponse
...
from digital_ocean_python_sdk.pydantic.apps_get_tier_response import AppsGetTierResponse as AppsGetTierResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsGetTierResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_tier_info_mapped_args(
        self,
        slug: str,
    ...
    async def _aget_tier_info_oapg(
        self,
...
class GetTierInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tier_info(
        self,
        slug: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_tier_info_mapped_args(
            slug=slug,
        )
        return await self._aget_tier_info_oapg(
    ...
    def get_tier_info(
        ...
        return self._get_tier_info_oapg(
            path_params=args.path,
        )

class GetTierInfo(BaseApi):
    ...
    async def aget_tier_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsGetTierResponsePydantic:
        raw_response = await self.raw.aget_tier_info(
            slug=slug,
            **kwargs,
        )
        if validate:
            return AppsGetTierResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsGetTierResponsePydantic, raw_response.body)
    ...
    def get_tier_info(
        ...
        raw_response = self.raw.get_tier_info(
            slug=slug,
        )
        if validate:
            return AppsGetTierResponsePydantic(**raw_response.body)
