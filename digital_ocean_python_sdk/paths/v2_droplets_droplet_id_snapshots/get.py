...
from digital_ocean_python_sdk.model.droplets_list_snapshots_response import DropletsListSnapshotsResponse as DropletsListSnapshotsResponseSchema

from digital_ocean_python_sdk.type.droplets_list_snapshots_response import DropletsListSnapshotsResponse
...
from digital_ocean_python_sdk.pydantic.droplets_list_snapshots_response import DropletsListSnapshotsResponse as DropletsListSnapshotsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListSnapshotsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListSnapshotsResponse
...
class ListSnapshots(BaseApi):
    ...
    async def alist_snapshots(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListSnapshotsResponsePydantic:
        ...
        if validate:
            return RootModel[DropletsListSnapshotsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListSnapshotsResponsePydantic, raw_response.body)
