...
request_path_manifest_digest = api_client.PathParameter(
    name="manifest_digest",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ManifestDigestSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _delete_repository_manifest_by_digest_mapped_args(
        self,
        registry_name: str,
        repository_name: str,
        manifest_digest: str,
        ...
        if manifest_digest is not None:
            _path_params["manifest_digest"] = manifest_digest
        args.path = _path_params
        return args

    async def _adelete_repository_manifest_by_digest_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/registry/{registry_name}/repositories/{repository_name}/digests/{manifest_digest}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_repository_manifest_by_digest_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteRepositoryManifestByDigestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_repository_manifest_by_digest(
        self,
        registry_name: str,
        repository_name: str,
        manifest_digest: str,
        **kwargs,
        ...
        args = self._delete_repository_manifest_by_digest_mapped_args(
            registry_name=registry_name,
            repository_name=repository_name,
            manifest_digest=manifest_digest,
        )
        return await self._adelete_repository_manifest_by_digest_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_repository_manifest_by_digest(
        self,
        registry_name: str,
        repository_name: str,
        manifest_digest: str,
        ...
        return self._delete_repository_manifest_by_digest_oapg(
            path_params=args.path,
        )

class DeleteRepositoryManifestByDigest(BaseApi):
    ...
    async def adelete_repository_manifest_by_digest(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_repository_manifest_by_digest(
            registry_name=registry_name,
            repository_name=repository_name,
            manifest_digest=manifest_digest,
            **kwargs,
    ...
    def delete_repository_manifest_by_digest(
        ...
        raw_response = self.raw.delete_repository_manifest_by_digest(
            registry_name=registry_name,
            repository_name=repository_name,
            manifest_digest=manifest_digest,
        )
