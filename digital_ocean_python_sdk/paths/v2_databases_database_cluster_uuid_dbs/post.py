...
from digital_ocean_python_sdk.model.database import Database as DatabaseSchema
from digital_ocean_python_sdk.model.databases_add_response import DatabasesAddResponse as DatabasesAddResponseSchema

from digital_ocean_python_sdk.type.databases_add_response import DatabasesAddResponse
from digital_ocean_python_sdk.type.database import Database
...
from digital_ocean_python_sdk.pydantic.database import Database as DatabasePydantic
from digital_ocean_python_sdk.pydantic.databases_add_response import DatabasesAddResponse as DatabasesAddResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabaseSchema


request_body_database = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DatabasesAddResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aadd_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_database.serialize(body, content_type)
...
class Add(BaseApi):
    ...
    async def aadd(
        ...
        **kwargs,
        ...
        if validate:
            return DatabasesAddResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesAddResponsePydantic, raw_response.body)
