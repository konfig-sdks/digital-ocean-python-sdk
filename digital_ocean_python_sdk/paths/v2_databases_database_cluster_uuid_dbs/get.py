...
from digital_ocean_python_sdk.model.databases_list_response import DatabasesListResponse as DatabasesListResponseSchema

from digital_ocean_python_sdk.type.databases_list_response import DatabasesListResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_response import DatabasesListResponse as DatabasesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListResponsePydantic:
        raw_response = await self.raw.alist(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListResponsePydantic, raw_response.body)
