...
from digital_ocean_python_sdk.model.clusterlint_results import ClusterlintResults as ClusterlintResultsSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.clusterlint_results import ClusterlintResults
...
from digital_ocean_python_sdk.pydantic.clusterlint_results import ClusterlintResults as ClusterlintResultsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ClusterlintResultsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_cluster_lint_diagnostics_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _aget_cluster_lint_diagnostics_oapg(
        self,
    ...
    def _get_cluster_lint_diagnostics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetClusterLintDiagnosticsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cluster_lint_diagnostics(
        self,
        cluster_id: str,
        run_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_cluster_lint_diagnostics_mapped_args(
            cluster_id=cluster_id,
            run_id=run_id,
        )
        return await self._aget_cluster_lint_diagnostics_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_cluster_lint_diagnostics(
        self,
        cluster_id: str,
        run_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_cluster_lint_diagnostics_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetClusterLintDiagnostics(BaseApi):
    ...
    async def aget_cluster_lint_diagnostics(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ClusterlintResultsPydantic:
        raw_response = await self.raw.aget_cluster_lint_diagnostics(
            cluster_id=cluster_id,
            run_id=run_id,
            **kwargs,
        )
        if validate:
            return ClusterlintResultsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ClusterlintResultsPydantic, raw_response.body)
    ...
    def get_cluster_lint_diagnostics(
        ...
        raw_response = self.raw.get_cluster_lint_diagnostics(
            cluster_id=cluster_id,
            run_id=run_id,
        )
        if validate:
