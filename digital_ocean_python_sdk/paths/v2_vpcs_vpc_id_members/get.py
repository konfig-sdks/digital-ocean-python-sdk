...
from digital_ocean_python_sdk.model.vp_cs_list_members_response import VpCsListMembersResponse as VpCsListMembersResponseSchema

from digital_ocean_python_sdk.type.vp_cs_list_members_response import VpCsListMembersResponse
...
from digital_ocean_python_sdk.pydantic.vp_cs_list_members_response import VpCsListMembersResponse as VpCsListMembersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VpCsListMembersResponseSchema
...
class ListMembers(BaseApi):
    ...
    async def alist_members(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VpCsListMembersResponsePydantic:
        ...
        if validate:
            return RootModel[VpCsListMembersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VpCsListMembersResponsePydantic, raw_response.body)
