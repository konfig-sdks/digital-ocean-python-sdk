...
request_path_repository_tag = api_client.PathParameter(
    name="repository_tag",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RepositoryTagSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _delete_repository_tag_mapped_args(
        self,
        registry_name: str,
        repository_name: str,
        repository_tag: str,
        ...
        if repository_tag is not None:
            _path_params["repository_tag"] = repository_tag
        args.path = _path_params
        return args

    async def _adelete_repository_tag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/registry/{registry_name}/repositories/{repository_name}/tags/{repository_tag}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_repository_tag_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteRepositoryTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_repository_tag(
        self,
        registry_name: str,
        repository_name: str,
        repository_tag: str,
        **kwargs,
        ...
        args = self._delete_repository_tag_mapped_args(
            registry_name=registry_name,
            repository_name=repository_name,
            repository_tag=repository_tag,
        )
        return await self._adelete_repository_tag_oapg(
    ...
    def delete_repository_tag(
        ...
        return self._delete_repository_tag_oapg(
            path_params=args.path,
        )

class DeleteRepositoryTag(BaseApi):
    ...
    async def adelete_repository_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_repository_tag(
            registry_name=registry_name,
            repository_name=repository_name,
            repository_tag=repository_tag,
            **kwargs,
    ...
    def delete_repository_tag(
        ...
        raw_response = self.raw.delete_repository_tag(
            registry_name=registry_name,
            repository_name=repository_name,
            repository_tag=repository_tag,
        )
