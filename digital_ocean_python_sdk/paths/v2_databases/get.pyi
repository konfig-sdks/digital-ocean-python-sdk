...
from digital_ocean_python_sdk.model.databases_list_clusters_response import DatabasesListClustersResponse as DatabasesListClustersResponseSchema

from digital_ocean_python_sdk.type.databases_list_clusters_response import DatabasesListClustersResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_clusters_response import DatabasesListClustersResponse as DatabasesListClustersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListClustersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListClustersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_clusters_mapped_args(
        self,
    ...
    async def _alist_clusters_oapg(
        self,
...
class ListClustersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_clusters(
        self,
        tag_name: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_clusters_mapped_args(
            tag_name=tag_name,
        )
        return await self._alist_clusters_oapg(
...
class ListClusters(BaseApi):
    ...
    async def alist_clusters(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListClustersResponsePydantic:
        raw_response = await self.raw.alist_clusters(
            tag_name=tag_name,
            **kwargs,
        )
        if validate:
            return DatabasesListClustersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListClustersResponsePydantic, raw_response.body)
    ...
    def list_clusters(
        ...
        raw_response = self.raw.list_clusters(
            tag_name=tag_name,
        )
        if validate:
            return DatabasesListClustersResponsePydantic(**raw_response.body)
