...
from digital_ocean_python_sdk.model.firewalls_remove_droplets_request import FirewallsRemoveDropletsRequest as FirewallsRemoveDropletsRequestSchema

from digital_ocean_python_sdk.type.firewalls_remove_droplets_request import FirewallsRemoveDropletsRequest
...
from digital_ocean_python_sdk.pydantic.firewalls_remove_droplets_request import FirewallsRemoveDropletsRequest as FirewallsRemoveDropletsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsRemoveDropletsRequestSchema


request_body_firewalls_remove_droplets_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_droplets_mapped_args(
        self,
        droplet_ids: typing.List[int],
        firewall_id: str,
    ...
    async def _aremove_droplets_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_remove_droplets_request.serialize(body, content_type)
...
class RemoveDropletsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_droplets(
        self,
        droplet_ids: typing.List[int],
        firewall_id: str,
        **kwargs,
        ...
        args = self._remove_droplets_mapped_args(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
        )
        return await self._aremove_droplets_oapg(
            body=args.body,
    ...
    def remove_droplets(
        ...
        return self._remove_droplets_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveDroplets(BaseApi):
    ...
    async def aremove_droplets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_droplets(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
            **kwargs,
    ...
    def remove_droplets(
        ...
        raw_response = self.raw.remove_droplets(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
        )
