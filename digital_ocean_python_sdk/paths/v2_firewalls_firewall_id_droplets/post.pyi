...
from digital_ocean_python_sdk.model.firewalls_add_droplets_request import FirewallsAddDropletsRequest as FirewallsAddDropletsRequestSchema

from digital_ocean_python_sdk.type.firewalls_add_droplets_request import FirewallsAddDropletsRequest
...
from digital_ocean_python_sdk.pydantic.firewalls_add_droplets_request import FirewallsAddDropletsRequest as FirewallsAddDropletsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsAddDropletsRequestSchema


request_body_firewalls_add_droplets_request = api_client.RequestBody(
    content={
    ...
    async def _aadd_droplets_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_add_droplets_request.serialize(body, content_type)
...
class AddDropletsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_droplets(
        self,
        droplet_ids: typing.List[int],
        firewall_id: str,
        **kwargs,
        ...
        args = self._add_droplets_mapped_args(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
        )
        return await self._aadd_droplets_oapg(
            body=args.body,
    ...
    def add_droplets(
        ...
        return self._add_droplets_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddDroplets(BaseApi):
    ...
    async def aadd_droplets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_droplets(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
            **kwargs,
    ...
    def add_droplets(
        ...
        raw_response = self.raw.add_droplets(
            body=body,
            droplet_ids=droplet_ids,
            firewall_id=firewall_id,
        )
