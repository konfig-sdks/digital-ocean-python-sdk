...
from digital_ocean_python_sdk.model.tags_get_response import TagsGetResponse as TagsGetResponseSchema
...
from digital_ocean_python_sdk.type.tags_get_response import TagsGetResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.tags_get_response import TagsGetResponse as TagsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagsGetResponsePydantic:
        raw_response = await self.raw.aget(
            tag_id=tag_id,
            **kwargs,
        )
        if validate:
            return TagsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsGetResponsePydantic, raw_response.body)
