...
from digital_ocean_python_sdk.model.app_metrics_bandwidth_usage_request_app_ids import AppMetricsBandwidthUsageRequestAppIds as AppMetricsBandwidthUsageRequestAppIdsSchema
from digital_ocean_python_sdk.model.app_metrics_bandwidth_usage import AppMetricsBandwidthUsage as AppMetricsBandwidthUsageSchema
from digital_ocean_python_sdk.model.app_metrics_bandwidth_usage_request import AppMetricsBandwidthUsageRequest as AppMetricsBandwidthUsageRequestSchema

from digital_ocean_python_sdk.type.app_metrics_bandwidth_usage_request_app_ids import AppMetricsBandwidthUsageRequestAppIds
from digital_ocean_python_sdk.type.app_metrics_bandwidth_usage import AppMetricsBandwidthUsage
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.app_metrics_bandwidth_usage_request import AppMetricsBandwidthUsageRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.app_metrics_bandwidth_usage_request import AppMetricsBandwidthUsageRequest as AppMetricsBandwidthUsageRequestPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.app_metrics_bandwidth_usage_request_app_ids import AppMetricsBandwidthUsageRequestAppIds as AppMetricsBandwidthUsageRequestAppIdsPydantic
from digital_ocean_python_sdk.pydantic.app_metrics_bandwidth_usage import AppMetricsBandwidthUsage as AppMetricsBandwidthUsagePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AppMetricsBandwidthUsageRequestSchema


request_body_app_metrics_bandwidth_usage_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppMetricsBandwidthUsageSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_multiple_daily_metrics_mapped_args(
        self,
        app_ids: AppMetricsBandwidthUsageRequestAppIds,
    ...
    async def _aget_multiple_daily_metrics_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_app_metrics_bandwidth_usage_request.serialize(body, content_type)
    ...
    def _get_multiple_daily_metrics_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMultipleDailyMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_multiple_daily_metrics(
        self,
        app_ids: AppMetricsBandwidthUsageRequestAppIds,
        date: typing.Optional[datetime] = None,
        **kwargs,
        ...
        args = self._get_multiple_daily_metrics_mapped_args(
            app_ids=app_ids,
            date=date,
        )
        return await self._aget_multiple_daily_metrics_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_multiple_daily_metrics(
        self,
        app_ids: AppMetricsBandwidthUsageRequestAppIds,
        date: typing.Optional[datetime] = None,
    ) -> typing.Union[
        ...
        return self._get_multiple_daily_metrics_oapg(
            body=args.body,
        )

class GetMultipleDailyMetrics(BaseApi):
    ...
    async def aget_multiple_daily_metrics(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppMetricsBandwidthUsagePydantic:
        raw_response = await self.raw.aget_multiple_daily_metrics(
            app_ids=app_ids,
            date=date,
            **kwargs,
        )
        if validate:
            return AppMetricsBandwidthUsagePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppMetricsBandwidthUsagePydantic, raw_response.body)
    ...
    def get_multiple_daily_metrics(
        ...
        raw_response = self.raw.get_multiple_daily_metrics(
            app_ids=app_ids,
            date=date,
        )
        if validate:
