...
class BaseApi(api_client.Api):
    ...
    def _destroy_cluster_mapped_args(
        self,
    ...
    async def _adestroy_cluster_oapg(
        self,
...
class DestroyClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adestroy_cluster(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._destroy_cluster_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._adestroy_cluster_oapg(
    ...
    def destroy_cluster(
        ...
        return self._destroy_cluster_oapg(
            path_params=args.path,
        )

class DestroyCluster(BaseApi):
    ...
    async def adestroy_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adestroy_cluster(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
    ...
    def destroy_cluster(
        ...
        raw_response = self.raw.destroy_cluster(
            database_cluster_uuid=database_cluster_uuid,
        )
