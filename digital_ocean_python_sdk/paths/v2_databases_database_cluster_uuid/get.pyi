...
SchemaFor200ResponseBodyApplicationJson = DatabasesCreateClusterResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_cluster_info_mapped_args(
        self,
    ...
    async def _aget_cluster_info_oapg(
        self,
...
class GetClusterInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cluster_info(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_cluster_info_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_cluster_info_oapg(
    ...
    def get_cluster_info(
        ...
        return self._get_cluster_info_oapg(
            path_params=args.path,
        )

class GetClusterInfo(BaseApi):
    ...
    async def aget_cluster_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cluster_info(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
    ...
    def get_cluster_info(
        ...
        raw_response = self.raw.get_cluster_info(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesCreateClusterResponsePydantic(**raw_response.body)
