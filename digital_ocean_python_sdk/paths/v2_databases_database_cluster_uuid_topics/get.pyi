...
from digital_ocean_python_sdk.model.databases_list_topics_kafka_cluster_response import DatabasesListTopicsKafkaClusterResponse as DatabasesListTopicsKafkaClusterResponseSchema

from digital_ocean_python_sdk.type.databases_list_topics_kafka_cluster_response import DatabasesListTopicsKafkaClusterResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_topics_kafka_cluster_response import DatabasesListTopicsKafkaClusterResponse as DatabasesListTopicsKafkaClusterResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListTopicsKafkaClusterResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListTopicsKafkaClusterResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_topics_kafka_cluster_mapped_args(
        self,
    ...
    async def _alist_topics_kafka_cluster_oapg(
        self,
    ...
    def _list_topics_kafka_cluster_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListTopicsKafkaClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_topics_kafka_cluster(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_topics_kafka_cluster_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_topics_kafka_cluster_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_topics_kafka_cluster(
        self,
        database_cluster_uuid: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_topics_kafka_cluster_oapg(
            path_params=args.path,
        )

class ListTopicsKafkaCluster(BaseApi):
    ...
    async def alist_topics_kafka_cluster(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListTopicsKafkaClusterResponsePydantic:
        raw_response = await self.raw.alist_topics_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListTopicsKafkaClusterResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListTopicsKafkaClusterResponsePydantic, raw_response.body)
    ...
    def list_topics_kafka_cluster(
        ...
        raw_response = self.raw.list_topics_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesListTopicsKafkaClusterResponsePydantic(**raw_response.body)
