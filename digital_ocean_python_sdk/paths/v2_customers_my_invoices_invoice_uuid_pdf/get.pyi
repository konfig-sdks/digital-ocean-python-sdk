...
class BaseApi(api_client.Api):
    ...
    def _get_pdf_by_uuid_mapped_args(
        self,
        invoice_uuid: str,
    ...
    async def _aget_pdf_by_uuid_oapg(
        self,
...
class GetPdfByUuidRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pdf_by_uuid(
        self,
        invoice_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_pdf_by_uuid_mapped_args(
            invoice_uuid=invoice_uuid,
        )
        return await self._aget_pdf_by_uuid_oapg(
    ...
    def get_pdf_by_uuid(
        ...
        return self._get_pdf_by_uuid_oapg(
            path_params=args.path,
        )

class GetPdfByUuid(BaseApi):
    ...
    async def aget_pdf_by_uuid(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pdf_by_uuid(
            invoice_uuid=invoice_uuid,
            **kwargs,
        )
        if validate:
    ...
    def get_pdf_by_uuid(
        ...
        raw_response = self.raw.get_pdf_by_uuid(
            invoice_uuid=invoice_uuid,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
