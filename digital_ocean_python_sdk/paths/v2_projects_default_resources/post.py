...
from digital_ocean_python_sdk.model.project_assignment import ProjectAssignment as ProjectAssignmentSchema
from digital_ocean_python_sdk.model.project_resources_assign_to_project_response import ProjectResourcesAssignToProjectResponse as ProjectResourcesAssignToProjectResponseSchema

from digital_ocean_python_sdk.type.project_resources_assign_to_project_response import ProjectResourcesAssignToProjectResponse
from digital_ocean_python_sdk.type.project_assignment import ProjectAssignment
...
from digital_ocean_python_sdk.pydantic.project_assignment import ProjectAssignment as ProjectAssignmentPydantic
from digital_ocean_python_sdk.pydantic.project_resources_assign_to_project_response import ProjectResourcesAssignToProjectResponse as ProjectResourcesAssignToProjectResponsePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ProjectAssignmentSchema


request_body_project_assignment = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectResourcesAssignToProjectResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectResourcesAssignToProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _assign_resources_to_default_mapped_args(
        self,
        resources: typing.Optional[typing.List[Urn]] = None,
    ...
    async def _aassign_resources_to_default_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_project_assignment.serialize(body, content_type)
    ...
    def _assign_resources_to_default_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AssignResourcesToDefaultRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_resources_to_default(
        self,
        resources: typing.Optional[typing.List[Urn]] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._assign_resources_to_default_mapped_args(
            resources=resources,
        )
        return await self._aassign_resources_to_default_oapg(
            body=args.body,
            **kwargs,
        )
    
    def assign_resources_to_default(
        self,
        resources: typing.Optional[typing.List[Urn]] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._assign_resources_to_default_oapg(
            body=args.body,
        )

class AssignResourcesToDefault(BaseApi):
    ...
    async def aassign_resources_to_default(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectResourcesAssignToProjectResponsePydantic:
        raw_response = await self.raw.aassign_resources_to_default(
            resources=resources,
            **kwargs,
        )
        if validate:
            return ProjectResourcesAssignToProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectResourcesAssignToProjectResponsePydantic, raw_response.body)
    ...
    def assign_resources_to_default(
        ...
        raw_response = self.raw.assign_resources_to_default(
            resources=resources,
        )
        if validate:
            return ProjectResourcesAssignToProjectResponsePydantic(**raw_response.body)
