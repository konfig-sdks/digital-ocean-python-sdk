...
from digital_ocean_python_sdk.model.project_resources_list_response import ProjectResourcesListResponse as ProjectResourcesListResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.project_resources_list_response import ProjectResourcesListResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.project_resources_list_response import ProjectResourcesListResponse as ProjectResourcesListResponsePydantic

RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = ProjectResourcesListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectResourcesListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_default_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_default_oapg(
        self,
...
class ListDefaultRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_default(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_default_mapped_args(
        )
        return await self._alist_default_oapg(
            **kwargs,
        )
    ...
    def list_default(
        ...
        return self._list_default_oapg(
        )

class ListDefault(BaseApi):

    async def alist_default(
        self,
        validate: bool = False,
        **kwargs,
    ) -> ProjectResourcesListResponsePydantic:
        raw_response = await self.raw.alist_default(
            **kwargs,
        )
        if validate:
            return RootModel[ProjectResourcesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProjectResourcesListResponsePydantic, raw_response.body)
    ...
    def list_default(
        ...
        raw_response = self.raw.list_default(
        )
        if validate:
            return RootModel[ProjectResourcesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProjectResourcesListResponsePydantic, raw_response.body)
