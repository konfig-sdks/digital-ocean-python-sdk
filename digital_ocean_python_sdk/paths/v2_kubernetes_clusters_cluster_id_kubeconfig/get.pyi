...
class BaseApi(api_client.Api):
    ...
    def _get_kubeconfig_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _aget_kubeconfig_oapg(
        self,
...
class GetKubeconfigRaw(BaseApi):
    ...
    async def aget_kubeconfig(
        ...
        **kwargs,
        ...
        args = self._get_kubeconfig_mapped_args(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
        )
        return await self._aget_kubeconfig_oapg(
    ...
    def get_kubeconfig(
        ...
        return self._get_kubeconfig_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetKubeconfig(BaseApi):
    ...
    async def aget_kubeconfig(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_kubeconfig(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
            **kwargs,
        )
    ...
    def get_kubeconfig(
        ...
        raw_response = self.raw.get_kubeconfig(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
        )
