...
from digital_ocean_python_sdk.model.databases_list_events_logs_response import DatabasesListEventsLogsResponse as DatabasesListEventsLogsResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.databases_list_events_logs_response import DatabasesListEventsLogsResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_events_logs_response import DatabasesListEventsLogsResponse as DatabasesListEventsLogsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListEventsLogsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListEventsLogsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_events_logs_mapped_args(
        self,
    ...
    async def _alist_events_logs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/databases/{database_cluster_uuid}/events',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListEventsLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_events_logs(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_events_logs_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_events_logs_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_events_logs(
        self,
        database_cluster_uuid: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_events_logs_oapg(
            path_params=args.path,
        )

class ListEventsLogs(BaseApi):
    ...
    async def alist_events_logs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListEventsLogsResponsePydantic:
        raw_response = await self.raw.alist_events_logs(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListEventsLogsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListEventsLogsResponsePydantic, raw_response.body)
    ...
    def list_events_logs(
        ...
        raw_response = self.raw.list_events_logs(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesListEventsLogsResponsePydantic(**raw_response.body)
