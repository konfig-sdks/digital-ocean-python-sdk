...
class BaseApi(api_client.Api):
    ...
    def _get_app_restart_count_metrics_mapped_args(
        self,
        app_id: str,
        start: str,
        end: str,
    ...
    async def _aget_app_restart_count_metrics_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/monitoring/metrics/apps/restart_count',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_app_restart_count_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAppRestartCountMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_app_restart_count_metrics(
        self,
        app_id: str,
        start: str,
        end: str,
        ...
        **kwargs,
        ...
        args = self._get_app_restart_count_metrics_mapped_args(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
        )
        return await self._aget_app_restart_count_metrics_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_app_restart_count_metrics(
        self,
        app_id: str,
        start: str,
        end: str,
        ...
        return self._get_app_restart_count_metrics_oapg(
            query_params=args.query,
        )

class GetAppRestartCountMetrics(BaseApi):
    ...
    async def aget_app_restart_count_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_app_restart_count_metrics(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
    ...
    def get_app_restart_count_metrics(
        ...
        raw_response = self.raw.get_app_restart_count_metrics(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
