...
from digital_ocean_python_sdk.model.databases_list_backups_response import DatabasesListBackupsResponse as DatabasesListBackupsResponseSchema

from digital_ocean_python_sdk.type.databases_list_backups_response import DatabasesListBackupsResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_backups_response import DatabasesListBackupsResponse as DatabasesListBackupsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListBackupsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListBackupsResponse
...
class ListBackupsRaw(BaseApi):
    ...
    async def alist_backups(
        ...
        **kwargs,
        ...
        args = self._list_backups_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_backups_oapg(
...
class ListBackups(BaseApi):
    ...
    async def alist_backups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListBackupsResponsePydantic:
        raw_response = await self.raw.alist_backups(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListBackupsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListBackupsResponsePydantic, raw_response.body)
    ...
    def list_backups(
        ...
        raw_response = self.raw.list_backups(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesListBackupsResponsePydantic(**raw_response.body)
