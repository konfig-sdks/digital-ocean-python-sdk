...
class BaseApi(api_client.Api):
    ...
    def _get_namespace_details_mapped_args(
        self,
        namespace_id: str,
    ...
    async def _aget_namespace_details_oapg(
        self,
    ...
    def _get_namespace_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetNamespaceDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_namespace_details(
        self,
        namespace_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_namespace_details_mapped_args(
            namespace_id=namespace_id,
        )
        return await self._aget_namespace_details_oapg(
    ...
    def get_namespace_details(
        ...
        return self._get_namespace_details_oapg(
            path_params=args.path,
        )

class GetNamespaceDetails(BaseApi):
    ...
    async def aget_namespace_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_namespace_details(
            namespace_id=namespace_id,
            **kwargs,
        )
        if validate:
    ...
    def get_namespace_details(
        ...
        raw_response = self.raw.get_namespace_details(
            namespace_id=namespace_id,
        )
        if validate:
            return FunctionsCreateNamespaceResponsePydantic(**raw_response.body)
