...
class BaseApi(api_client.Api):
    ...
    def _delete_namespace_mapped_args(
        self,
        namespace_id: str,
    ...
    async def _adelete_namespace_oapg(
        self,
...
class DeleteNamespaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_namespace(
        self,
        namespace_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_namespace_mapped_args(
            namespace_id=namespace_id,
        )
        return await self._adelete_namespace_oapg(
...
class DeleteNamespace(BaseApi):
    ...
    async def adelete_namespace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_namespace(
            namespace_id=namespace_id,
            **kwargs,
        )
    ...
    def delete_namespace(
        ...
        raw_response = self.raw.delete_namespace(
            namespace_id=namespace_id,
        )
