...
from digital_ocean_python_sdk.model.associated_resource_status import AssociatedResourceStatus as AssociatedResourceStatusSchema

from digital_ocean_python_sdk.type.associated_resource_status import AssociatedResourceStatus
...
from digital_ocean_python_sdk.pydantic.associated_resource_status import AssociatedResourceStatus as AssociatedResourceStatusPydantic
...
SchemaFor200ResponseBodyApplicationJson = AssociatedResourceStatusSchema
...
class BaseApi(api_client.Api):
    ...
    def _check_destroy_status_mapped_args(
        self,
        droplet_id: int,
    ...
    async def _acheck_destroy_status_oapg(
        self,
    ...
    def _check_destroy_status_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckDestroyStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_destroy_status(
        self,
        droplet_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_destroy_status_mapped_args(
            droplet_id=droplet_id,
        )
        return await self._acheck_destroy_status_oapg(
    ...
    def check_destroy_status(
        ...
        return self._check_destroy_status_oapg(
            path_params=args.path,
        )

class CheckDestroyStatus(BaseApi):
    ...
    async def acheck_destroy_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AssociatedResourceStatusPydantic:
        raw_response = await self.raw.acheck_destroy_status(
            droplet_id=droplet_id,
            **kwargs,
        )
        if validate:
            return AssociatedResourceStatusPydantic(**raw_response.body)
        return api_client.construct_model_instance(AssociatedResourceStatusPydantic, raw_response.body)
    ...
    def check_destroy_status(
        ...
        raw_response = self.raw.check_destroy_status(
            droplet_id=droplet_id,
        )
        if validate:
            return AssociatedResourceStatusPydantic(**raw_response.body)
