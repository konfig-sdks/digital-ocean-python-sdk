...
from digital_ocean_python_sdk.model.cdn_endpoint import CdnEndpoint as CdnEndpointSchema
from digital_ocean_python_sdk.model.cdn_endpoints_create_new_endpoint_response import CdnEndpointsCreateNewEndpointResponse as CdnEndpointsCreateNewEndpointResponseSchema

from digital_ocean_python_sdk.type.cdn_endpoints_create_new_endpoint_response import CdnEndpointsCreateNewEndpointResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.cdn_endpoint import CdnEndpoint

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.cdn_endpoint import CdnEndpoint as CdnEndpointPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.cdn_endpoints_create_new_endpoint_response import CdnEndpointsCreateNewEndpointResponse as CdnEndpointsCreateNewEndpointResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = CdnEndpointSchema


request_body_cdn_endpoint = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CdnEndpointsCreateNewEndpointResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: CdnEndpointsCreateNewEndpointResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_endpoint_mapped_args(
        self,
        origin: str,
        ...
        if certificate_id is not None:
            _body["certificate_id"] = certificate_id
        if custom_domain is not None:
            _body["custom_domain"] = custom_domain
        if created_at is not None:
            _body["created_at"] = created_at
        args.body = _body
        return args

    async def _acreate_new_endpoint_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_cdn_endpoint.serialize(body, content_type)
...
class CreateNewEndpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_endpoint(
        self,
        origin: str,
        id: typing.Optional[str] = None,
        endpoint: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_endpoint_mapped_args(
            origin=origin,
            id=id,
            endpoint=endpoint,
            ttl=ttl,
        ...
        return await self._acreate_new_endpoint_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_endpoint(
        ...
        return self._create_new_endpoint_oapg(
            body=args.body,
        )

class CreateNewEndpoint(BaseApi):
    ...
    async def acreate_new_endpoint(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CdnEndpointsCreateNewEndpointResponsePydantic:
        raw_response = await self.raw.acreate_new_endpoint(
            origin=origin,
            id=id,
            endpoint=endpoint,
            ttl=ttl,
        ...
        if validate:
            return CdnEndpointsCreateNewEndpointResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CdnEndpointsCreateNewEndpointResponsePydantic, raw_response.body)
    ...
    def create_new_endpoint(
        ...
        raw_response = self.raw.create_new_endpoint(
            origin=origin,
            id=id,
            endpoint=endpoint,
            ttl=ttl,
