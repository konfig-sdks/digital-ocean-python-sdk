...
from digital_ocean_python_sdk.model.cdn_endpoints_list_all_response import CdnEndpointsListAllResponse as CdnEndpointsListAllResponseSchema

from digital_ocean_python_sdk.type.cdn_endpoints_list_all_response import CdnEndpointsListAllResponse
...
from digital_ocean_python_sdk.pydantic.cdn_endpoints_list_all_response import CdnEndpointsListAllResponse as CdnEndpointsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CdnEndpointsListAllResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CdnEndpointsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CdnEndpointsListAllResponsePydantic:
        ...
        if validate:
            return RootModel[CdnEndpointsListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CdnEndpointsListAllResponsePydantic, raw_response.body)
