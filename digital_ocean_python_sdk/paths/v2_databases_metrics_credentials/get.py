...
from digital_ocean_python_sdk.model.databases_get_clusters_metrics_credentials_response import DatabasesGetClustersMetricsCredentialsResponse as DatabasesGetClustersMetricsCredentialsResponseSchema

from digital_ocean_python_sdk.type.databases_get_clusters_metrics_credentials_response import DatabasesGetClustersMetricsCredentialsResponse
...
from digital_ocean_python_sdk.pydantic.databases_get_clusters_metrics_credentials_response import DatabasesGetClustersMetricsCredentialsResponse as DatabasesGetClustersMetricsCredentialsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesGetClustersMetricsCredentialsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesGetClustersMetricsCredentialsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_clusters_metrics_credentials_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_clusters_metrics_credentials_oapg(
        self,
    ...
    def _get_clusters_metrics_credentials_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetClustersMetricsCredentialsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_clusters_metrics_credentials(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_clusters_metrics_credentials_mapped_args(
        )
        return await self._aget_clusters_metrics_credentials_oapg(
            **kwargs,
        )
    
    def get_clusters_metrics_credentials(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        ApiResponseForDefault,
        ...
        return self._get_clusters_metrics_credentials_oapg(
        )

class GetClustersMetricsCredentials(BaseApi):

    async def aget_clusters_metrics_credentials(
        self,
        validate: bool = False,
        **kwargs,
    ) -> DatabasesGetClustersMetricsCredentialsResponsePydantic:
        raw_response = await self.raw.aget_clusters_metrics_credentials(
            **kwargs,
        )
        if validate:
            return DatabasesGetClustersMetricsCredentialsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesGetClustersMetricsCredentialsResponsePydantic, raw_response.body)
    ...
    def get_clusters_metrics_credentials(
        ...
        raw_response = self.raw.get_clusters_metrics_credentials(
        )
        if validate:
            return DatabasesGetClustersMetricsCredentialsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesGetClustersMetricsCredentialsResponsePydantic, raw_response.body)
