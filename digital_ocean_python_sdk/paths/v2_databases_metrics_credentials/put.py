...
from digital_ocean_python_sdk.model.databases_basic_auth_credentials import DatabasesBasicAuthCredentials as DatabasesBasicAuthCredentialsSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.database_metrics_credentials import DatabaseMetricsCredentials as DatabaseMetricsCredentialsSchema

from digital_ocean_python_sdk.type.database_metrics_credentials import DatabaseMetricsCredentials
from digital_ocean_python_sdk.type.databases_basic_auth_credentials import DatabasesBasicAuthCredentials
...
from digital_ocean_python_sdk.pydantic.databases_basic_auth_credentials import DatabasesBasicAuthCredentials as DatabasesBasicAuthCredentialsPydantic
from digital_ocean_python_sdk.pydantic.database_metrics_credentials import DatabaseMetricsCredentials as DatabaseMetricsCredentialsPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DatabaseMetricsCredentialsSchema


request_body_database_metrics_credentials = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_metrics_credentials_mapped_args(
        self,
        credentials: typing.Optional[DatabasesBasicAuthCredentials] = None,
    ...
    async def _aupdate_metrics_credentials_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/databases/metrics/credentials',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_database_metrics_credentials.serialize(body, content_type)
    ...
    def _update_metrics_credentials_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateMetricsCredentialsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_metrics_credentials(
        self,
        credentials: typing.Optional[DatabasesBasicAuthCredentials] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_metrics_credentials_mapped_args(
            credentials=credentials,
        )
        return await self._aupdate_metrics_credentials_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_metrics_credentials(
        self,
        credentials: typing.Optional[DatabasesBasicAuthCredentials] = None,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._update_metrics_credentials_oapg(
            body=args.body,
        )

class UpdateMetricsCredentials(BaseApi):
    ...
    async def aupdate_metrics_credentials(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_metrics_credentials(
            credentials=credentials,
            **kwargs,
        )
    ...
    def update_metrics_credentials(
        ...
        raw_response = self.raw.update_metrics_credentials(
            credentials=credentials,
        )
