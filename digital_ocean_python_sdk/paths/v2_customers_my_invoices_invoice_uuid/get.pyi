...
from digital_ocean_python_sdk.model.billing_get_invoice_by_uuid_response import BillingGetInvoiceByUuidResponse as BillingGetInvoiceByUuidResponseSchema

from digital_ocean_python_sdk.type.billing_get_invoice_by_uuid_response import BillingGetInvoiceByUuidResponse
...
from digital_ocean_python_sdk.pydantic.billing_get_invoice_by_uuid_response import BillingGetInvoiceByUuidResponse as BillingGetInvoiceByUuidResponsePydantic

# Path params
InvoiceUuidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'invoice_uuid': typing.Union[InvoiceUuidSchema, str, ],
    }
)
...
request_path_invoice_uuid = api_client.PathParameter(
    name="invoice_uuid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InvoiceUuidSchema,
    required=True,
)
RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = BillingGetInvoiceByUuidResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BillingGetInvoiceByUuidResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_invoice_by_uuid_mapped_args(
        self,
        invoice_uuid: str,
        ...
        if invoice_uuid is not None:
            _path_params["invoice_uuid"] = invoice_uuid
        args.path = _path_params
        return args

    async def _aget_invoice_by_uuid_oapg(
        self,
...
class GetInvoiceByUuidRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_invoice_by_uuid(
        self,
        invoice_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_invoice_by_uuid_mapped_args(
            invoice_uuid=invoice_uuid,
        )
        return await self._aget_invoice_by_uuid_oapg(
    ...
    def get_invoice_by_uuid(
        ...
        return self._get_invoice_by_uuid_oapg(
            path_params=args.path,
        )

class GetInvoiceByUuid(BaseApi):
    ...
    async def aget_invoice_by_uuid(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingGetInvoiceByUuidResponsePydantic:
        raw_response = await self.raw.aget_invoice_by_uuid(
            invoice_uuid=invoice_uuid,
            **kwargs,
        )
        if validate:
            return RootModel[BillingGetInvoiceByUuidResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BillingGetInvoiceByUuidResponsePydantic, raw_response.body)
    ...
    def get_invoice_by_uuid(
        ...
        raw_response = self.raw.get_invoice_by_uuid(
            invoice_uuid=invoice_uuid,
        )
        if validate:
            return RootModel[BillingGetInvoiceByUuidResponsePydantic](raw_response.body).root
