...
class TagResourceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atag_resource(
        self,
        resources: TagsResourceResources,
        tag_id: str,
        **kwargs,
        ...
        args = self._tag_resource_mapped_args(
            resources=resources,
            tag_id=tag_id,
        )
        return await self._atag_resource_oapg(
            body=args.body,
    ...
    def tag_resource(
        ...
        return self._tag_resource_oapg(
            body=args.body,
            path_params=args.path,
        )

class TagResource(BaseApi):
    ...
    async def atag_resource(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atag_resource(
            resources=resources,
            tag_id=tag_id,
            **kwargs,
        )
    ...
    def tag_resource(
        ...
        raw_response = self.raw.tag_resource(
            resources=resources,
            tag_id=tag_id,
        )
