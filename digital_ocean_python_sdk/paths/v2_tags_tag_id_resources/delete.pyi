...
from digital_ocean_python_sdk.model.tags_resource import TagsResource as TagsResourceSchema
from digital_ocean_python_sdk.model.tags_resource_resources import TagsResourceResources as TagsResourceResourcesSchema

from digital_ocean_python_sdk.type.tags_resource import TagsResource
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.tags_resource_resources import TagsResourceResources

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.tags_resource import TagsResource as TagsResourcePydantic
from digital_ocean_python_sdk.pydantic.tags_resource_resources import TagsResourceResources as TagsResourceResourcesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TagsResourceSchema


request_body_tags_resource = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _untag_resource_mapped_args(
        self,
        resources: TagsResourceResources,
        tag_id: str,
    ...
    async def _auntag_resource_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_tags_resource.serialize(body, content_type)
...
class UntagResourceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def auntag_resource(
        self,
        resources: TagsResourceResources,
        tag_id: str,
        **kwargs,
        ...
        args = self._untag_resource_mapped_args(
            resources=resources,
            tag_id=tag_id,
        )
        return await self._auntag_resource_oapg(
            body=args.body,
    ...
    def untag_resource(
        ...
        return self._untag_resource_oapg(
            body=args.body,
            path_params=args.path,
        )

class UntagResource(BaseApi):
    ...
    async def auntag_resource(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.auntag_resource(
            resources=resources,
            tag_id=tag_id,
            **kwargs,
        )
    ...
    def untag_resource(
        ...
        raw_response = self.raw.untag_resource(
            resources=resources,
            tag_id=tag_id,
        )
