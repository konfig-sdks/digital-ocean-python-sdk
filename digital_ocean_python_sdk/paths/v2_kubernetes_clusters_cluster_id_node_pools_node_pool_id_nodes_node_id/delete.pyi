...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'skip_drain': typing.Union[SkipDrainSchema, decimal.Decimal, int, ],
        'replace': typing.Union[ReplaceSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_skip_drain = api_client.QueryParameter(
    name="skip_drain",
    style=api_client.ParameterStyle.FORM,
    schema=SkipDrainSchema,
    explode=True,
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'node_id': typing.Union[NodeIdSchema, str, uuid.UUID, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _delete_node_in_node_pool_mapped_args(
        self,
        cluster_id: str,
        node_pool_id: str,
        node_id: str,
        skip_drain: typing.Optional[int] = None,
        replace: typing.Optional[int] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if skip_drain is not None:
            _query_params["skip_drain"] = skip_drain
        if replace is not None:
            _query_params["replace"] = replace
    ...
    async def _adelete_node_in_node_pool_oapg(
        self,
    ...
    def _delete_node_in_node_pool_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteNodeInNodePoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_node_in_node_pool(
        self,
        cluster_id: str,
        node_pool_id: str,
        node_id: str,
        ...
        **kwargs,
        ...
        args = self._delete_node_in_node_pool_mapped_args(
        ...
        return await self._adelete_node_in_node_pool_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def delete_node_in_node_pool(
        self,
        cluster_id: str,
        node_pool_id: str,
        node_id: str,
        ...
        return self._delete_node_in_node_pool_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteNodeInNodePool(BaseApi):
    ...
    async def adelete_node_in_node_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_node_in_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            node_id=node_id,
            skip_drain=skip_drain,
    ...
    def delete_node_in_node_pool(
        ...
        raw_response = self.raw.delete_node_in_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            node_id=node_id,
            skip_drain=skip_drain,
