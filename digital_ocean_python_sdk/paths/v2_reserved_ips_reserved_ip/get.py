...
from digital_ocean_python_sdk.model.reserved_ips_get_response import ReservedIPsGetResponse as ReservedIPsGetResponseSchema

from digital_ocean_python_sdk.type.reserved_ips_get_response import ReservedIPsGetResponse
...
from digital_ocean_python_sdk.pydantic.reserved_ips_get_response import ReservedIPsGetResponse as ReservedIPsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReservedIPsGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReservedIPsGetResponsePydantic:
        raw_response = await self.raw.aget(
            reserved_ip=reserved_ip,
            **kwargs,
        )
        if validate:
            return ReservedIPsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReservedIPsGetResponsePydantic, raw_response.body)
