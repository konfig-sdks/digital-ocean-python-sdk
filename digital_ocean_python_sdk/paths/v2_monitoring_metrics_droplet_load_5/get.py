...
class BaseApi(api_client.Api):
    ...
    def _droplet_load5_metrics_get_mapped_args(
        self,
        host_id: str,
        start: str,
        end: str,
    ...
    async def _adroplet_load5_metrics_get_oapg(
        self,
    ...
    def _droplet_load5_metrics_get_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DropletLoad5MetricsGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adroplet_load5_metrics_get(
        self,
        host_id: str,
        start: str,
        end: str,
        **kwargs,
        ...
        args = self._droplet_load5_metrics_get_mapped_args(
            host_id=host_id,
            start=start,
            end=end,
        )
        return await self._adroplet_load5_metrics_get_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def droplet_load5_metrics_get(
        self,
        host_id: str,
        start: str,
        end: str,
        ...
        return self._droplet_load5_metrics_get_oapg(
            query_params=args.query,
        )

class DropletLoad5MetricsGet(BaseApi):
    ...
    async def adroplet_load5_metrics_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adroplet_load5_metrics_get(
            host_id=host_id,
            start=start,
            end=end,
            **kwargs,
    ...
    def droplet_load5_metrics_get(
        ...
        raw_response = self.raw.droplet_load5_metrics_get(
            host_id=host_id,
            start=start,
            end=end,
        )
