...
from digital_ocean_python_sdk.model.app_propose_response import AppProposeResponse as AppProposeResponseSchema
from digital_ocean_python_sdk.model.app_spec import AppSpec as AppSpecSchema
from digital_ocean_python_sdk.model.app_propose import AppPropose as AppProposeSchema

from digital_ocean_python_sdk.type.app_propose import AppPropose
from digital_ocean_python_sdk.type.app_propose_response import AppProposeResponse
from digital_ocean_python_sdk.type.app_spec import AppSpec
...
from digital_ocean_python_sdk.pydantic.app_propose import AppPropose as AppProposePydantic
from digital_ocean_python_sdk.pydantic.app_propose_response import AppProposeResponse as AppProposeResponsePydantic
from digital_ocean_python_sdk.pydantic.app_spec import AppSpec as AppSpecPydantic

# body param
SchemaForRequestBodyApplicationJson = AppProposeSchema


request_body_app_propose = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppProposeResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _propose_app_spec_mapped_args(
        self,
        spec: AppSpec,
    ...
    async def _apropose_app_spec_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_app_propose.serialize(body, content_type)
...
class ProposeAppSpecRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apropose_app_spec(
        self,
        spec: AppSpec,
        app_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._propose_app_spec_mapped_args(
            spec=spec,
            app_id=app_id,
        )
        return await self._apropose_app_spec_oapg(
            body=args.body,
            **kwargs,
        )
    
    def propose_app_spec(
        self,
        spec: AppSpec,
        app_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._propose_app_spec_oapg(
            body=args.body,
        )

class ProposeAppSpec(BaseApi):
    ...
    async def apropose_app_spec(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppProposeResponsePydantic:
        raw_response = await self.raw.apropose_app_spec(
            spec=spec,
            app_id=app_id,
            **kwargs,
        )
        if validate:
            return AppProposeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppProposeResponsePydantic, raw_response.body)
    ...
    def propose_app_spec(
        ...
        raw_response = self.raw.propose_app_spec(
            spec=spec,
            app_id=app_id,
        )
        if validate:
