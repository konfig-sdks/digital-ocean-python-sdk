...
from digital_ocean_python_sdk.model.database_maintenance_window_description import DatabaseMaintenanceWindowDescription as DatabaseMaintenanceWindowDescriptionSchema

from digital_ocean_python_sdk.type.database_maintenance_window import DatabaseMaintenanceWindow
from digital_ocean_python_sdk.type.database_maintenance_window_description import DatabaseMaintenanceWindowDescription
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.database_maintenance_window_description import DatabaseMaintenanceWindowDescription as DatabaseMaintenanceWindowDescriptionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabaseMaintenanceWindowSchema


request_body_database_maintenance_window = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _configure_maintenance_window_mapped_args(
        self,
        day: str,
        hour: str,
        database_cluster_uuid: str,
        description: typing.Optional[DatabaseMaintenanceWindowDescription] = None,
    ...
    async def _aconfigure_maintenance_window_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_database_maintenance_window.serialize(body, content_type)
    ...
    def _configure_maintenance_window_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ConfigureMaintenanceWindowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aconfigure_maintenance_window(
        self,
        day: str,
        hour: str,
        database_cluster_uuid: str,
        ...
        **kwargs,
        ...
        args = self._configure_maintenance_window_mapped_args(
            day=day,
            hour=hour,
        ...
        return await self._aconfigure_maintenance_window_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def configure_maintenance_window(
        self,
        day: str,
        hour: str,
        database_cluster_uuid: str,
        ...
        return self._configure_maintenance_window_oapg(
            body=args.body,
            path_params=args.path,
        )

class ConfigureMaintenanceWindow(BaseApi):
    ...
    async def aconfigure_maintenance_window(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aconfigure_maintenance_window(
            day=day,
            hour=hour,
            database_cluster_uuid=database_cluster_uuid,
            description=description,
    ...
    def configure_maintenance_window(
        ...
        raw_response = self.raw.configure_maintenance_window(
            day=day,
            hour=hour,
            database_cluster_uuid=database_cluster_uuid,
            description=description,
