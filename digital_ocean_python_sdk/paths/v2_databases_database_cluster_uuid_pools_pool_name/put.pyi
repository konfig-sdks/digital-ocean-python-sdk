...
from digital_ocean_python_sdk.model.connection_pool_update import ConnectionPoolUpdate as ConnectionPoolUpdateSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.connection_pool_update import ConnectionPoolUpdate
...
from digital_ocean_python_sdk.pydantic.connection_pool_update import ConnectionPoolUpdate as ConnectionPoolUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ConnectionPoolUpdateSchema


request_body_connection_pool_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_connection_pool_postgresql_mapped_args(
        self,
        mode: str,
        size: int,
        db: str,
    ...
    async def _aupdate_connection_pool_postgresql_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_connection_pool_update.serialize(body, content_type)
    ...
    def _update_connection_pool_postgresql_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateConnectionPoolPostgresqlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_connection_pool_postgresql(
        self,
        mode: str,
        size: int,
        db: str,
        ...
        **kwargs,
        ...
        args = self._update_connection_pool_postgresql_mapped_args(
            mode=mode,
            size=size,
            db=db,
        ...
        return await self._aupdate_connection_pool_postgresql_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_connection_pool_postgresql(
        self,
        mode: str,
        size: int,
        db: str,
        ...
        return self._update_connection_pool_postgresql_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateConnectionPoolPostgresql(BaseApi):
    ...
    async def aupdate_connection_pool_postgresql(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_connection_pool_postgresql(
            mode=mode,
            size=size,
            db=db,
            database_cluster_uuid=database_cluster_uuid,
    ...
    def update_connection_pool_postgresql(
        ...
        raw_response = self.raw.update_connection_pool_postgresql(
            mode=mode,
            size=size,
            db=db,
            database_cluster_uuid=database_cluster_uuid,
