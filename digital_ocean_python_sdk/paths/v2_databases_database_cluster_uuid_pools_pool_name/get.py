...
request_path_pool_name = api_client.PathParameter(
    name="pool_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PoolNameSchema,
    required=True,
)
_auth = [
    'bearer_auth',
...
SchemaFor200ResponseBodyApplicationJson = DatabasesAddNewConnectionPoolResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_connection_pool_mapped_args(
        self,
    ...
    async def _aget_connection_pool_oapg(
        self,
...
class GetConnectionPoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_connection_pool(
        self,
        database_cluster_uuid: str,
        pool_name: str,
        **kwargs,
        ...
        args = self._get_connection_pool_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
        )
        return await self._aget_connection_pool_oapg(
    ...
    def get_connection_pool(
        ...
        return self._get_connection_pool_oapg(
            path_params=args.path,
        )

class GetConnectionPool(BaseApi):
    ...
    async def aget_connection_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_connection_pool(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
            **kwargs,
        )
    ...
    def get_connection_pool(
        ...
        raw_response = self.raw.get_connection_pool(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
        )
        if validate:
