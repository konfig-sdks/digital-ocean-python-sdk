...
class BaseApi(api_client.Api):
    ...
    def _delete_connection_pool_mapped_args(
        self,
    ...
    async def _adelete_connection_pool_oapg(
        self,
    ...
    def _delete_connection_pool_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteConnectionPoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_connection_pool(
        self,
        database_cluster_uuid: str,
        pool_name: str,
        **kwargs,
        ...
        args = self._delete_connection_pool_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
        )
        return await self._adelete_connection_pool_oapg(
    ...
    def delete_connection_pool(
        ...
        return self._delete_connection_pool_oapg(
            path_params=args.path,
        )

class DeleteConnectionPool(BaseApi):
    ...
    async def adelete_connection_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_connection_pool(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
            **kwargs,
        )
    ...
    def delete_connection_pool(
        ...
        raw_response = self.raw.delete_connection_pool(
            database_cluster_uuid=database_cluster_uuid,
            pool_name=pool_name,
        )
