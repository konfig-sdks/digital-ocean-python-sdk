...
from digital_ocean_python_sdk.model.droplets_list_associated_resources_response import DropletsListAssociatedResourcesResponse as DropletsListAssociatedResourcesResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.droplets_list_associated_resources_response import DropletsListAssociatedResourcesResponse
...
from digital_ocean_python_sdk.pydantic.droplets_list_associated_resources_response import DropletsListAssociatedResourcesResponse as DropletsListAssociatedResourcesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListAssociatedResourcesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListAssociatedResourcesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_associated_resources_mapped_args(
        self,
        droplet_id: int,
    ...
    async def _alist_associated_resources_oapg(
        self,
    ...
    def _list_associated_resources_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAssociatedResourcesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_associated_resources(
        self,
        droplet_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_associated_resources_mapped_args(
            droplet_id=droplet_id,
        )
        return await self._alist_associated_resources_oapg(
    ...
    def list_associated_resources(
        ...
        return self._list_associated_resources_oapg(
            path_params=args.path,
        )

class ListAssociatedResources(BaseApi):
    ...
    async def alist_associated_resources(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListAssociatedResourcesResponsePydantic:
        raw_response = await self.raw.alist_associated_resources(
            droplet_id=droplet_id,
            **kwargs,
        )
        if validate:
            return RootModel[DropletsListAssociatedResourcesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListAssociatedResourcesResponsePydantic, raw_response.body)
    ...
    def list_associated_resources(
        ...
        raw_response = self.raw.list_associated_resources(
            droplet_id=droplet_id,
        )
        if validate:
            return RootModel[DropletsListAssociatedResourcesResponsePydantic](raw_response.body).root
