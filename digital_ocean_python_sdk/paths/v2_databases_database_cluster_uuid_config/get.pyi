...
from digital_ocean_python_sdk.model.databases_get_cluster_config_response import DatabasesGetClusterConfigResponse as DatabasesGetClusterConfigResponseSchema

from digital_ocean_python_sdk.type.databases_get_cluster_config_response import DatabasesGetClusterConfigResponse
...
from digital_ocean_python_sdk.pydantic.databases_get_cluster_config_response import DatabasesGetClusterConfigResponse as DatabasesGetClusterConfigResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesGetClusterConfigResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesGetClusterConfigResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_cluster_config_mapped_args(
        self,
    ...
    async def _aget_cluster_config_oapg(
        self,
...
class GetClusterConfigRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cluster_config(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_cluster_config_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_cluster_config_oapg(
    ...
    def get_cluster_config(
        ...
        return self._get_cluster_config_oapg(
            path_params=args.path,
        )

class GetClusterConfig(BaseApi):
    ...
    async def aget_cluster_config(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesGetClusterConfigResponsePydantic:
        raw_response = await self.raw.aget_cluster_config(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesGetClusterConfigResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesGetClusterConfigResponsePydantic, raw_response.body)
    ...
    def get_cluster_config(
        ...
        raw_response = self.raw.get_cluster_config(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesGetClusterConfigResponsePydantic(**raw_response.body)
