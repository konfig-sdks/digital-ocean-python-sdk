...
from digital_ocean_python_sdk.model.database_config import DatabaseConfig as DatabaseConfigSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.postgres import Postgres as PostgresSchema
from digital_ocean_python_sdk.model.mysql import Mysql as MysqlSchema
from digital_ocean_python_sdk.model.redis import Redis as RedisSchema

from digital_ocean_python_sdk.type.redis import Redis
from digital_ocean_python_sdk.type.postgres import Postgres
from digital_ocean_python_sdk.type.mysql import Mysql
from digital_ocean_python_sdk.type.database_config import DatabaseConfig
...
from digital_ocean_python_sdk.pydantic.redis import Redis as RedisPydantic
from digital_ocean_python_sdk.pydantic.database_config import DatabaseConfig as DatabaseConfigPydantic
from digital_ocean_python_sdk.pydantic.mysql import Mysql as MysqlPydantic
from digital_ocean_python_sdk.pydantic.postgres import Postgres as PostgresPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabaseConfigSchema


request_body_database_config = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_config_cluster_mapped_args(
        self,
        database_cluster_uuid: str,
        config: typing.Optional[typing.Union[Mysql, Postgres, Redis]] = None,
    ...
    async def _aupdate_config_cluster_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_database_config.serialize(body, content_type)
    ...
    def _update_config_cluster_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateConfigClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_config_cluster(
        self,
        database_cluster_uuid: str,
        config: typing.Optional[typing.Union[Mysql, Postgres, Redis]] = None,
        **kwargs,
        ...
        args = self._update_config_cluster_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            config=config,
        )
        return await self._aupdate_config_cluster_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_config_cluster(
        self,
        database_cluster_uuid: str,
        config: typing.Optional[typing.Union[Mysql, Postgres, Redis]] = None,
    ) -> typing.Union[
        ...
        return self._update_config_cluster_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateConfigCluster(BaseApi):
    ...
    async def aupdate_config_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_config_cluster(
            database_cluster_uuid=database_cluster_uuid,
            config=config,
            **kwargs,
        )
    ...
    def update_config_cluster(
        ...
        raw_response = self.raw.update_config_cluster(
            database_cluster_uuid=database_cluster_uuid,
            config=config,
        )
