...
from digital_ocean_python_sdk.model.firewalls_add_rules_request import FirewallsAddRulesRequest as FirewallsAddRulesRequestSchema
...
from digital_ocean_python_sdk.type.firewalls_add_rules_request import FirewallsAddRulesRequest
...
from digital_ocean_python_sdk.pydantic.firewalls_add_rules_request import FirewallsAddRulesRequest as FirewallsAddRulesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsAddRulesRequestSchema


request_body_firewalls_add_rules_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_rules_mapped_args(
        ...
        body: typing.Optional[FirewallsAddRulesRequest] = None,
    ...
    async def _aadd_rules_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_add_rules_request.serialize(body, content_type)
...
class AddRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_rules(
        self,
        firewall_id: str,
        inbound_rules: typing.Optional[FirewallRulesInboundRules] = None,
        outbound_rules: typing.Optional[FirewallRulesOutboundRules] = None,
        ...
        **kwargs,
        ...
        args = self._add_rules_mapped_args(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
        )
        return await self._aadd_rules_oapg(
            body=args.body,
    ...
    def add_rules(
        ...
        return self._add_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddRules(BaseApi):
    ...
    async def aadd_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_rules(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
    ...
    def add_rules(
        ...
        raw_response = self.raw.add_rules(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
