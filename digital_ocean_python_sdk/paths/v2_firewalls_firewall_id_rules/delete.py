...
from digital_ocean_python_sdk.model.firewalls_remove_rules_request import FirewallsRemoveRulesRequest as FirewallsRemoveRulesRequestSchema
...
from digital_ocean_python_sdk.type.firewalls_remove_rules_request import FirewallsRemoveRulesRequest
...
from digital_ocean_python_sdk.pydantic.firewalls_remove_rules_request import FirewallsRemoveRulesRequest as FirewallsRemoveRulesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsRemoveRulesRequestSchema


request_body_firewalls_remove_rules_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_rules_mapped_args(
        ...
        body: typing.Optional[FirewallsRemoveRulesRequest] = None,
    ...
    async def _aremove_rules_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_remove_rules_request.serialize(body, content_type)
...
class RemoveRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_rules(
        self,
        firewall_id: str,
        inbound_rules: typing.Optional[FirewallRulesInboundRules] = None,
        outbound_rules: typing.Optional[FirewallRulesOutboundRules] = None,
        ...
        **kwargs,
        ...
        args = self._remove_rules_mapped_args(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
        )
        return await self._aremove_rules_oapg(
            body=args.body,
    ...
    def remove_rules(
        ...
        return self._remove_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveRules(BaseApi):
    ...
    async def aremove_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_rules(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
    ...
    def remove_rules(
        ...
        raw_response = self.raw.remove_rules(
            body=body,
            firewall_id=firewall_id,
            inbound_rules=inbound_rules,
            outbound_rules=outbound_rules,
