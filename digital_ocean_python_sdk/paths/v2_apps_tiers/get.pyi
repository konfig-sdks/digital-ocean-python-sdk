...
from digital_ocean_python_sdk.model.apps_list_tiers_response import AppsListTiersResponse as AppsListTiersResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.apps_list_tiers_response import AppsListTiersResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.apps_list_tiers_response import AppsListTiersResponse as AppsListTiersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsListTiersResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_tiers_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_tiers_oapg(
        self,
...
class ListTiersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_tiers(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_tiers_mapped_args(
        )
        return await self._alist_tiers_oapg(
            **kwargs,
        )
    ...
    def list_tiers(
        ...
        return self._list_tiers_oapg(
        )

class ListTiers(BaseApi):

    async def alist_tiers(
        self,
        validate: bool = False,
        **kwargs,
    ) -> AppsListTiersResponsePydantic:
        raw_response = await self.raw.alist_tiers(
            **kwargs,
        )
        if validate:
            return AppsListTiersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListTiersResponsePydantic, raw_response.body)
    ...
    def list_tiers(
        ...
        raw_response = self.raw.list_tiers(
        )
        if validate:
            return AppsListTiersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListTiersResponsePydantic, raw_response.body)
