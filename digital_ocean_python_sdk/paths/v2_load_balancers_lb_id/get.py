...
from digital_ocean_python_sdk.model.load_balancers_get_response import LoadBalancersGetResponse as LoadBalancersGetResponseSchema

from digital_ocean_python_sdk.type.load_balancers_get_response import LoadBalancersGetResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.load_balancers_get_response import LoadBalancersGetResponse as LoadBalancersGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancersGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersGetResponsePydantic:
        raw_response = await self.raw.aget(
            lb_id=lb_id,
            **kwargs,
        )
        if validate:
            return LoadBalancersGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LoadBalancersGetResponsePydantic, raw_response.body)
