...
from digital_ocean_python_sdk.model.droplet_actions_list_response import DropletActionsListResponse as DropletActionsListResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.droplet_actions_list_response import DropletActionsListResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.droplet_actions_list_response import DropletActionsListResponse as DropletActionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletActionsListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletActionsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletActionsListResponsePydantic:
        ...
        if validate:
            return RootModel[DropletActionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletActionsListResponsePydantic, raw_response.body)
