...
class BaseApi(api_client.Api):
    ...
    def _delete_trigger_mapped_args(
        self,
        namespace_id: str,
        trigger_name: str,
    ...
    async def _adelete_trigger_oapg(
        self,
...
class DeleteTriggerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_trigger(
        self,
        namespace_id: str,
        trigger_name: str,
        **kwargs,
        ...
        args = self._delete_trigger_mapped_args(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
        )
        return await self._adelete_trigger_oapg(
    ...
    def delete_trigger(
        ...
        return self._delete_trigger_oapg(
            path_params=args.path,
        )

class DeleteTrigger(BaseApi):
    ...
    async def adelete_trigger(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_trigger(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
            **kwargs,
        )
    ...
    def delete_trigger(
        ...
        raw_response = self.raw.delete_trigger(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
        )
