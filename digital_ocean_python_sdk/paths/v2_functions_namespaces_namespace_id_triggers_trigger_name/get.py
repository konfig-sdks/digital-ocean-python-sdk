...
class BaseApi(api_client.Api):
    ...
    def _get_trigger_details_mapped_args(
        self,
        namespace_id: str,
        trigger_name: str,
    ...
    async def _aget_trigger_details_oapg(
        self,
...
class GetTriggerDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_trigger_details(
        self,
        namespace_id: str,
        trigger_name: str,
        **kwargs,
        ...
        args = self._get_trigger_details_mapped_args(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
        )
        return await self._aget_trigger_details_oapg(
    ...
    def get_trigger_details(
        ...
        return self._get_trigger_details_oapg(
            path_params=args.path,
        )

class GetTriggerDetails(BaseApi):
    ...
    async def aget_trigger_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_trigger_details(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
            **kwargs,
        )
    ...
    def get_trigger_details(
        ...
        raw_response = self.raw.get_trigger_details(
            namespace_id=namespace_id,
            trigger_name=trigger_name,
        )
        if validate:
