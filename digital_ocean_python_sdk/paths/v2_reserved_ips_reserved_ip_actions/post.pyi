...
from digital_ocean_python_sdk.model.reserved_ips_actions_post_response import ReservedIPsActionsPostResponse as ReservedIPsActionsPostResponseSchema
from digital_ocean_python_sdk.model.reserved_ips_actions_post_request import ReservedIPsActionsPostRequest as ReservedIPsActionsPostRequestSchema

from digital_ocean_python_sdk.type.reserved_ips_actions_post_response import ReservedIPsActionsPostResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.reserved_ips_actions_post_request import ReservedIPsActionsPostRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.reserved_ips_actions_post_response import ReservedIPsActionsPostResponse as ReservedIPsActionsPostResponsePydantic
from digital_ocean_python_sdk.pydantic.reserved_ips_actions_post_request import ReservedIPsActionsPostRequest as ReservedIPsActionsPostRequestPydantic

# Path params


class ReservedIpSchema(
    schemas.StrSchema
):
    pass
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'reserved_ip': typing.Union[ReservedIpSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ReservedIPsActionsPostRequestSchema


request_body_reserved_ips_actions_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ReservedIPsActionsPostResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: ReservedIPsActionsPostResponse
...
class BaseApi(api_client.Api):
    ...
    def _post_mapped_args(
        ...
        body: typing.Optional[ReservedIPsActionsPostRequest] = None,
        ...
        if reserved_ip is not None:
            _path_params["reserved_ip"] = reserved_ip
    ...
    async def _apost_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_reserved_ips_actions_post_request.serialize(body, content_type)
...
class Post(BaseApi):
    ...
    async def apost(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReservedIPsActionsPostResponsePydantic:
        ...
        if validate:
            return ReservedIPsActionsPostResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReservedIPsActionsPostResponsePydantic, raw_response.body)
