...
from digital_ocean_python_sdk.model.reserved_ips_actions_list_response import ReservedIPsActionsListResponse as ReservedIPsActionsListResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.reserved_ips_actions_list_response import ReservedIPsActionsListResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.reserved_ips_actions_list_response import ReservedIPsActionsListResponse as ReservedIPsActionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReservedIPsActionsListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ReservedIPsActionsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReservedIPsActionsListResponsePydantic:
        raw_response = await self.raw.alist(
            reserved_ip=reserved_ip,
            **kwargs,
        )
        if validate:
            return RootModel[ReservedIPsActionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ReservedIPsActionsListResponsePydantic, raw_response.body)
