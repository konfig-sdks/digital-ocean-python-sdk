...
from digital_ocean_python_sdk.model.droplet_actions_act_on_tagged_droplets_request import DropletActionsActOnTaggedDropletsRequest as DropletActionsActOnTaggedDropletsRequestSchema

from digital_ocean_python_sdk.type.droplet_actions_act_on_tagged_droplets_request import DropletActionsActOnTaggedDropletsRequest
...
from digital_ocean_python_sdk.pydantic.droplet_actions_act_on_tagged_droplets_request import DropletActionsActOnTaggedDropletsRequest as DropletActionsActOnTaggedDropletsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DropletActionsActOnTaggedDropletsRequestSchema


request_body_droplet_actions_act_on_tagged_droplets_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _act_on_tagged_droplets_mapped_args(
        self,
        type: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tag_name: typing.Optional[str] = None,
        body: typing.Optional[DropletActionsActOnTaggedDropletsRequest] = None,
        ...
        if tag_name is not None:
            _query_params["tag_name"] = tag_name
        args.query = _query_params
        return args

    async def _aact_on_tagged_droplets_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_droplet_actions_act_on_tagged_droplets_request.serialize(body, content_type)
    ...
    def _act_on_tagged_droplets_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ActOnTaggedDropletsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aact_on_tagged_droplets(
        self,
        type: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tag_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._act_on_tagged_droplets_mapped_args(
            body=body,
            type=type,
            name=name,
            tag_name=tag_name,
        )
        return await self._aact_on_tagged_droplets_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def act_on_tagged_droplets(
        self,
        type: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        tag_name: typing.Optional[str] = None,
        ...
        return self._act_on_tagged_droplets_oapg(
            body=args.body,
            query_params=args.query,
        )

class ActOnTaggedDroplets(BaseApi):
    ...
    async def aact_on_tagged_droplets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aact_on_tagged_droplets(
            body=body,
            type=type,
            name=name,
            tag_name=tag_name,
    ...
    def act_on_tagged_droplets(
        ...
        raw_response = self.raw.act_on_tagged_droplets(
            body=body,
            type=type,
            name=name,
            tag_name=tag_name,
