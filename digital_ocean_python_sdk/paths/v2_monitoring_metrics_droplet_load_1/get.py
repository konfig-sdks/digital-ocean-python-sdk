...
class BaseApi(api_client.Api):
    ...
    def _get_droplet_load1_metrics_mapped_args(
        self,
        host_id: str,
        start: str,
        end: str,
    ...
    async def _aget_droplet_load1_metrics_oapg(
        self,
    ...
    def _get_droplet_load1_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDropletLoad1MetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_droplet_load1_metrics(
        self,
        host_id: str,
        start: str,
        end: str,
        **kwargs,
        ...
        args = self._get_droplet_load1_metrics_mapped_args(
            host_id=host_id,
            start=start,
            end=end,
        )
        return await self._aget_droplet_load1_metrics_oapg(
    ...
    def get_droplet_load1_metrics(
        ...
        return self._get_droplet_load1_metrics_oapg(
            query_params=args.query,
        )

class GetDropletLoad1Metrics(BaseApi):
    ...
    async def aget_droplet_load1_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_droplet_load1_metrics(
            host_id=host_id,
            start=start,
            end=end,
            **kwargs,
    ...
    def get_droplet_load1_metrics(
        ...
        raw_response = self.raw.get_droplet_load1_metrics(
            host_id=host_id,
            start=start,
            end=end,
        )
