...
from digital_ocean_python_sdk.model.container_registry_list_repository_manifests_response import ContainerRegistryListRepositoryManifestsResponse as ContainerRegistryListRepositoryManifestsResponseSchema

from digital_ocean_python_sdk.type.container_registry_list_repository_manifests_response import ContainerRegistryListRepositoryManifestsResponse
...
from digital_ocean_python_sdk.pydantic.container_registry_list_repository_manifests_response import ContainerRegistryListRepositoryManifestsResponse as ContainerRegistryListRepositoryManifestsResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'repository_name': typing.Union[RepositoryNameSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListRepositoryManifestsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListRepositoryManifestsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_repository_manifests_mapped_args(
        self,
        registry_name: str,
        repository_name: str,
        ...
        if repository_name is not None:
            _path_params["repository_name"] = repository_name
        args.query = _query_params
        args.path = _path_params
        return args

    async def _alist_repository_manifests_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/registry/{registry_name}/repositories/{repository_name}/digests',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_repository_manifests_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListRepositoryManifestsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_repository_manifests(
        self,
        registry_name: str,
        repository_name: str,
        per_page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_repository_manifests_mapped_args(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
        )
        return await self._alist_repository_manifests_oapg(
    ...
    def list_repository_manifests(
        ...
        return self._list_repository_manifests_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRepositoryManifests(BaseApi):
    ...
    async def alist_repository_manifests(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListRepositoryManifestsResponsePydantic:
        raw_response = await self.raw.alist_repository_manifests(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
        ...
        if validate:
            return RootModel[ContainerRegistryListRepositoryManifestsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContainerRegistryListRepositoryManifestsResponsePydantic, raw_response.body)
    ...
    def list_repository_manifests(
        ...
        raw_response = self.raw.list_repository_manifests(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
