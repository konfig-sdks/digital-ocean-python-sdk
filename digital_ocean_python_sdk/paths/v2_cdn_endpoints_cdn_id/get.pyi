...
class BaseApi(api_client.Api):
    ...
    def _get_existing_endpoint_mapped_args(
        self,
        cdn_id: str,
    ...
    async def _aget_existing_endpoint_oapg(
        self,
    ...
    def _get_existing_endpoint_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExistingEndpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_existing_endpoint(
        self,
        cdn_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_existing_endpoint_mapped_args(
            cdn_id=cdn_id,
        )
        return await self._aget_existing_endpoint_oapg(
    ...
    def get_existing_endpoint(
        ...
        return self._get_existing_endpoint_oapg(
            path_params=args.path,
        )

class GetExistingEndpoint(BaseApi):
    ...
    async def aget_existing_endpoint(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_existing_endpoint(
            cdn_id=cdn_id,
            **kwargs,
        )
        if validate:
    ...
    def get_existing_endpoint(
        ...
        raw_response = self.raw.get_existing_endpoint(
            cdn_id=cdn_id,
        )
        if validate:
            return CdnEndpointsCreateNewEndpointResponsePydantic(**raw_response.body)
