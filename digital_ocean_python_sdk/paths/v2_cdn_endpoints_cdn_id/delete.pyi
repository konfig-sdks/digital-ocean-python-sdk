...
class BaseApi(api_client.Api):
    ...
    def _delete_endpoint_mapped_args(
        self,
        cdn_id: str,
    ...
    async def _adelete_endpoint_oapg(
        self,
...
class DeleteEndpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_endpoint(
        self,
        cdn_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_endpoint_mapped_args(
            cdn_id=cdn_id,
        )
        return await self._adelete_endpoint_oapg(
...
class DeleteEndpoint(BaseApi):
    ...
    async def adelete_endpoint(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_endpoint(
            cdn_id=cdn_id,
            **kwargs,
        )
    ...
    def delete_endpoint(
        ...
        raw_response = self.raw.delete_endpoint(
            cdn_id=cdn_id,
        )
