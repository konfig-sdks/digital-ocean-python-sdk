...
from digital_ocean_python_sdk.model.update_endpoint import UpdateEndpoint as UpdateEndpointSchema
...
from digital_ocean_python_sdk.type.update_endpoint import UpdateEndpoint

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.update_endpoint import UpdateEndpoint as UpdateEndpointPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'cdn_id': typing.Union[CdnIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_cdn_id = api_client.PathParameter(
    name="cdn_id",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEndpointSchema


request_body_update_endpoint = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CdnEndpointsCreateNewEndpointResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_endpoint_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_update_endpoint.serialize(body, content_type)
