...
from digital_ocean_python_sdk.model.domains_get_response import DomainsGetResponse as DomainsGetResponseSchema

from digital_ocean_python_sdk.type.domains_get_response import DomainsGetResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.domains_get_response import DomainsGetResponse as DomainsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DomainsGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainsGetResponsePydantic:
        raw_response = await self.raw.aget(
            domain_name=domain_name,
            **kwargs,
        )
        if validate:
            return DomainsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainsGetResponsePydantic, raw_response.body)
