...
from digital_ocean_python_sdk.model.apps_get_logs_response import AppsGetLogsResponse as AppsGetLogsResponseSchema

from digital_ocean_python_sdk.type.apps_get_logs_response import AppsGetLogsResponse
...
from digital_ocean_python_sdk.pydantic.apps_get_logs_response import AppsGetLogsResponse as AppsGetLogsResponsePydantic
...
class TypeSchema(
    ...
    @schemas.classproperty
    def RUN_RESTARTED(cls):
        return cls("RUN_RESTARTED")
PodConnectionTimeoutSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'pod_connection_timeout': typing.Union[PodConnectionTimeoutSchema, str, ],
    },
    total=False
)
...
request_query_pod_connection_timeout = api_client.QueryParameter(
    name="pod_connection_timeout",
    style=api_client.ParameterStyle.FORM,
    schema=PodConnectionTimeoutSchema,
    explode=True,
)
# Path params
AppIdSchema = schemas.StrSchema
ComponentNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'app_id': typing.Union[AppIdSchema, str, ],
        'component_name': typing.Union[ComponentNameSchema, str, ],
    }
)
...
request_path_component_name = api_client.PathParameter(
    name="component_name",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = AppsGetLogsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_active_deployment_logs_mapped_args(
        self,
        app_id: str,
        component_name: str,
        type: str,
        follow: typing.Optional[bool] = None,
        pod_connection_timeout: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if follow is not None:
            _query_params["follow"] = follow
        if type is not None:
            _query_params["type"] = type
        if pod_connection_timeout is not None:
            _query_params["pod_connection_timeout"] = pod_connection_timeout
    ...
    async def _aget_active_deployment_logs_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_type,
            request_query_pod_connection_timeout,
        ):
    ...
    def _get_active_deployment_logs_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetActiveDeploymentLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_active_deployment_logs(
        self,
        app_id: str,
        component_name: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._get_active_deployment_logs_mapped_args(
            app_id=app_id,
        ...
        return await self._aget_active_deployment_logs_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_active_deployment_logs(
        self,
        app_id: str,
        component_name: str,
        type: str,
        ...
        return self._get_active_deployment_logs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetActiveDeploymentLogs(BaseApi):
    ...
    async def aget_active_deployment_logs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsGetLogsResponsePydantic:
        raw_response = await self.raw.aget_active_deployment_logs(
            app_id=app_id,
            component_name=component_name,
            type=type,
            follow=follow,
        ...
        if validate:
            return AppsGetLogsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsGetLogsResponsePydantic, raw_response.body)
    ...
    def get_active_deployment_logs(
        ...
        raw_response = self.raw.get_active_deployment_logs(
            app_id=app_id,
            component_name=component_name,
            type=type,
            follow=follow,
