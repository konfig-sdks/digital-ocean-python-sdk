...
from digital_ocean_python_sdk.model.container_registry_list_options_response import ContainerRegistryListOptionsResponse as ContainerRegistryListOptionsResponseSchema

from digital_ocean_python_sdk.type.container_registry_list_options_response import ContainerRegistryListOptionsResponse
...
from digital_ocean_python_sdk.pydantic.container_registry_list_options_response import ContainerRegistryListOptionsResponse as ContainerRegistryListOptionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListOptionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListOptionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_options_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_options_oapg(
        self,
...
class ListOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_options(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_options_mapped_args(
        )
        return await self._alist_options_oapg(
            **kwargs,
        )
    ...
    def list_options(
        ...
        return self._list_options_oapg(
        )

class ListOptions(BaseApi):

    async def alist_options(
        self,
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListOptionsResponsePydantic:
        raw_response = await self.raw.alist_options(
            **kwargs,
        )
        if validate:
            return ContainerRegistryListOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContainerRegistryListOptionsResponsePydantic, raw_response.body)
    ...
    def list_options(
        ...
        raw_response = self.raw.list_options(
        )
        if validate:
            return ContainerRegistryListOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContainerRegistryListOptionsResponsePydantic, raw_response.body)
