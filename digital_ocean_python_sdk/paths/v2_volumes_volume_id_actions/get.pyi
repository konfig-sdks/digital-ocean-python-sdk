...
from digital_ocean_python_sdk.model.volume_actions_list_response import VolumeActionsListResponse as VolumeActionsListResponseSchema

from digital_ocean_python_sdk.type.volume_actions_list_response import VolumeActionsListResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.volume_actions_list_response import VolumeActionsListResponse as VolumeActionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumeActionsListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumeActionsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeActionsListResponsePydantic:
        ...
        if validate:
            return RootModel[VolumeActionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VolumeActionsListResponsePydantic, raw_response.body)
