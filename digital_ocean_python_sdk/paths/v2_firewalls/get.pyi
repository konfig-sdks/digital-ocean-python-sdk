...
from digital_ocean_python_sdk.model.firewalls_list_response import FirewallsListResponse as FirewallsListResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.firewalls_list_response import FirewallsListResponse
...
from digital_ocean_python_sdk.pydantic.firewalls_list_response import FirewallsListResponse as FirewallsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[FirewallsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FirewallsListResponsePydantic, raw_response.body)
