...
from digital_ocean_python_sdk.model.firewalls_create_request import FirewallsCreateRequest as FirewallsCreateRequestSchema
...
from digital_ocean_python_sdk.model.firewalls_create_response import FirewallsCreateResponse as FirewallsCreateResponseSchema

from digital_ocean_python_sdk.type.tags_array import TagsArray
from digital_ocean_python_sdk.type.firewalls_create_request import FirewallsCreateRequest
from digital_ocean_python_sdk.type.firewalls_create_response import FirewallsCreateResponse
...
from digital_ocean_python_sdk.pydantic.firewalls_create_request import FirewallsCreateRequest as FirewallsCreateRequestPydantic
...
from digital_ocean_python_sdk.pydantic.firewalls_create_response import FirewallsCreateResponse as FirewallsCreateResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsCreateRequestSchema


request_body_firewalls_create_request = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = FirewallsCreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        ...
        body: typing.Optional[FirewallsCreateRequest] = None,
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_create_request.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsCreateResponsePydantic:
        ...
        if validate:
            return FirewallsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsCreateResponsePydantic, raw_response.body)
