...
from digital_ocean_python_sdk.model.alert import Alert as AlertSchema
...
from digital_ocean_python_sdk.type.alert import Alert
...
from digital_ocean_python_sdk.pydantic.alert import Alert as AlertPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AlertSchema


request_body_alert = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = UptimeCreateNewAlertResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_alert_mapped_args(
        self,
        check_id: str,
    ...
    async def _acreate_new_alert_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_alert.serialize(body, content_type)
...
class CreateNewAlertRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_alert(
        self,
        check_id: str,
        id: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_alert_mapped_args(
            check_id=check_id,
            id=id,
            name=name,
            type=type,
        ...
        return await self._acreate_new_alert_oapg(
            body=args.body,
    ...
    def create_new_alert(
        ...
        return self._create_new_alert_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewAlert(BaseApi):
    ...
    async def acreate_new_alert(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_alert(
            check_id=check_id,
            id=id,
            name=name,
            type=type,
    ...
    def create_new_alert(
        ...
        raw_response = self.raw.create_new_alert(
            check_id=check_id,
            id=id,
            name=name,
            type=type,
