...
from digital_ocean_python_sdk.model.uptime_list_all_alerts_response import UptimeListAllAlertsResponse as UptimeListAllAlertsResponseSchema

from digital_ocean_python_sdk.type.uptime_list_all_alerts_response import UptimeListAllAlertsResponse
...
from digital_ocean_python_sdk.pydantic.uptime_list_all_alerts_response import UptimeListAllAlertsResponse as UptimeListAllAlertsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UptimeListAllAlertsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: UptimeListAllAlertsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_alerts_mapped_args(
        self,
        check_id: str,
    ...
    async def _alist_all_alerts_oapg(
        self,
...
class ListAllAlertsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_alerts(
        self,
        check_id: str,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_all_alerts_mapped_args(
            check_id=check_id,
            per_page=per_page,
            page=page,
        )
        return await self._alist_all_alerts_oapg(
    ...
    def list_all_alerts(
        ...
        return self._list_all_alerts_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListAllAlerts(BaseApi):
    ...
    async def alist_all_alerts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UptimeListAllAlertsResponsePydantic:
        raw_response = await self.raw.alist_all_alerts(
            check_id=check_id,
            per_page=per_page,
            page=page,
            **kwargs,
        ...
        if validate:
            return RootModel[UptimeListAllAlertsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UptimeListAllAlertsResponsePydantic, raw_response.body)
    ...
    def list_all_alerts(
        ...
        raw_response = self.raw.list_all_alerts(
            check_id=check_id,
            per_page=per_page,
            page=page,
        )
