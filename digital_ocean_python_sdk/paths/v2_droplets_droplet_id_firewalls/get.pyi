...
from digital_ocean_python_sdk.model.droplets_list_firewalls_response import DropletsListFirewallsResponse as DropletsListFirewallsResponseSchema

from digital_ocean_python_sdk.type.droplets_list_firewalls_response import DropletsListFirewallsResponse
...
from digital_ocean_python_sdk.pydantic.droplets_list_firewalls_response import DropletsListFirewallsResponse as DropletsListFirewallsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListFirewallsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListFirewallsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_firewalls_mapped_args(
        self,
        droplet_id: int,
    ...
    async def _alist_firewalls_oapg(
        self,
...
class ListFirewallsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_firewalls(
        self,
        droplet_id: int,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_firewalls_mapped_args(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
        )
        return await self._alist_firewalls_oapg(
    ...
    def list_firewalls(
        ...
        return self._list_firewalls_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListFirewalls(BaseApi):
    ...
    async def alist_firewalls(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListFirewallsResponsePydantic:
        raw_response = await self.raw.alist_firewalls(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
            **kwargs,
        ...
        if validate:
            return RootModel[DropletsListFirewallsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListFirewallsResponsePydantic, raw_response.body)
    ...
    def list_firewalls(
        ...
        raw_response = self.raw.list_firewalls(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
        )
