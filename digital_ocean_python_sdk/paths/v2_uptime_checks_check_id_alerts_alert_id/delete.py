...
class DeleteAlertRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_alert(
        self,
        check_id: str,
        alert_id: str,
        **kwargs,
        ...
        args = self._delete_alert_mapped_args(
            check_id=check_id,
            alert_id=alert_id,
        )
        return await self._adelete_alert_oapg(
    ...
    def delete_alert(
        ...
        return self._delete_alert_oapg(
            path_params=args.path,
        )

class DeleteAlert(BaseApi):
    ...
    async def adelete_alert(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_alert(
            check_id=check_id,
            alert_id=alert_id,
            **kwargs,
        )
    ...
    def delete_alert(
        ...
        raw_response = self.raw.delete_alert(
            check_id=check_id,
            alert_id=alert_id,
        )
