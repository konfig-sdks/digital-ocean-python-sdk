...
class BaseApi(api_client.Api):
    ...
    def _get_existing_alert_mapped_args(
        self,
        check_id: str,
        alert_id: str,
    ...
    async def _aget_existing_alert_oapg(
        self,
...
class GetExistingAlertRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_existing_alert(
        self,
        check_id: str,
        alert_id: str,
        **kwargs,
        ...
        args = self._get_existing_alert_mapped_args(
            check_id=check_id,
            alert_id=alert_id,
        )
        return await self._aget_existing_alert_oapg(
    ...
    def get_existing_alert(
        ...
        return self._get_existing_alert_oapg(
            path_params=args.path,
        )

class GetExistingAlert(BaseApi):
    ...
    async def aget_existing_alert(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_existing_alert(
            check_id=check_id,
            alert_id=alert_id,
            **kwargs,
        )
    ...
    def get_existing_alert(
        ...
        raw_response = self.raw.get_existing_alert(
            check_id=check_id,
            alert_id=alert_id,
        )
        if validate:
