...
from digital_ocean_python_sdk.model.uptime_create_new_alert_response import UptimeCreateNewAlertResponse as UptimeCreateNewAlertResponseSchema
from digital_ocean_python_sdk.model.alert_updatable import AlertUpdatable as AlertUpdatableSchema
from digital_ocean_python_sdk.model.notification import Notification as NotificationSchema

from digital_ocean_python_sdk.type.alert_updatable import AlertUpdatable
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.uptime_create_new_alert_response import UptimeCreateNewAlertResponse
from digital_ocean_python_sdk.type.notification import Notification

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.uptime_create_new_alert_response import UptimeCreateNewAlertResponse as UptimeCreateNewAlertResponsePydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.notification import Notification as NotificationPydantic
from digital_ocean_python_sdk.pydantic.alert_updatable import AlertUpdatable as AlertUpdatablePydantic
...
# body param
SchemaForRequestBodyApplicationJson = AlertUpdatableSchema


request_body_alert_updatable = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UptimeCreateNewAlertResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: UptimeCreateNewAlertResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_alert_settings_mapped_args(
        self,
        check_id: str,
        alert_id: str,
        ...
        notifications: typing.Optional[Notification] = None,
    ...
    async def _aupdate_alert_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_alert_updatable.serialize(body, content_type)
    ...
    def _update_alert_settings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateAlertSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_alert_settings(
        self,
        check_id: str,
        alert_id: str,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_alert_settings_mapped_args(
            check_id=check_id,
            alert_id=alert_id,
            name=name,
            type=type,
        ...
        return await self._aupdate_alert_settings_oapg(
            body=args.body,
    ...
    def update_alert_settings(
        ...
        return self._update_alert_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateAlertSettings(BaseApi):
    ...
    async def aupdate_alert_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UptimeCreateNewAlertResponsePydantic:
        raw_response = await self.raw.aupdate_alert_settings(
            check_id=check_id,
            alert_id=alert_id,
            name=name,
            type=type,
        ...
        if validate:
            return UptimeCreateNewAlertResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UptimeCreateNewAlertResponsePydantic, raw_response.body)
    ...
    def update_alert_settings(
        ...
        raw_response = self.raw.update_alert_settings(
            check_id=check_id,
            alert_id=alert_id,
            name=name,
            type=type,
