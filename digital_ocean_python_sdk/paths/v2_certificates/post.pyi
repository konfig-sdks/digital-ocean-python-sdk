...
from digital_ocean_python_sdk.model.certificates_create_request import CertificatesCreateRequest as CertificatesCreateRequestSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.certificates_create_response import CertificatesCreateResponse as CertificatesCreateResponseSchema

from digital_ocean_python_sdk.type.certificates_create_response import CertificatesCreateResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.certificates_create_request import CertificatesCreateRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.certificates_create_response import CertificatesCreateResponse as CertificatesCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.certificates_create_request import CertificatesCreateRequest as CertificatesCreateRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = CertificatesCreateRequestSchema


request_body_certificates_create_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CertificatesCreateResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: CertificatesCreateResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        self,
        body: CertificatesCreateRequest,
        name: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        dns_names: typing.Optional[typing.List[str]] = None,
        private_key: typing.Optional[str] = None,
        leaf_certificate: typing.Optional[str] = None,
        ...
        if dns_names is not None:
            _body["dns_names"] = dns_names
        if private_key is not None:
            _body["private_key"] = private_key
        if leaf_certificate is not None:
            _body["leaf_certificate"] = leaf_certificate
        if certificate_chain is not None:
            _body["certificate_chain"] = certificate_chain
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_certificates_create_request.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesCreateResponsePydantic:
        ...
        if validate:
            return CertificatesCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificatesCreateResponsePydantic, raw_response.body)
