...
from digital_ocean_python_sdk.model.certificates_list_response import CertificatesListResponse as CertificatesListResponseSchema

from digital_ocean_python_sdk.type.certificates_list_response import CertificatesListResponse
...
from digital_ocean_python_sdk.pydantic.certificates_list_response import CertificatesListResponse as CertificatesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CertificatesListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesListResponsePydantic:
        ...
        if validate:
            return RootModel[CertificatesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CertificatesListResponsePydantic, raw_response.body)
