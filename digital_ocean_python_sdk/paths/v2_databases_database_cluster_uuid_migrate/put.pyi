...
from digital_ocean_python_sdk.model.databases_migrate_cluster_to_new_region_request import DatabasesMigrateClusterToNewRegionRequest as DatabasesMigrateClusterToNewRegionRequestSchema

from digital_ocean_python_sdk.type.databases_migrate_cluster_to_new_region_request import DatabasesMigrateClusterToNewRegionRequest
...
from digital_ocean_python_sdk.pydantic.databases_migrate_cluster_to_new_region_request import DatabasesMigrateClusterToNewRegionRequest as DatabasesMigrateClusterToNewRegionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabasesMigrateClusterToNewRegionRequestSchema


request_body_databases_migrate_cluster_to_new_region_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _migrate_cluster_to_new_region_mapped_args(
        self,
        region: str,
    ...
    async def _amigrate_cluster_to_new_region_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_databases_migrate_cluster_to_new_region_request.serialize(body, content_type)
    ...
    def _migrate_cluster_to_new_region_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class MigrateClusterToNewRegionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amigrate_cluster_to_new_region(
        self,
        region: str,
        database_cluster_uuid: str,
        **kwargs,
        ...
        args = self._migrate_cluster_to_new_region_mapped_args(
            region=region,
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._amigrate_cluster_to_new_region_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def migrate_cluster_to_new_region(
        self,
        region: str,
        database_cluster_uuid: str,
    ) -> typing.Union[
        ...
        return self._migrate_cluster_to_new_region_oapg(
            body=args.body,
            path_params=args.path,
        )

class MigrateClusterToNewRegion(BaseApi):
    ...
    async def amigrate_cluster_to_new_region(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amigrate_cluster_to_new_region(
            region=region,
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
    ...
    def migrate_cluster_to_new_region(
        ...
        raw_response = self.raw.migrate_cluster_to_new_region(
            region=region,
            database_cluster_uuid=database_cluster_uuid,
        )
