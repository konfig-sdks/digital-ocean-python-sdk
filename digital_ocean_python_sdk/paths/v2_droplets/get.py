...
from digital_ocean_python_sdk.model.droplets_list_response import DropletsListResponse as DropletsListResponseSchema

from digital_ocean_python_sdk.type.droplets_list_response import DropletsListResponse
...
from digital_ocean_python_sdk.pydantic.droplets_list_response import DropletsListResponse as DropletsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[DropletsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListResponsePydantic, raw_response.body)
