...
class BaseApi(api_client.Api):
    ...
    def _delete_by_tag_mapped_args(
        self,
        tag_name: str,
    ...
    async def _adelete_by_tag_oapg(
        self,
...
class DeleteByTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_by_tag(
        self,
        tag_name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_by_tag_mapped_args(
            tag_name=tag_name,
        )
        return await self._adelete_by_tag_oapg(
    ...
    def delete_by_tag(
        ...
        return self._delete_by_tag_oapg(
            query_params=args.query,
        )

class DeleteByTag(BaseApi):
    ...
    async def adelete_by_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_by_tag(
            tag_name=tag_name,
            **kwargs,
        )
    ...
    def delete_by_tag(
        ...
        raw_response = self.raw.delete_by_tag(
            tag_name=tag_name,
        )
