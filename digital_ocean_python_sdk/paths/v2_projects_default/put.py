...
class BaseApi(api_client.Api):
    ...
    def _update_default_project_mapped_args(
        self,
    ...
    async def _aupdate_default_project_oapg(
        self,
    ...
    def _update_default_project_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateDefaultProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_default_project(
        self,
        description: typing.Optional[str] = None,
        id: typing.Optional[str] = None,
        owner_uuid: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_default_project_mapped_args(
            body=body,
        ...
        return await self._aupdate_default_project_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_default_project(
        ...
        return self._update_default_project_oapg(
            body=args.body,
        )

class UpdateDefaultProject(BaseApi):
    ...
    async def aupdate_default_project(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_default_project(
            body=body,
            description=description,
            id=id,
            owner_uuid=owner_uuid,
    ...
    def update_default_project(
        ...
        raw_response = self.raw.update_default_project(
            body=body,
            description=description,
            id=id,
            owner_uuid=owner_uuid,
