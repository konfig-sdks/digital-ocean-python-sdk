...
from digital_ocean_python_sdk.model.projects_get_default_project_response import ProjectsGetDefaultProjectResponse as ProjectsGetDefaultProjectResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.projects_get_default_project_response import ProjectsGetDefaultProjectResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.projects_get_default_project_response import ProjectsGetDefaultProjectResponse as ProjectsGetDefaultProjectResponsePydantic

RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = ProjectsGetDefaultProjectResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetDefaultProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_default_project_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_default_project_oapg(
        self,
...
class GetDefaultProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_default_project(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_default_project_mapped_args(
        )
        return await self._aget_default_project_oapg(
            **kwargs,
        )
    ...
    def get_default_project(
        ...
        return self._get_default_project_oapg(
        )

class GetDefaultProject(BaseApi):

    async def aget_default_project(
        self,
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetDefaultProjectResponsePydantic:
        raw_response = await self.raw.aget_default_project(
            **kwargs,
        )
        if validate:
            return ProjectsGetDefaultProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetDefaultProjectResponsePydantic, raw_response.body)
    ...
    def get_default_project(
        ...
        raw_response = self.raw.get_default_project(
        )
        if validate:
            return ProjectsGetDefaultProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetDefaultProjectResponsePydantic, raw_response.body)
