...
from digital_ocean_python_sdk.model.databases_get_public_certificate_response import DatabasesGetPublicCertificateResponse as DatabasesGetPublicCertificateResponseSchema

from digital_ocean_python_sdk.type.databases_get_public_certificate_response import DatabasesGetPublicCertificateResponse
...
from digital_ocean_python_sdk.pydantic.databases_get_public_certificate_response import DatabasesGetPublicCertificateResponse as DatabasesGetPublicCertificateResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesGetPublicCertificateResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesGetPublicCertificateResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_public_certificate_mapped_args(
        self,
    ...
    async def _aget_public_certificate_oapg(
        self,
    ...
    def _get_public_certificate_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPublicCertificateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_public_certificate(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_public_certificate_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_public_certificate_oapg(
    ...
    def get_public_certificate(
        ...
        return self._get_public_certificate_oapg(
            path_params=args.path,
        )

class GetPublicCertificate(BaseApi):
    ...
    async def aget_public_certificate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesGetPublicCertificateResponsePydantic:
        raw_response = await self.raw.aget_public_certificate(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesGetPublicCertificateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesGetPublicCertificateResponsePydantic, raw_response.body)
    ...
    def get_public_certificate(
        ...
        raw_response = self.raw.get_public_certificate(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesGetPublicCertificateResponsePydantic(**raw_response.body)
