...
SchemaFor201ResponseBodyApplicationJson = UptimeCreateCheckResponseSchema
...
class CreateCheckRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_check(
        self,
        name: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        target: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_check_mapped_args(
            name=name,
            type=type,
            target=target,
            regions=regions,
        ...
        return await self._acreate_check_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_check(
        ...
        return self._create_check_oapg(
            body=args.body,
        )

class CreateCheck(BaseApi):
    ...
    async def acreate_check(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_check(
            name=name,
            type=type,
            target=target,
            regions=regions,
    ...
    def create_check(
        ...
        raw_response = self.raw.create_check(
            name=name,
            type=type,
            target=target,
            regions=regions,
