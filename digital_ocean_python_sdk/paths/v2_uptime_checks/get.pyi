...
from digital_ocean_python_sdk.model.uptime_list_checks_response import UptimeListChecksResponse as UptimeListChecksResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.uptime_list_checks_response import UptimeListChecksResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.uptime_list_checks_response import UptimeListChecksResponse as UptimeListChecksResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UptimeListChecksResponseSchema
...
class ListChecksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_checks(
        self,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_checks_mapped_args(
            per_page=per_page,
            page=page,
        )
        return await self._alist_checks_oapg(
    ...
    def list_checks(
        ...
        return self._list_checks_oapg(
            query_params=args.query,
        )

class ListChecks(BaseApi):
    ...
    async def alist_checks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UptimeListChecksResponsePydantic:
        raw_response = await self.raw.alist_checks(
            per_page=per_page,
            page=page,
            **kwargs,
        )
        if validate:
            return RootModel[UptimeListChecksResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UptimeListChecksResponsePydantic, raw_response.body)
    ...
    def list_checks(
        ...
        raw_response = self.raw.list_checks(
            per_page=per_page,
            page=page,
        )
        if validate:
