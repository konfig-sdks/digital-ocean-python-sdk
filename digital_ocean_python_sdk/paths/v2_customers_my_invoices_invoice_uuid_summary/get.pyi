...
from digital_ocean_python_sdk.model.invoice_summary import InvoiceSummary as InvoiceSummarySchema

from digital_ocean_python_sdk.type.invoice_summary import InvoiceSummary
...
from digital_ocean_python_sdk.pydantic.invoice_summary import InvoiceSummary as InvoiceSummaryPydantic
...
SchemaFor200ResponseBodyApplicationJson = InvoiceSummarySchema
...
class BaseApi(api_client.Api):
    ...
    def _get_invoice_summary_by_uuid_mapped_args(
        self,
        invoice_uuid: str,
    ...
    async def _aget_invoice_summary_by_uuid_oapg(
        self,
    ...
    def _get_invoice_summary_by_uuid_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetInvoiceSummaryByUuidRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_invoice_summary_by_uuid(
        self,
        invoice_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_invoice_summary_by_uuid_mapped_args(
            invoice_uuid=invoice_uuid,
        )
        return await self._aget_invoice_summary_by_uuid_oapg(
    ...
    def get_invoice_summary_by_uuid(
        ...
        return self._get_invoice_summary_by_uuid_oapg(
            path_params=args.path,
        )

class GetInvoiceSummaryByUuid(BaseApi):
    ...
    async def aget_invoice_summary_by_uuid(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InvoiceSummaryPydantic:
        raw_response = await self.raw.aget_invoice_summary_by_uuid(
            invoice_uuid=invoice_uuid,
            **kwargs,
        )
        if validate:
            return InvoiceSummaryPydantic(**raw_response.body)
        return api_client.construct_model_instance(InvoiceSummaryPydantic, raw_response.body)
    ...
    def get_invoice_summary_by_uuid(
        ...
        raw_response = self.raw.get_invoice_summary_by_uuid(
            invoice_uuid=invoice_uuid,
        )
        if validate:
            return InvoiceSummaryPydantic(**raw_response.body)
