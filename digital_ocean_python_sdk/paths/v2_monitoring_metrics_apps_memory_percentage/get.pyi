...
from digital_ocean_python_sdk.model.metrics import Metrics as MetricsSchema

from digital_ocean_python_sdk.type.metrics import Metrics
...
from digital_ocean_python_sdk.pydantic.metrics import Metrics as MetricsPydantic

# Query params
AppIdSchema = schemas.StrSchema
AppComponentSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'app_component': typing.Union[AppComponentSchema, str, ],
    },
    total=False
)
...
request_query_app_component = api_client.QueryParameter(
    name="app_component",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = MetricsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_app_memory_percentage_metrics_mapped_args(
        self,
        app_id: str,
        start: str,
        end: str,
        app_component: typing.Optional[str] = None,
        ...
        if app_component is not None:
            _query_params["app_component"] = app_component
    ...
    async def _aget_app_memory_percentage_metrics_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/monitoring/metrics/apps/memory_percentage',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_app_memory_percentage_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAppMemoryPercentageMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_app_memory_percentage_metrics(
        self,
        app_id: str,
        start: str,
        end: str,
        ...
        **kwargs,
        ...
        args = self._get_app_memory_percentage_metrics_mapped_args(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
        )
        return await self._aget_app_memory_percentage_metrics_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_app_memory_percentage_metrics(
        self,
        app_id: str,
        start: str,
        end: str,
        ...
        return self._get_app_memory_percentage_metrics_oapg(
            query_params=args.query,
        )

class GetAppMemoryPercentageMetrics(BaseApi):
    ...
    async def aget_app_memory_percentage_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_app_memory_percentage_metrics(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
        ...
        if validate:
            return MetricsPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricsPydantic, raw_response.body)
    ...
    def get_app_memory_percentage_metrics(
        ...
        raw_response = self.raw.get_app_memory_percentage_metrics(
            app_id=app_id,
            start=start,
            end=end,
            app_component=app_component,
