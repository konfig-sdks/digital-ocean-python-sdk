...
from digital_ocean_python_sdk.model.apps_create_app_request import AppsCreateAppRequest as AppsCreateAppRequestSchema
...
from digital_ocean_python_sdk.type.apps_create_app_request import AppsCreateAppRequest
...
from digital_ocean_python_sdk.pydantic.apps_create_app_request import AppsCreateAppRequest as AppsCreateAppRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = AppsCreateAppRequestSchema


request_body_apps_create_app_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_apps_create_app_request.serialize(body, content_type)
