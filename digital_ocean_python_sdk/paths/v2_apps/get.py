...
from digital_ocean_python_sdk.model.apps_response import AppsResponse as AppsResponseSchema

from digital_ocean_python_sdk.type.apps_response import AppsResponse
...
from digital_ocean_python_sdk.pydantic.apps_response import AppsResponse as AppsResponsePydantic
...
class PerPageSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
WithProjectsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'with_projects': typing.Union[WithProjectsSchema, bool, ],
    },
    total=False
)
...
request_query_with_projects = api_client.QueryParameter(
    name="with_projects",
    style=api_client.ParameterStyle.FORM,
    schema=WithProjectsSchema,
    explode=True,
)
_auth = [
    'bearer_auth',
...
SchemaFor200ResponseBodyApplicationJson = AppsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        with_projects: typing.Optional[bool] = None,
        ...
        if with_projects is not None:
            _query_params["with_projects"] = with_projects
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[AppsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AppsResponsePydantic, raw_response.body)
