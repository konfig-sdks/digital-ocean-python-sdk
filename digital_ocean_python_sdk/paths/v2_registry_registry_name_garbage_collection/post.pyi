...
SchemaFor201ResponseBodyApplicationJson = ContainerRegistryGetActiveGarbageCollectionResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _start_garbage_collection_mapped_args(
        self,
        registry_name: str,
    ...
    async def _astart_garbage_collection_oapg(
        self,
    ...
    def _start_garbage_collection_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StartGarbageCollectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astart_garbage_collection(
        self,
        registry_name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._start_garbage_collection_mapped_args(
            registry_name=registry_name,
        )
        return await self._astart_garbage_collection_oapg(
    ...
    def start_garbage_collection(
        ...
        return self._start_garbage_collection_oapg(
            path_params=args.path,
        )

class StartGarbageCollection(BaseApi):
    ...
    async def astart_garbage_collection(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astart_garbage_collection(
            registry_name=registry_name,
            **kwargs,
        )
        if validate:
    ...
    def start_garbage_collection(
        ...
        raw_response = self.raw.start_garbage_collection(
            registry_name=registry_name,
        )
        if validate:
            return ContainerRegistryGetActiveGarbageCollectionResponsePydantic(**raw_response.body)
