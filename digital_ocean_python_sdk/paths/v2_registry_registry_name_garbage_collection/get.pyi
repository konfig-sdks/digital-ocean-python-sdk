...
class BaseApi(api_client.Api):
    ...
    def _get_active_garbage_collection_mapped_args(
        self,
        registry_name: str,
    ...
    async def _aget_active_garbage_collection_oapg(
        self,
    ...
    def _get_active_garbage_collection_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetActiveGarbageCollectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_active_garbage_collection(
        self,
        registry_name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_active_garbage_collection_mapped_args(
            registry_name=registry_name,
        )
        return await self._aget_active_garbage_collection_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_active_garbage_collection(
        self,
        registry_name: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_active_garbage_collection_oapg(
            path_params=args.path,
        )

class GetActiveGarbageCollection(BaseApi):
    ...
    async def aget_active_garbage_collection(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_active_garbage_collection(
            registry_name=registry_name,
            **kwargs,
        )
        if validate:
    ...
    def get_active_garbage_collection(
        ...
        raw_response = self.raw.get_active_garbage_collection(
            registry_name=registry_name,
        )
        if validate:
            return ContainerRegistryGetActiveGarbageCollectionResponsePydantic(**raw_response.body)
