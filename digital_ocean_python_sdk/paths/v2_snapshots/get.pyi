...
from digital_ocean_python_sdk.model.snapshots_list_response import SnapshotsListResponse as SnapshotsListResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.snapshots_list_response import SnapshotsListResponse
...
from digital_ocean_python_sdk.pydantic.snapshots_list_response import SnapshotsListResponse as SnapshotsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SnapshotsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[SnapshotsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(SnapshotsListResponsePydantic, raw_response.body)
