...
from digital_ocean_python_sdk.model.container_registry_update_subscription_tier_request import ContainerRegistryUpdateSubscriptionTierRequest as ContainerRegistryUpdateSubscriptionTierRequestSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.container_registry_update_subscription_tier_request import ContainerRegistryUpdateSubscriptionTierRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.container_registry_update_subscription_tier_request import ContainerRegistryUpdateSubscriptionTierRequest as ContainerRegistryUpdateSubscriptionTierRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ContainerRegistryUpdateSubscriptionTierRequestSchema


request_body_container_registry_update_subscription_tier_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_subscription_tier_mapped_args(
        self,
        tier_slug: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if tier_slug is not None:
            _body["tier_slug"] = tier_slug
        args.body = _body
        return args

    async def _aupdate_subscription_tier_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_container_registry_update_subscription_tier_request.serialize(body, content_type)
    ...
    def _update_subscription_tier_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateSubscriptionTierRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_subscription_tier(
        self,
        tier_slug: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_subscription_tier_mapped_args(
            tier_slug=tier_slug,
        )
        return await self._aupdate_subscription_tier_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_subscription_tier(
        ...
        return self._update_subscription_tier_oapg(
            body=args.body,
        )

class UpdateSubscriptionTier(BaseApi):
    ...
    async def aupdate_subscription_tier(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_subscription_tier(
            tier_slug=tier_slug,
            **kwargs,
        )
        if validate:
    ...
    def update_subscription_tier(
        ...
        raw_response = self.raw.update_subscription_tier(
            tier_slug=tier_slug,
        )
        if validate:
            return Dictionary(**raw_response.body)
