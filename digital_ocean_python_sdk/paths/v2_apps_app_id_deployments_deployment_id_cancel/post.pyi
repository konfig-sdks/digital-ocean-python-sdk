...
class BaseApi(api_client.Api):
    ...
    def _cancel_deployment_mapped_args(
        self,
        app_id: str,
        deployment_id: str,
    ...
    async def _acancel_deployment_oapg(
        self,
...
class CancelDeploymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_deployment(
        self,
        app_id: str,
        deployment_id: str,
        **kwargs,
        ...
        args = self._cancel_deployment_mapped_args(
            app_id=app_id,
            deployment_id=deployment_id,
        )
        return await self._acancel_deployment_oapg(
    ...
    def cancel_deployment(
        ...
        return self._cancel_deployment_oapg(
            path_params=args.path,
        )

class CancelDeployment(BaseApi):
    ...
    async def acancel_deployment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_deployment(
            app_id=app_id,
            deployment_id=deployment_id,
            **kwargs,
        )
    ...
    def cancel_deployment(
        ...
        raw_response = self.raw.cancel_deployment(
            app_id=app_id,
            deployment_id=deployment_id,
        )
        if validate:
