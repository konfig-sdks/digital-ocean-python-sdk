...
from digital_ocean_python_sdk.model.floating_ip_create import FloatingIpCreate as FloatingIpCreateSchema
from digital_ocean_python_sdk.model.floating_ips_create_response import FloatingIPsCreateResponse as FloatingIPsCreateResponseSchema

from digital_ocean_python_sdk.type.floating_ip_create import FloatingIpCreate
from digital_ocean_python_sdk.type.floating_ips_create_response import FloatingIPsCreateResponse
...
from digital_ocean_python_sdk.pydantic.floating_ips_create_response import FloatingIPsCreateResponse as FloatingIPsCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.floating_ip_create import FloatingIpCreate as FloatingIpCreatePydantic

# body param
SchemaForRequestBodyApplicationJson = FloatingIpCreateSchema


request_body_floating_ip_create = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = FloatingIPsCreateResponseSchema
...
class ApiResponseFor202(api_client.ApiResponse):
    body: FloatingIPsCreateResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        self,
        body: typing.Optional[FloatingIpCreate] = None,
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_floating_ip_create.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsCreateResponsePydantic:
        ...
        if validate:
            return FloatingIPsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsCreateResponsePydantic, raw_response.body)
