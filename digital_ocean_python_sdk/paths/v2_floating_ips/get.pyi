...
from digital_ocean_python_sdk.model.floating_ips_list_response import FloatingIPsListResponse as FloatingIPsListResponseSchema

from digital_ocean_python_sdk.type.floating_ips_list_response import FloatingIPsListResponse
...
from digital_ocean_python_sdk.pydantic.floating_ips_list_response import FloatingIPsListResponse as FloatingIPsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIPsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsListResponsePydantic:
        ...
        if validate:
            return RootModel[FloatingIPsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FloatingIPsListResponsePydantic, raw_response.body)
