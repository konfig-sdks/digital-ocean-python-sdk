...
from digital_ocean_python_sdk.model.registry_create import RegistryCreate as RegistryCreateSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.registry_create import RegistryCreate

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.registry_create import RegistryCreate as RegistryCreatePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = RegistryCreateSchema


request_body_registry_create = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        ...
        if subscription_tier_slug is not None:
            _body["subscription_tier_slug"] = subscription_tier_slug
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_registry_create.serialize(body, content_type)
