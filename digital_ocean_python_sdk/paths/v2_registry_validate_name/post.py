...
from digital_ocean_python_sdk.model.validate_registry import ValidateRegistry as ValidateRegistrySchema

from digital_ocean_python_sdk.type.validate_registry import ValidateRegistry
...
from digital_ocean_python_sdk.pydantic.validate_registry import ValidateRegistry as ValidateRegistryPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ValidateRegistrySchema


request_body_validate_registry = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _validate_name_mapped_args(
        self,
        name: str,
    ...
    async def _avalidate_name_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_validate_registry.serialize(body, content_type)
...
class ValidateNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_name(
        self,
        name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._validate_name_mapped_args(
            name=name,
        )
        return await self._avalidate_name_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def validate_name(
        ...
        return self._validate_name_oapg(
            body=args.body,
        )

class ValidateName(BaseApi):
    ...
    async def avalidate_name(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avalidate_name(
            name=name,
            **kwargs,
        )
    ...
    def validate_name(
        ...
        raw_response = self.raw.validate_name(
            name=name,
        )
