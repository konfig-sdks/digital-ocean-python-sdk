...
from digital_ocean_python_sdk.model.functions_list_namespaces_response import FunctionsListNamespacesResponse as FunctionsListNamespacesResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.functions_list_namespaces_response import FunctionsListNamespacesResponse
...
from digital_ocean_python_sdk.pydantic.functions_list_namespaces_response import FunctionsListNamespacesResponse as FunctionsListNamespacesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FunctionsListNamespacesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FunctionsListNamespacesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_namespaces_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_namespaces_oapg(
        self,
...
class ListNamespacesRaw(BaseApi):
    ...
    async def alist_namespaces(
        ...
        **kwargs,
        ...
        args = self._list_namespaces_mapped_args(
        )
        return await self._alist_namespaces_oapg(
            **kwargs,
        )
    ...
    def list_namespaces(
        ...
        return self._list_namespaces_oapg(
        )

class ListNamespaces(BaseApi):

    async def alist_namespaces(
        self,
        validate: bool = False,
        **kwargs,
    ) -> FunctionsListNamespacesResponsePydantic:
        raw_response = await self.raw.alist_namespaces(
            **kwargs,
        )
        if validate:
            return RootModel[FunctionsListNamespacesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FunctionsListNamespacesResponsePydantic, raw_response.body)
    ...
    def list_namespaces(
        ...
        raw_response = self.raw.list_namespaces(
        )
        if validate:
            return RootModel[FunctionsListNamespacesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FunctionsListNamespacesResponsePydantic, raw_response.body)
