...
from digital_ocean_python_sdk.model.create_namespace import CreateNamespace as CreateNamespaceSchema
from digital_ocean_python_sdk.model.functions_create_namespace_response import FunctionsCreateNamespaceResponse as FunctionsCreateNamespaceResponseSchema

from digital_ocean_python_sdk.type.functions_create_namespace_response import FunctionsCreateNamespaceResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.create_namespace import CreateNamespace

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.create_namespace import CreateNamespace as CreateNamespacePydantic
from digital_ocean_python_sdk.pydantic.functions_create_namespace_response import FunctionsCreateNamespaceResponse as FunctionsCreateNamespaceResponsePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateNamespaceSchema


request_body_create_namespace = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FunctionsCreateNamespaceResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FunctionsCreateNamespaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_namespace_mapped_args(
        self,
        region: str,
        label: str,
    ...
    async def _acreate_namespace_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_namespace.serialize(body, content_type)
...
class CreateNamespaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_namespace(
        self,
        region: str,
        label: str,
        **kwargs,
        ...
        args = self._create_namespace_mapped_args(
            region=region,
            label=label,
        )
        return await self._acreate_namespace_oapg(
            body=args.body,
            **kwargs,
        )
...
class CreateNamespace(BaseApi):
    ...
    async def acreate_namespace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FunctionsCreateNamespaceResponsePydantic:
        raw_response = await self.raw.acreate_namespace(
            region=region,
            label=label,
            **kwargs,
        )
        if validate:
            return FunctionsCreateNamespaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FunctionsCreateNamespaceResponsePydantic, raw_response.body)
    ...
    def create_namespace(
        ...
        raw_response = self.raw.create_namespace(
            region=region,
            label=label,
        )
        if validate:
