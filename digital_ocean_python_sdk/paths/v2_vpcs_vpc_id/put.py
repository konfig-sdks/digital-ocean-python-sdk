...
from digital_ocean_python_sdk.model.vpcs_create_response import VpcsCreateResponse as VpcsCreateResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.vpcs_update_request import VpcsUpdateRequest as VpcsUpdateRequestSchema

from digital_ocean_python_sdk.type.vpcs_update_request import VpcsUpdateRequest
from digital_ocean_python_sdk.type.vpcs_create_response import VpcsCreateResponse
...
from digital_ocean_python_sdk.pydantic.vpcs_create_response import VpcsCreateResponse as VpcsCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.vpcs_update_request import VpcsUpdateRequest as VpcsUpdateRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'vpc_id': typing.Union[VpcIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = VpcsUpdateRequestSchema


request_body_vpcs_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = VpcsCreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_vpcs_update_request.serialize(body, content_type)
...
class Update(BaseApi):
    ...
    async def aupdate(
        ...
        **kwargs,
        ...
        if validate:
            return VpcsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VpcsCreateResponsePydantic, raw_response.body)
