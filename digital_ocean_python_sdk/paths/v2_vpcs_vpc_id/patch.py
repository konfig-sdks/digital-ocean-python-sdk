...
from digital_ocean_python_sdk.model.vpcs_patch_request import VpcsPatchRequest as VpcsPatchRequestSchema

from digital_ocean_python_sdk.type.vpcs_patch_request import VpcsPatchRequest
...
from digital_ocean_python_sdk.pydantic.vpcs_patch_request import VpcsPatchRequest as VpcsPatchRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VpcsPatchRequestSchema


request_body_vpcs_patch_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _apatch_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_vpcs_patch_request.serialize(body, content_type)
