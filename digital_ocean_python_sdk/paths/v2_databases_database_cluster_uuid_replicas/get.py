...
from digital_ocean_python_sdk.model.databases_list_read_only_replicas_response import DatabasesListReadOnlyReplicasResponse as DatabasesListReadOnlyReplicasResponseSchema

from digital_ocean_python_sdk.type.databases_list_read_only_replicas_response import DatabasesListReadOnlyReplicasResponse
...
from digital_ocean_python_sdk.pydantic.databases_list_read_only_replicas_response import DatabasesListReadOnlyReplicasResponse as DatabasesListReadOnlyReplicasResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListReadOnlyReplicasResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListReadOnlyReplicasResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_read_only_replicas_mapped_args(
        self,
    ...
    async def _alist_read_only_replicas_oapg(
        self,
    ...
    def _list_read_only_replicas_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListReadOnlyReplicasRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_read_only_replicas(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_read_only_replicas_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_read_only_replicas_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_read_only_replicas(
        self,
        database_cluster_uuid: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_read_only_replicas_oapg(
            path_params=args.path,
        )

class ListReadOnlyReplicas(BaseApi):
    ...
    async def alist_read_only_replicas(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListReadOnlyReplicasResponsePydantic:
        raw_response = await self.raw.alist_read_only_replicas(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListReadOnlyReplicasResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListReadOnlyReplicasResponsePydantic, raw_response.body)
    ...
    def list_read_only_replicas(
        ...
        raw_response = self.raw.list_read_only_replicas(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesListReadOnlyReplicasResponsePydantic(**raw_response.body)
