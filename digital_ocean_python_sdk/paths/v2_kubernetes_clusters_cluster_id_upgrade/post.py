...
from digital_ocean_python_sdk.model.kubernetes_upgrade_cluster_request import KubernetesUpgradeClusterRequest as KubernetesUpgradeClusterRequestSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.kubernetes_upgrade_cluster_request import KubernetesUpgradeClusterRequest
...
from digital_ocean_python_sdk.pydantic.kubernetes_upgrade_cluster_request import KubernetesUpgradeClusterRequest as KubernetesUpgradeClusterRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = KubernetesUpgradeClusterRequestSchema


request_body_kubernetes_upgrade_cluster_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upgrade_cluster_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _aupgrade_cluster_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_kubernetes_upgrade_cluster_request.serialize(body, content_type)
...
class UpgradeClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupgrade_cluster(
        self,
        cluster_id: str,
        version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._upgrade_cluster_mapped_args(
            body=body,
            cluster_id=cluster_id,
            version=version,
        )
        return await self._aupgrade_cluster_oapg(
            body=args.body,
    ...
    def upgrade_cluster(
        ...
        return self._upgrade_cluster_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpgradeCluster(BaseApi):
    ...
    async def aupgrade_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupgrade_cluster(
            body=body,
            cluster_id=cluster_id,
            version=version,
            **kwargs,
    ...
    def upgrade_cluster(
        ...
        raw_response = self.raw.upgrade_cluster(
            body=body,
            cluster_id=cluster_id,
            version=version,
        )
