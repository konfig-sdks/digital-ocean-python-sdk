...
from digital_ocean_python_sdk.model.load_balancers_add_forwarding_rules_request import LoadBalancersAddForwardingRulesRequest as LoadBalancersAddForwardingRulesRequestSchema
...
from digital_ocean_python_sdk.type.load_balancers_add_forwarding_rules_request import LoadBalancersAddForwardingRulesRequest
...
from digital_ocean_python_sdk.pydantic.load_balancers_add_forwarding_rules_request import LoadBalancersAddForwardingRulesRequest as LoadBalancersAddForwardingRulesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancersAddForwardingRulesRequestSchema


request_body_load_balancers_add_forwarding_rules_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_forwarding_rules_mapped_args(
        self,
    ...
    async def _aadd_forwarding_rules_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_load_balancers_add_forwarding_rules_request.serialize(body, content_type)
    ...
    def _add_forwarding_rules_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddForwardingRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_forwarding_rules(
        self,
        forwarding_rules: typing.List[ForwardingRule],
        lb_id: str,
        **kwargs,
        ...
        args = self._add_forwarding_rules_mapped_args(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
        )
        return await self._aadd_forwarding_rules_oapg(
            body=args.body,
    ...
    def add_forwarding_rules(
        ...
        return self._add_forwarding_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddForwardingRules(BaseApi):
    ...
    async def aadd_forwarding_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_forwarding_rules(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
            **kwargs,
    ...
    def add_forwarding_rules(
        ...
        raw_response = self.raw.add_forwarding_rules(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
        )
