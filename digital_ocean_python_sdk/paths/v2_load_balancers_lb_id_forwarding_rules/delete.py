...
from digital_ocean_python_sdk.model.load_balancers_remove_forwarding_rules_request import LoadBalancersRemoveForwardingRulesRequest as LoadBalancersRemoveForwardingRulesRequestSchema

from digital_ocean_python_sdk.type.forwarding_rule import ForwardingRule
from digital_ocean_python_sdk.type.load_balancers_remove_forwarding_rules_request import LoadBalancersRemoveForwardingRulesRequest
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.load_balancers_remove_forwarding_rules_request import LoadBalancersRemoveForwardingRulesRequest as LoadBalancersRemoveForwardingRulesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LoadBalancersRemoveForwardingRulesRequestSchema


request_body_load_balancers_remove_forwarding_rules_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_forwarding_rules_mapped_args(
        self,
        forwarding_rules: typing.List[ForwardingRule],
        lb_id: str,
    ...
    async def _aremove_forwarding_rules_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_load_balancers_remove_forwarding_rules_request.serialize(body, content_type)
    ...
    def _remove_forwarding_rules_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RemoveForwardingRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_forwarding_rules(
        self,
        forwarding_rules: typing.List[ForwardingRule],
        lb_id: str,
        **kwargs,
        ...
        args = self._remove_forwarding_rules_mapped_args(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
        )
        return await self._aremove_forwarding_rules_oapg(
            body=args.body,
    ...
    def remove_forwarding_rules(
        ...
        return self._remove_forwarding_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveForwardingRules(BaseApi):
    ...
    async def aremove_forwarding_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_forwarding_rules(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
            **kwargs,
    ...
    def remove_forwarding_rules(
        ...
        raw_response = self.raw.remove_forwarding_rules(
            body=body,
            forwarding_rules=forwarding_rules,
            lb_id=lb_id,
        )
