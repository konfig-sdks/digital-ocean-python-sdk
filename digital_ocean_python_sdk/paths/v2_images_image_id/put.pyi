...
from digital_ocean_python_sdk.model.image_update import ImageUpdate as ImageUpdateSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.images_update_response import ImagesUpdateResponse as ImagesUpdateResponseSchema

from digital_ocean_python_sdk.type.images_update_response import ImagesUpdateResponse
from digital_ocean_python_sdk.type.image_update import ImageUpdate
...
from digital_ocean_python_sdk.pydantic.image_update import ImageUpdate as ImageUpdatePydantic
...
from digital_ocean_python_sdk.pydantic.images_update_response import ImagesUpdateResponse as ImagesUpdateResponsePydantic

# Path params
ImageIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'image_id': typing.Union[ImageIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ImageUpdateSchema


request_body_image_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ImagesUpdateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_image_update.serialize(body, content_type)
...
class Update(BaseApi):
    ...
    async def aupdate(
        ...
        **kwargs,
        ...
        if validate:
            return ImagesUpdateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagesUpdateResponsePydantic, raw_response.body)
