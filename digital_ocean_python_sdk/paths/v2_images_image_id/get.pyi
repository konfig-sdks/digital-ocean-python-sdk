...
from digital_ocean_python_sdk.model.images_get_response import ImagesGetResponse as ImagesGetResponseSchema

from digital_ocean_python_sdk.type.images_get_response import ImagesGetResponse
...
from digital_ocean_python_sdk.pydantic.images_get_response import ImagesGetResponse as ImagesGetResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'image_id': typing.Union[ImageIdSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = ImagesGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ImagesGetResponsePydantic:
        raw_response = await self.raw.aget(
            image_id=image_id,
            **kwargs,
        )
        if validate:
            return ImagesGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImagesGetResponsePydantic, raw_response.body)
