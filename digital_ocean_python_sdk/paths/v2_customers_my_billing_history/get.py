...
from digital_ocean_python_sdk.model.billing_history_list_response import BillingHistoryListResponse as BillingHistoryListResponseSchema

from digital_ocean_python_sdk.type.billing_history_list_response import BillingHistoryListResponse
...
from digital_ocean_python_sdk.pydantic.billing_history_list_response import BillingHistoryListResponse as BillingHistoryListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BillingHistoryListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: BillingHistoryListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BillingHistoryListResponsePydantic:
        raw_response = await self.raw.alist(
            **kwargs,
        )
        if validate:
            return RootModel[BillingHistoryListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BillingHistoryListResponsePydantic, raw_response.body)
