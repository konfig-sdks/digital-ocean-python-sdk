...
class BaseApi(api_client.Api):
    ...
    def _get_existing_record_mapped_args(
        self,
        domain_name: str,
    ...
    async def _aget_existing_record_oapg(
        self,
...
class GetExistingRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_existing_record(
        self,
        domain_name: str,
        domain_record_id: int,
        **kwargs,
        ...
        args = self._get_existing_record_mapped_args(
            domain_name=domain_name,
            domain_record_id=domain_record_id,
        )
        return await self._aget_existing_record_oapg(
    ...
    def get_existing_record(
        ...
        return self._get_existing_record_oapg(
            path_params=args.path,
        )

class GetExistingRecord(BaseApi):
    ...
    async def aget_existing_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_existing_record(
            domain_name=domain_name,
            domain_record_id=domain_record_id,
            **kwargs,
        )
    ...
    def get_existing_record(
        ...
        raw_response = self.raw.get_existing_record(
            domain_name=domain_name,
            domain_record_id=domain_record_id,
        )
        if validate:
