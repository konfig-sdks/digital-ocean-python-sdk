...
class BaseApi(api_client.Api):
    ...
    def _update_record_by_id_mapped_args(
        self,
        type: str,
        domain_name: str,
    ...
    async def _aupdate_record_by_id_oapg(
        self,
...
class UpdateRecordByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_record_by_id(
        self,
        type: str,
        domain_name: str,
        domain_record_id: int,
        ...
        **kwargs,
        ...
        args = self._update_record_by_id_mapped_args(
            type=type,
        ...
        return await self._aupdate_record_by_id_oapg(
            body=args.body,
    ...
    def update_record_by_id(
        ...
        return self._update_record_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRecordById(BaseApi):
    ...
    async def aupdate_record_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_record_by_id(
            type=type,
            domain_name=domain_name,
            domain_record_id=domain_record_id,
            id=id,
    ...
    def update_record_by_id(
        ...
        raw_response = self.raw.update_record_by_id(
            type=type,
            domain_name=domain_name,
            domain_record_id=domain_record_id,
            id=id,
