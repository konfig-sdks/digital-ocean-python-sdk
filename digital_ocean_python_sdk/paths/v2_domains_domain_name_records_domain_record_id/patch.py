...
from digital_ocean_python_sdk.model.domain_records_get_existing_record_response import DomainRecordsGetExistingRecordResponse as DomainRecordsGetExistingRecordResponseSchema
from digital_ocean_python_sdk.model.domain_record import DomainRecord as DomainRecordSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.domain_records_get_existing_record_response import DomainRecordsGetExistingRecordResponse
from digital_ocean_python_sdk.type.domain_record import DomainRecord

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.domain_records_get_existing_record_response import DomainRecordsGetExistingRecordResponse as DomainRecordsGetExistingRecordResponsePydantic
from digital_ocean_python_sdk.pydantic.domain_record import DomainRecord as DomainRecordPydantic

from . import path

# Path params
DomainNameSchema = schemas.StrSchema
DomainRecordIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'domain_name': typing.Union[DomainNameSchema, str, ],
        'domain_record_id': typing.Union[DomainRecordIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_domain_record_id = api_client.PathParameter(
    name="domain_record_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DomainRecordIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = DomainRecordSchema


request_body_domain_record = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DomainRecordsGetExistingRecordResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DomainRecordsGetExistingRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_record_by_id_0_mapped_args(
        self,
        type: str,
        domain_name: str,
        ...
        priority: typing.Optional[typing.Optional[int]] = None,
        port: typing.Optional[typing.Optional[int]] = None,
        ttl: typing.Optional[int] = None,
        weight: typing.Optional[typing.Optional[int]] = None,
        flags: typing.Optional[typing.Optional[int]] = None,
        ...
        if domain_record_id is not None:
            _path_params["domain_record_id"] = domain_record_id
        args.path = _path_params
        return args

    async def _aupdate_record_by_id_0_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_domain_record.serialize(body, content_type)
    ...
    def _update_record_by_id_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateRecordById0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_record_by_id_0(
        self,
        type: str,
        domain_name: str,
        domain_record_id: int,
        ...
        **kwargs,
        ...
        args = self._update_record_by_id_0_mapped_args(
            type=type,
        ...
        return await self._aupdate_record_by_id_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_record_by_id_0(
        self,
        type: str,
        domain_name: str,
        domain_record_id: int,
        ...
        return self._update_record_by_id_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRecordById0(BaseApi):
    ...
    async def aupdate_record_by_id_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainRecordsGetExistingRecordResponsePydantic:
        raw_response = await self.raw.aupdate_record_by_id_0(
            type=type,
            domain_name=domain_name,
            domain_record_id=domain_record_id,
            id=id,
        ...
        if validate:
            return DomainRecordsGetExistingRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainRecordsGetExistingRecordResponsePydantic, raw_response.body)
    ...
    def update_record_by_id_0(
        ...
        raw_response = self.raw.update_record_by_id_0(
            type=type,
            domain_name=domain_name,
            domain_record_id=domain_record_id,
            id=id,
