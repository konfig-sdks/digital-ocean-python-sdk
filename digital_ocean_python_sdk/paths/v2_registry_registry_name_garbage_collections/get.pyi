...
from digital_ocean_python_sdk.model.container_registry_list_garbage_collections_response import ContainerRegistryListGarbageCollectionsResponse as ContainerRegistryListGarbageCollectionsResponseSchema

from digital_ocean_python_sdk.type.container_registry_list_garbage_collections_response import ContainerRegistryListGarbageCollectionsResponse
...
from digital_ocean_python_sdk.pydantic.container_registry_list_garbage_collections_response import ContainerRegistryListGarbageCollectionsResponse as ContainerRegistryListGarbageCollectionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListGarbageCollectionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListGarbageCollectionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_garbage_collections_mapped_args(
        self,
        registry_name: str,
    ...
    async def _alist_garbage_collections_oapg(
        self,
    ...
    def _list_garbage_collections_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListGarbageCollectionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_garbage_collections(
        self,
        registry_name: str,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_garbage_collections_mapped_args(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
        )
        return await self._alist_garbage_collections_oapg(
    ...
    def list_garbage_collections(
        ...
        return self._list_garbage_collections_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListGarbageCollections(BaseApi):
    ...
    async def alist_garbage_collections(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListGarbageCollectionsResponsePydantic:
        raw_response = await self.raw.alist_garbage_collections(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
            **kwargs,
        ...
        if validate:
            return ContainerRegistryListGarbageCollectionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContainerRegistryListGarbageCollectionsResponsePydantic, raw_response.body)
    ...
    def list_garbage_collections(
        ...
        raw_response = self.raw.list_garbage_collections(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
        )
