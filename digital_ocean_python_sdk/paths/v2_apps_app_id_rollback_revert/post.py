...
class BaseApi(api_client.Api):
    ...
    def _revert_rollback_mapped_args(
        self,
        app_id: str,
    ...
    async def _arevert_rollback_oapg(
        self,
...
class RevertRollbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevert_rollback(
        self,
        app_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._revert_rollback_mapped_args(
            app_id=app_id,
        )
        return await self._arevert_rollback_oapg(
    ...
    def revert_rollback(
        ...
        return self._revert_rollback_oapg(
            path_params=args.path,
        )

class RevertRollback(BaseApi):
    ...
    async def arevert_rollback(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arevert_rollback(
            app_id=app_id,
            **kwargs,
        )
        if validate:
    ...
    def revert_rollback(
        ...
        raw_response = self.raw.revert_rollback(
            app_id=app_id,
        )
        if validate:
            return AppsDeploymentResponsePydantic(**raw_response.body)
