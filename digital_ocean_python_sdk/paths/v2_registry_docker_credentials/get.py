...
from digital_ocean_python_sdk.model.docker_credentials import DockerCredentials as DockerCredentialsSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.docker_credentials import DockerCredentials

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.docker_credentials import DockerCredentials as DockerCredentialsPydantic
...
class ExpirySecondsSchema(
    ...
    class MetaOapg:
        inclusive_minimum = 0
ReadWriteSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'expiry_seconds': typing.Union[ExpirySecondsSchema, decimal.Decimal, int, ],
        'read_write': typing.Union[ReadWriteSchema, bool, ],
    },
    total=False
)
...
request_query_expiry_seconds = api_client.QueryParameter(
    name="expiry_seconds",
    style=api_client.ParameterStyle.FORM,
    schema=ExpirySecondsSchema,
    explode=True,
)
request_query_read_write = api_client.QueryParameter(
    name="read_write",
    style=api_client.ParameterStyle.FORM,
    schema=ReadWriteSchema,
    explode=True,
)
_auth = [
    'bearer_auth',
...
SchemaFor200ResponseBodyApplicationJson = DockerCredentialsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_docker_credentials_mapped_args(
        self,
        expiry_seconds: typing.Optional[int] = None,
        read_write: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        if expiry_seconds is not None:
            _query_params["expiry_seconds"] = expiry_seconds
        if read_write is not None:
            _query_params["read_write"] = read_write
        args.query = _query_params
        return args

    async def _aget_docker_credentials_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_expiry_seconds,
            request_query_read_write,
        ):
    ...
    def _get_docker_credentials_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDockerCredentialsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_docker_credentials(
        self,
        expiry_seconds: typing.Optional[int] = None,
        read_write: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._get_docker_credentials_mapped_args(
            expiry_seconds=expiry_seconds,
            read_write=read_write,
        )
        return await self._aget_docker_credentials_oapg(
    ...
    def get_docker_credentials(
        ...
        return self._get_docker_credentials_oapg(
            query_params=args.query,
        )

class GetDockerCredentials(BaseApi):
    ...
    async def aget_docker_credentials(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DockerCredentialsPydantic:
        raw_response = await self.raw.aget_docker_credentials(
            expiry_seconds=expiry_seconds,
            read_write=read_write,
            **kwargs,
        )
        if validate:
            return DockerCredentialsPydantic(**raw_response.body)
        return api_client.construct_model_instance(DockerCredentialsPydantic, raw_response.body)
    ...
    def get_docker_credentials(
        ...
        raw_response = self.raw.get_docker_credentials(
            expiry_seconds=expiry_seconds,
            read_write=read_write,
        )
        if validate:
