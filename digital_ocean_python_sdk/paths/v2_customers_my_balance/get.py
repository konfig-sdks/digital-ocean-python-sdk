...
from digital_ocean_python_sdk.model.balance import Balance as BalanceSchema

from digital_ocean_python_sdk.type.balance import Balance
...
from digital_ocean_python_sdk.pydantic.balance import Balance as BalancePydantic
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        **kwargs,
        ...
        if validate:
            return BalancePydantic(**raw_response.body)
        return api_client.construct_model_instance(BalancePydantic, raw_response.body)
