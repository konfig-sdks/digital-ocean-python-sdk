...
from digital_ocean_python_sdk.model.volume_snapshots_list_response import VolumeSnapshotsListResponse as VolumeSnapshotsListResponseSchema

from digital_ocean_python_sdk.type.volume_snapshots_list_response import VolumeSnapshotsListResponse
...
from digital_ocean_python_sdk.pydantic.volume_snapshots_list_response import VolumeSnapshotsListResponse as VolumeSnapshotsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VolumeSnapshotsListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: VolumeSnapshotsListResponse
...
class List0(BaseApi):
    ...
    async def alist_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VolumeSnapshotsListResponsePydantic:
        ...
        if validate:
            return RootModel[VolumeSnapshotsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VolumeSnapshotsListResponsePydantic, raw_response.body)
