...
class BaseApi(api_client.Api):
    ...
    def _get_active_deployment_logs_0_mapped_args(
        self,
        app_id: str,
        type: str,
    ...
    async def _aget_active_deployment_logs_0_oapg(
        self,
    ...
    def _get_active_deployment_logs_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetActiveDeploymentLogs0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_active_deployment_logs_0(
        self,
        app_id: str,
        type: str,
        follow: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_active_deployment_logs_0_mapped_args(
            app_id=app_id,
            type=type,
            follow=follow,
            pod_connection_timeout=pod_connection_timeout,
        )
        return await self._aget_active_deployment_logs_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_active_deployment_logs_0(
        self,
        app_id: str,
        type: str,
        follow: typing.Optional[bool] = None,
        ...
        return self._get_active_deployment_logs_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetActiveDeploymentLogs0(BaseApi):
    ...
    async def aget_active_deployment_logs_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_active_deployment_logs_0(
            app_id=app_id,
            type=type,
            follow=follow,
            pod_connection_timeout=pod_connection_timeout,
    ...
    def get_active_deployment_logs_0(
        ...
        raw_response = self.raw.get_active_deployment_logs_0(
            app_id=app_id,
            type=type,
            follow=follow,
            pod_connection_timeout=pod_connection_timeout,
