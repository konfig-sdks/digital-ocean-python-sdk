...
from digital_ocean_python_sdk.model.uptime_create_check_response import UptimeCreateCheckResponse as UptimeCreateCheckResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.check_updatable import CheckUpdatable as CheckUpdatableSchema
from digital_ocean_python_sdk.model.check_updatable_regions import CheckUpdatableRegions as CheckUpdatableRegionsSchema

from digital_ocean_python_sdk.type.uptime_create_check_response import UptimeCreateCheckResponse
from digital_ocean_python_sdk.type.check_updatable import CheckUpdatable
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.check_updatable_regions import CheckUpdatableRegions

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.uptime_create_check_response import UptimeCreateCheckResponse as UptimeCreateCheckResponsePydantic
from digital_ocean_python_sdk.pydantic.check_updatable import CheckUpdatable as CheckUpdatablePydantic
from digital_ocean_python_sdk.pydantic.check_updatable_regions import CheckUpdatableRegions as CheckUpdatableRegionsPydantic

from . import path

# Path params
CheckIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'check_id': typing.Union[CheckIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = CheckUpdatableSchema


request_body_check_updatable = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UptimeCreateCheckResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: UptimeCreateCheckResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_check_settings_mapped_args(
        self,
        check_id: str,
        name: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        target: typing.Optional[str] = None,
        regions: typing.Optional[CheckUpdatableRegions] = None,
    ...
    async def _aupdate_check_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_check_updatable.serialize(body, content_type)
    ...
    def _update_check_settings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCheckSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_check_settings(
        self,
        check_id: str,
        name: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_check_settings_mapped_args(
            check_id=check_id,
            name=name,
            type=type,
            target=target,
        ...
        return await self._aupdate_check_settings_oapg(
            body=args.body,
    ...
    def update_check_settings(
        ...
        return self._update_check_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateCheckSettings(BaseApi):
    ...
    async def aupdate_check_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UptimeCreateCheckResponsePydantic:
        raw_response = await self.raw.aupdate_check_settings(
            check_id=check_id,
            name=name,
            type=type,
            target=target,
        ...
        if validate:
            return UptimeCreateCheckResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UptimeCreateCheckResponsePydantic, raw_response.body)
    ...
    def update_check_settings(
        ...
        raw_response = self.raw.update_check_settings(
            check_id=check_id,
            name=name,
            type=type,
            target=target,
