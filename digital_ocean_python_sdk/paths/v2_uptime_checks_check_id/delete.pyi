...
class DeleteCheckRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_check(
        self,
        check_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_check_mapped_args(
            check_id=check_id,
        )
        return await self._adelete_check_oapg(
    ...
    def delete_check(
        ...
        return self._delete_check_oapg(
            path_params=args.path,
        )

class DeleteCheck(BaseApi):
    ...
    async def adelete_check(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_check(
            check_id=check_id,
            **kwargs,
        )
    ...
    def delete_check(
        ...
        raw_response = self.raw.delete_check(
            check_id=check_id,
        )
