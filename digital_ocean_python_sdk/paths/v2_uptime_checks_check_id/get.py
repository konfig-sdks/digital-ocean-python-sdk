...
class BaseApi(api_client.Api):
    ...
    def _get_check_by_id_mapped_args(
        self,
        check_id: str,
    ...
    async def _aget_check_by_id_oapg(
        self,
...
class GetCheckByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_check_by_id(
        self,
        check_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_check_by_id_mapped_args(
            check_id=check_id,
        )
        return await self._aget_check_by_id_oapg(
    ...
    def get_check_by_id(
        ...
        return self._get_check_by_id_oapg(
            path_params=args.path,
        )

class GetCheckById(BaseApi):
    ...
    async def aget_check_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_check_by_id(
            check_id=check_id,
            **kwargs,
        )
        if validate:
    ...
    def get_check_by_id(
        ...
        raw_response = self.raw.get_check_by_id(
            check_id=check_id,
        )
        if validate:
            return UptimeCreateCheckResponsePydantic(**raw_response.body)
