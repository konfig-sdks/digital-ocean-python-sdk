...
from digital_ocean_python_sdk.model.connection_pools import ConnectionPools as ConnectionPoolsSchema

from digital_ocean_python_sdk.type.connection_pools import ConnectionPools
...
from digital_ocean_python_sdk.pydantic.connection_pools import ConnectionPools as ConnectionPoolsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ConnectionPoolsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_connection_pools_mapped_args(
        self,
    ...
    async def _alist_connection_pools_oapg(
        self,
    ...
    def _list_connection_pools_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListConnectionPoolsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_connection_pools(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_connection_pools_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_connection_pools_oapg(
    ...
    def list_connection_pools(
        ...
        return self._list_connection_pools_oapg(
            path_params=args.path,
        )

class ListConnectionPools(BaseApi):
    ...
    async def alist_connection_pools(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ConnectionPoolsPydantic:
        raw_response = await self.raw.alist_connection_pools(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return ConnectionPoolsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ConnectionPoolsPydantic, raw_response.body)
    ...
    def list_connection_pools(
        ...
        raw_response = self.raw.list_connection_pools(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return ConnectionPoolsPydantic(**raw_response.body)
