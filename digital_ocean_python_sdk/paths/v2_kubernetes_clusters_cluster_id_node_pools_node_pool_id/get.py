...
from digital_ocean_python_sdk.model.kubernetes_get_node_pool_response import KubernetesGetNodePoolResponse as KubernetesGetNodePoolResponseSchema

from digital_ocean_python_sdk.type.kubernetes_get_node_pool_response import KubernetesGetNodePoolResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.kubernetes_get_node_pool_response import KubernetesGetNodePoolResponse as KubernetesGetNodePoolResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = KubernetesGetNodePoolResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: KubernetesGetNodePoolResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_node_pool_mapped_args(
        self,
        cluster_id: str,
        node_pool_id: str,
    ...
    async def _aget_node_pool_oapg(
        self,
...
class GetNodePoolRaw(BaseApi):
    ...
    async def aget_node_pool(
        ...
        **kwargs,
        ...
        args = self._get_node_pool_mapped_args(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
        )
        return await self._aget_node_pool_oapg(
    ...
    def get_node_pool(
        ...
        return self._get_node_pool_oapg(
            path_params=args.path,
        )
...
class GetNodePool(BaseApi):
    ...
    async def aget_node_pool(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesGetNodePoolResponsePydantic:
        raw_response = await self.raw.aget_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            **kwargs,
        )
        if validate:
            return KubernetesGetNodePoolResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesGetNodePoolResponsePydantic, raw_response.body)
    ...
    def get_node_pool(
        ...
        raw_response = self.raw.get_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
        )
        if validate:
