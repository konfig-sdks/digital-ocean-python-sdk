...
class BaseApi(api_client.Api):
    ...
    def _delete_node_pool_mapped_args(
        self,
        cluster_id: str,
        node_pool_id: str,
    ...
    async def _adelete_node_pool_oapg(
        self,
...
class DeleteNodePoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_node_pool(
        self,
        cluster_id: str,
        node_pool_id: str,
        **kwargs,
        ...
        args = self._delete_node_pool_mapped_args(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
        )
        return await self._adelete_node_pool_oapg(
    ...
    def delete_node_pool(
        ...
        return self._delete_node_pool_oapg(
            path_params=args.path,
        )
...
class DeleteNodePool(BaseApi):
    ...
    async def adelete_node_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            **kwargs,
        )
    ...
    def delete_node_pool(
        ...
        raw_response = self.raw.delete_node_pool(
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
        )
