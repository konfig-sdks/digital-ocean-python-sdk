...
class BaseApi(api_client.Api):
    ...
    def _droplet_memory_cached_metrics_mapped_args(
        self,
        host_id: str,
        start: str,
        end: str,
    ...
    async def _adroplet_memory_cached_metrics_oapg(
        self,
    ...
    def _droplet_memory_cached_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DropletMemoryCachedMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adroplet_memory_cached_metrics(
        self,
        host_id: str,
        start: str,
        end: str,
        **kwargs,
        ...
        args = self._droplet_memory_cached_metrics_mapped_args(
            host_id=host_id,
            start=start,
            end=end,
        )
        return await self._adroplet_memory_cached_metrics_oapg(
    ...
    def droplet_memory_cached_metrics(
        ...
        return self._droplet_memory_cached_metrics_oapg(
            query_params=args.query,
        )

class DropletMemoryCachedMetrics(BaseApi):
    ...
    async def adroplet_memory_cached_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adroplet_memory_cached_metrics(
            host_id=host_id,
            start=start,
            end=end,
            **kwargs,
    ...
    def droplet_memory_cached_metrics(
        ...
        raw_response = self.raw.droplet_memory_cached_metrics(
            host_id=host_id,
            start=start,
            end=end,
        )
