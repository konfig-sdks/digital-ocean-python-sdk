...
from digital_ocean_python_sdk.model.images_list_response import ImagesListResponse as ImagesListResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.images_list_response import ImagesListResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.images_list_response import ImagesListResponse as ImagesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImagesListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ImagesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ImagesListResponsePydantic, raw_response.body)
