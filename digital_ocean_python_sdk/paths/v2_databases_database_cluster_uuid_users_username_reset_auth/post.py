...
from digital_ocean_python_sdk.model.databases_reset_user_auth_request import DatabasesResetUserAuthRequest as DatabasesResetUserAuthRequestSchema
from digital_ocean_python_sdk.model.databases_add_user_response import DatabasesAddUserResponse as DatabasesAddUserResponseSchema
from digital_ocean_python_sdk.model.mysql_settings import MysqlSettings as MysqlSettingsSchema

from digital_ocean_python_sdk.type.mysql_settings import MysqlSettings
from digital_ocean_python_sdk.type.databases_add_user_response import DatabasesAddUserResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.databases_reset_user_auth_request import DatabasesResetUserAuthRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.databases_add_user_response import DatabasesAddUserResponse as DatabasesAddUserResponsePydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.mysql_settings import MysqlSettings as MysqlSettingsPydantic
from digital_ocean_python_sdk.pydantic.databases_reset_user_auth_request import DatabasesResetUserAuthRequest as DatabasesResetUserAuthRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabasesResetUserAuthRequestSchema


request_body_databases_reset_user_auth_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DatabasesAddUserResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _reset_user_auth_mapped_args(
        self,
        database_cluster_uuid: str,
        username: str,
        mysql_settings: typing.Optional[MysqlSettings] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if mysql_settings is not None:
            _body["mysql_settings"] = mysql_settings
        args.body = _body
    ...
    async def _areset_user_auth_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_databases_reset_user_auth_request.serialize(body, content_type)
...
class ResetUserAuthRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_user_auth(
        self,
        database_cluster_uuid: str,
        username: str,
        mysql_settings: typing.Optional[MysqlSettings] = None,
        **kwargs,
        ...
        args = self._reset_user_auth_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            username=username,
            mysql_settings=mysql_settings,
        )
        return await self._areset_user_auth_oapg(
            body=args.body,
    ...
    def reset_user_auth(
        ...
        return self._reset_user_auth_oapg(
            body=args.body,
            path_params=args.path,
        )

class ResetUserAuth(BaseApi):
    ...
    async def areset_user_auth(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesAddUserResponsePydantic:
        raw_response = await self.raw.areset_user_auth(
            database_cluster_uuid=database_cluster_uuid,
            username=username,
            mysql_settings=mysql_settings,
            **kwargs,
        ...
        if validate:
            return DatabasesAddUserResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesAddUserResponsePydantic, raw_response.body)
    ...
    def reset_user_auth(
        ...
        raw_response = self.raw.reset_user_auth(
            database_cluster_uuid=database_cluster_uuid,
            username=username,
            mysql_settings=mysql_settings,
        )
