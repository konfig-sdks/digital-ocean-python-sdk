...
from digital_ocean_python_sdk.model.reserved_ips_create_response import ReservedIPsCreateResponse as ReservedIPsCreateResponseSchema
from digital_ocean_python_sdk.model.reserved_ip_create import ReservedIpCreate as ReservedIpCreateSchema

from digital_ocean_python_sdk.type.reserved_ip_create import ReservedIpCreate
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.reserved_ips_create_response import ReservedIPsCreateResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.reserved_ips_create_response import ReservedIPsCreateResponse as ReservedIPsCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.reserved_ip_create import ReservedIpCreate as ReservedIpCreatePydantic

# body param
SchemaForRequestBodyApplicationJson = ReservedIpCreateSchema


request_body_reserved_ip_create = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = ReservedIPsCreateResponseSchema
...
class ApiResponseFor202(api_client.ApiResponse):
    body: ReservedIPsCreateResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        self,
        body: typing.Optional[ReservedIpCreate] = None,
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_reserved_ip_create.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReservedIPsCreateResponsePydantic:
        ...
        if validate:
            return ReservedIPsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReservedIPsCreateResponsePydantic, raw_response.body)
