...
from digital_ocean_python_sdk.model.reserved_ips_list_response import ReservedIPsListResponse as ReservedIPsListResponseSchema

from digital_ocean_python_sdk.type.reserved_ips_list_response import ReservedIPsListResponse
...
from digital_ocean_python_sdk.pydantic.reserved_ips_list_response import ReservedIPsListResponse as ReservedIPsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReservedIPsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReservedIPsListResponsePydantic:
        ...
        if validate:
            return RootModel[ReservedIPsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ReservedIPsListResponsePydantic, raw_response.body)
