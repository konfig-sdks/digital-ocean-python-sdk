...
from digital_ocean_python_sdk.model.associated_kubernetes_resources import AssociatedKubernetesResources as AssociatedKubernetesResourcesSchema

from digital_ocean_python_sdk.type.associated_kubernetes_resources import AssociatedKubernetesResources
...
from digital_ocean_python_sdk.pydantic.associated_kubernetes_resources import AssociatedKubernetesResources as AssociatedKubernetesResourcesPydantic
...
SchemaFor200ResponseBodyApplicationJson = AssociatedKubernetesResourcesSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: AssociatedKubernetesResources
...
class ListAssociatedResources(BaseApi):
    ...
    async def alist_associated_resources(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AssociatedKubernetesResourcesPydantic:
        raw_response = await self.raw.alist_associated_resources(
            cluster_id=cluster_id,
            **kwargs,
        )
        if validate:
            return AssociatedKubernetesResourcesPydantic(**raw_response.body)
        return api_client.construct_model_instance(AssociatedKubernetesResourcesPydantic, raw_response.body)
