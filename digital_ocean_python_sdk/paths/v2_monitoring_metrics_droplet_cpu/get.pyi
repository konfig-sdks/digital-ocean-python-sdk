...
class BaseApi(api_client.Api):
    ...
    def _droplet_cpu_metricsget_mapped_args(
        self,
        host_id: str,
        start: str,
        end: str,
    ...
    async def _adroplet_cpu_metricsget_oapg(
        self,
    ...
    def _droplet_cpu_metricsget_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DropletCpuMetricsgetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adroplet_cpu_metricsget(
        self,
        host_id: str,
        start: str,
        end: str,
        **kwargs,
        ...
        args = self._droplet_cpu_metricsget_mapped_args(
            host_id=host_id,
            start=start,
            end=end,
        )
        return await self._adroplet_cpu_metricsget_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def droplet_cpu_metricsget(
        self,
        host_id: str,
        start: str,
        end: str,
        ...
        return self._droplet_cpu_metricsget_oapg(
            query_params=args.query,
        )

class DropletCpuMetricsget(BaseApi):
    ...
    async def adroplet_cpu_metricsget(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adroplet_cpu_metricsget(
            host_id=host_id,
            start=start,
            end=end,
            **kwargs,
    ...
    def droplet_cpu_metricsget(
        ...
        raw_response = self.raw.droplet_cpu_metricsget(
            host_id=host_id,
            start=start,
            end=end,
        )
