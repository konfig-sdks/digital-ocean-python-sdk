...
from digital_ocean_python_sdk.model.kubernetes_recycle_node_pool_request import KubernetesRecycleNodePoolRequest as KubernetesRecycleNodePoolRequestSchema

from digital_ocean_python_sdk.type.kubernetes_recycle_node_pool_request import KubernetesRecycleNodePoolRequest
...
from digital_ocean_python_sdk.pydantic.kubernetes_recycle_node_pool_request import KubernetesRecycleNodePoolRequest as KubernetesRecycleNodePoolRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = KubernetesRecycleNodePoolRequestSchema


request_body_kubernetes_recycle_node_pool_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _recycle_node_pool_mapped_args(
        self,
        cluster_id: str,
        node_pool_id: str,
        nodes: typing.Optional[typing.List[str]] = None,
    ...
    async def _arecycle_node_pool_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_kubernetes_recycle_node_pool_request.serialize(body, content_type)
...
class RecycleNodePoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="kubernetes")
    async def arecycle_node_pool(
        self,
        cluster_id: str,
        node_pool_id: str,
        nodes: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._recycle_node_pool_mapped_args(
            body=body,
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            nodes=nodes,
        )
        return await self._arecycle_node_pool_oapg(
            body=args.body,
    ...
    def recycle_node_pool(
        ...
        return self._recycle_node_pool_oapg(
            body=args.body,
            path_params=args.path,
        )

class RecycleNodePool(BaseApi):
    ...
    async def arecycle_node_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arecycle_node_pool(
            body=body,
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            nodes=nodes,
    ...
    def recycle_node_pool(
        ...
        raw_response = self.raw.recycle_node_pool(
            body=body,
            cluster_id=cluster_id,
            node_pool_id=node_pool_id,
            nodes=nodes,
