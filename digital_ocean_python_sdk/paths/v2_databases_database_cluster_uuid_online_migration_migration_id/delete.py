...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'migration_id': typing.Union[MigrationIdSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _stop_online_migration_mapped_args(
        self,
    ...
    async def _astop_online_migration_oapg(
        self,
    ...
    def _stop_online_migration_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StopOnlineMigrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astop_online_migration(
        self,
        database_cluster_uuid: str,
        migration_id: str,
        **kwargs,
        ...
        args = self._stop_online_migration_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            migration_id=migration_id,
        )
        return await self._astop_online_migration_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def stop_online_migration(
        self,
        database_cluster_uuid: str,
        migration_id: str,
    ) -> typing.Union[
        ...
        return self._stop_online_migration_oapg(
            path_params=args.path,
        )

class StopOnlineMigration(BaseApi):
    ...
    async def astop_online_migration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astop_online_migration(
            database_cluster_uuid=database_cluster_uuid,
            migration_id=migration_id,
            **kwargs,
        )
    ...
    def stop_online_migration(
        ...
        raw_response = self.raw.stop_online_migration(
            database_cluster_uuid=database_cluster_uuid,
            migration_id=migration_id,
        )
