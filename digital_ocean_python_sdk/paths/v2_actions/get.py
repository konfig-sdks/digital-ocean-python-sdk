...
from digital_ocean_python_sdk.model.actions_list_response import ActionsListResponse as ActionsListResponseSchema

from digital_ocean_python_sdk.type.actions_list_response import ActionsListResponse
...
from digital_ocean_python_sdk.pydantic.actions_list_response import ActionsListResponse as ActionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ActionsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ActionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActionsListResponsePydantic, raw_response.body)
