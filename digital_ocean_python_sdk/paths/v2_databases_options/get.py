...
from digital_ocean_python_sdk.model.options import Options as OptionsSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.options import Options

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.options import Options as OptionsPydantic
...
SchemaFor200ResponseBodyApplicationJson = OptionsSchema
...
class ListOptions(BaseApi):
    ...
    async def alist_options(
        ...
        **kwargs,
        ...
        if validate:
            return OptionsPydantic(**raw_response.body)
        return api_client.construct_model_instance(OptionsPydantic, raw_response.body)
