...
from digital_ocean_python_sdk.model.tags import Tags as TagsSchema
from digital_ocean_python_sdk.model.tags_create_response import TagsCreateResponse as TagsCreateResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.error_with_root_causes import ErrorWithRootCauses as ErrorWithRootCausesSchema
from digital_ocean_python_sdk.model.tags_resources import TagsResources as TagsResourcesSchema

from digital_ocean_python_sdk.type.error_with_root_causes import ErrorWithRootCauses
from digital_ocean_python_sdk.type.tags_resources import TagsResources
from digital_ocean_python_sdk.type.tags import Tags
from digital_ocean_python_sdk.type.tags_create_response import TagsCreateResponse
...
from digital_ocean_python_sdk.pydantic.tags import Tags as TagsPydantic
from digital_ocean_python_sdk.pydantic.tags_create_response import TagsCreateResponse as TagsCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.tags_resources import TagsResources as TagsResourcesPydantic
from digital_ocean_python_sdk.pydantic.error_with_root_causes import ErrorWithRootCauses as ErrorWithRootCausesPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = TagsSchema


request_body_tags = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TagsCreateResponseSchema
...
SchemaFor400ResponseBodyApplicationJson = ErrorWithRootCausesSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        ...
        resources: typing.Optional[TagsResources] = None,
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_tags.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        **kwargs,
        ...
        if validate:
            return TagsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsCreateResponsePydantic, raw_response.body)
