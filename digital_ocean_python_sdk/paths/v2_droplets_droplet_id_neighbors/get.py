...
from digital_ocean_python_sdk.model.droplets_list_neighbors_response import DropletsListNeighborsResponse as DropletsListNeighborsResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.droplets_list_neighbors_response import DropletsListNeighborsResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.droplets_list_neighbors_response import DropletsListNeighborsResponse as DropletsListNeighborsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListNeighborsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListNeighborsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_neighbors_mapped_args(
        self,
        droplet_id: int,
    ...
    async def _alist_neighbors_oapg(
        self,
...
class ListNeighborsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_neighbors(
        self,
        droplet_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_neighbors_mapped_args(
            droplet_id=droplet_id,
        )
        return await self._alist_neighbors_oapg(
    ...
    def list_neighbors(
        ...
        return self._list_neighbors_oapg(
            path_params=args.path,
        )

class ListNeighbors(BaseApi):
    ...
    async def alist_neighbors(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListNeighborsResponsePydantic:
        raw_response = await self.raw.alist_neighbors(
            droplet_id=droplet_id,
            **kwargs,
        )
        if validate:
            return RootModel[DropletsListNeighborsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListNeighborsResponsePydantic, raw_response.body)
    ...
    def list_neighbors(
        ...
        raw_response = self.raw.list_neighbors(
            droplet_id=droplet_id,
        )
        if validate:
            return RootModel[DropletsListNeighborsResponsePydantic](raw_response.body).root
