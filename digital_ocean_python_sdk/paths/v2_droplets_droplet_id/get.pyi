...
from digital_ocean_python_sdk.model.droplets_get_response import DropletsGetResponse as DropletsGetResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.droplets_get_response import DropletsGetResponse
...
from digital_ocean_python_sdk.pydantic.droplets_get_response import DropletsGetResponse as DropletsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsGetResponsePydantic:
        raw_response = await self.raw.aget(
            droplet_id=droplet_id,
            **kwargs,
        )
        if validate:
            return DropletsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DropletsGetResponsePydantic, raw_response.body)
