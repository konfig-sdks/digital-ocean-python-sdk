...
SchemaFor200ResponseBodyApplicationJson = SqlModeSchema
...
class GetSqlModeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sql_mode(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_sql_mode_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_sql_mode_oapg(
    ...
    def get_sql_mode(
        ...
        return self._get_sql_mode_oapg(
            path_params=args.path,
        )

class GetSqlMode(BaseApi):
    ...
    async def aget_sql_mode(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_sql_mode(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return SqlModePydantic(**raw_response.body)
        return api_client.construct_model_instance(SqlModePydantic, raw_response.body)
    ...
    def get_sql_mode(
        ...
        raw_response = self.raw.get_sql_mode(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return SqlModePydantic(**raw_response.body)
