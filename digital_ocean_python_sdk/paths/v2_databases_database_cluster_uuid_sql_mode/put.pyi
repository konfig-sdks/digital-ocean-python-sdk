...
from digital_ocean_python_sdk.model.sql_mode import SqlMode as SqlModeSchema
...
from digital_ocean_python_sdk.type.sql_mode import SqlMode

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.sql_mode import SqlMode as SqlModePydantic
...
# body param
SchemaForRequestBodyApplicationJson = SqlModeSchema


request_body_sql_mode = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_sql_mode_mapped_args(
        self,
        sql_mode: str,
    ...
    async def _aupdate_sql_mode_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_sql_mode.serialize(body, content_type)
...
class UpdateSqlModeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_sql_mode(
        self,
        sql_mode: str,
        database_cluster_uuid: str,
        **kwargs,
        ...
        args = self._update_sql_mode_mapped_args(
            sql_mode=sql_mode,
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aupdate_sql_mode_oapg(
            body=args.body,
    ...
    def update_sql_mode(
        ...
        return self._update_sql_mode_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSqlMode(BaseApi):
    ...
    async def aupdate_sql_mode(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_sql_mode(
            sql_mode=sql_mode,
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
    ...
    def update_sql_mode(
        ...
        raw_response = self.raw.update_sql_mode(
            sql_mode=sql_mode,
            database_cluster_uuid=database_cluster_uuid,
        )
