...
SchemaFor200ResponseBodyApplicationJson = BlockStorageGetSnapshotDetailsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_snapshot_details_mapped_args(
        self,
        snapshot_id: typing.Union[int, str],
    ...
    async def _aget_snapshot_details_oapg(
        self,
    ...
    def _get_snapshot_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSnapshotDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_snapshot_details(
        self,
        snapshot_id: typing.Union[int, str],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_snapshot_details_mapped_args(
            snapshot_id=snapshot_id,
        )
        return await self._aget_snapshot_details_oapg(
    ...
    def get_snapshot_details(
        ...
        return self._get_snapshot_details_oapg(
            path_params=args.path,
        )

class GetSnapshotDetails(BaseApi):
    ...
    async def aget_snapshot_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_snapshot_details(
            snapshot_id=snapshot_id,
            **kwargs,
        )
        if validate:
    ...
    def get_snapshot_details(
        ...
        raw_response = self.raw.get_snapshot_details(
            snapshot_id=snapshot_id,
        )
        if validate:
            return BlockStorageGetSnapshotDetailsResponsePydantic(**raw_response.body)
