...
class BaseApi(api_client.Api):
    ...
    def _delete_volume_snapshot_mapped_args(
        self,
    ...
    async def _adelete_volume_snapshot_oapg(
        self,
    ...
    def _delete_volume_snapshot_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteVolumeSnapshotRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_volume_snapshot(
        self,
        snapshot_id: typing.Union[int, str],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_volume_snapshot_mapped_args(
            snapshot_id=snapshot_id,
        )
        return await self._adelete_volume_snapshot_oapg(
    ...
    def delete_volume_snapshot(
        ...
        return self._delete_volume_snapshot_oapg(
            path_params=args.path,
        )

class DeleteVolumeSnapshot(BaseApi):
    ...
    async def adelete_volume_snapshot(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_volume_snapshot(
            snapshot_id=snapshot_id,
            **kwargs,
        )
    ...
    def delete_volume_snapshot(
        ...
        raw_response = self.raw.delete_volume_snapshot(
            snapshot_id=snapshot_id,
        )
