...
class BaseApi(api_client.Api):
    ...
    def _get_migration_status_mapped_args(
        self,
    ...
    async def _aget_migration_status_oapg(
        self,
    ...
    def _get_migration_status_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMigrationStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_migration_status(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_migration_status_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_migration_status_oapg(
    ...
    def get_migration_status(
        ...
        return self._get_migration_status_oapg(
            path_params=args.path,
        )

class GetMigrationStatus(BaseApi):
    ...
    async def aget_migration_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_migration_status(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
    ...
    def get_migration_status(
        ...
        raw_response = self.raw.get_migration_status(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return OnlineMigrationPydantic(**raw_response.body)
