...
from digital_ocean_python_sdk.model.volumes_create_request import VolumesCreateRequest as VolumesCreateRequestSchema
from digital_ocean_python_sdk.model.volume_base_droplet_ids import VolumeBaseDropletIds as VolumeBaseDropletIdsSchema
from digital_ocean_python_sdk.model.volumes_create_response import VolumesCreateResponse as VolumesCreateResponseSchema
...
from digital_ocean_python_sdk.type.volumes_create_response import VolumesCreateResponse
from digital_ocean_python_sdk.type.volumes_create_request import VolumesCreateRequest
from digital_ocean_python_sdk.type.volume_base_droplet_ids import VolumeBaseDropletIds
...
from digital_ocean_python_sdk.pydantic.volumes_create_request import VolumesCreateRequest as VolumesCreateRequestPydantic
from digital_ocean_python_sdk.pydantic.tags_array import TagsArray as TagsArrayPydantic
from digital_ocean_python_sdk.pydantic.volumes_create_response import VolumesCreateResponse as VolumesCreateResponsePydantic
from digital_ocean_python_sdk.pydantic.volume_base_droplet_ids import VolumeBaseDropletIds as VolumeBaseDropletIdsPydantic

# body param
SchemaForRequestBodyApplicationJson = VolumesCreateRequestSchema


request_body_volumes_create_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VolumesCreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        self,
        body: typing.Optional[VolumesCreateRequest] = None,
        tags: typing.Optional[TagsArray] = None,
        description: typing.Optional[str] = None,
        id: typing.Optional[str] = None,
        droplet_ids: typing.Optional[VolumeBaseDropletIds] = None,
        name: typing.Optional[str] = None,
        size_gigabytes: typing.Optional[int] = None,
        created_at: typing.Optional[str] = None,
        snapshot_id: typing.Optional[str] = None,
        filesystem_type: typing.Optional[str] = None,
        region: typing.Optional[RegionSlug] = None,
        filesystem_label: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        ...
        if filesystem_type is not None:
            _body["filesystem_type"] = filesystem_type
        if region is not None:
            _body["region"] = region
        if filesystem_label is not None:
            _body["filesystem_label"] = filesystem_label
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_volumes_create_request.serialize(body, content_type)
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        **kwargs,
        ...
        if validate:
            return VolumesCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VolumesCreateResponsePydantic, raw_response.body)
