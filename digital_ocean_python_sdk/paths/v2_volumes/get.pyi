...
from digital_ocean_python_sdk.model.volumes_list_response import VolumesListResponse as VolumesListResponseSchema
...
from digital_ocean_python_sdk.type.volumes_list_response import VolumesListResponse
...
from digital_ocean_python_sdk.pydantic.volumes_list_response import VolumesListResponse as VolumesListResponsePydantic
from digital_ocean_python_sdk.pydantic.region_slug import RegionSlug as RegionSlugPydantic

# Query params
NameSchema = schemas.StrSchema
RegionSchema = RegionSlugSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'region': typing.Union[RegionSchema, ],
...
SchemaFor200ResponseBodyApplicationJson = VolumesListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[VolumesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VolumesListResponsePydantic, raw_response.body)
