...
class BaseApi(api_client.Api):
    ...
    def _retry_destroy_with_associated_resources_mapped_args(
        self,
        droplet_id: int,
    ...
    async def _aretry_destroy_with_associated_resources_oapg(
        self,
    ...
    def _retry_destroy_with_associated_resources_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RetryDestroyWithAssociatedResourcesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretry_destroy_with_associated_resources(
        self,
        droplet_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._retry_destroy_with_associated_resources_mapped_args(
            droplet_id=droplet_id,
        )
        return await self._aretry_destroy_with_associated_resources_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def retry_destroy_with_associated_resources(
        self,
        droplet_id: int,
    ) -> typing.Union[
        ApiResponseFor202,
        ...
        return self._retry_destroy_with_associated_resources_oapg(
            path_params=args.path,
        )

class RetryDestroyWithAssociatedResources(BaseApi):
    ...
    async def aretry_destroy_with_associated_resources(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aretry_destroy_with_associated_resources(
            droplet_id=droplet_id,
            **kwargs,
        )
    ...
    def retry_destroy_with_associated_resources(
        ...
        raw_response = self.raw.retry_destroy_with_associated_resources(
            droplet_id=droplet_id,
        )
