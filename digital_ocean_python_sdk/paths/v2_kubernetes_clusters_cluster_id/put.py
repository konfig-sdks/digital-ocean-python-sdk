...
from digital_ocean_python_sdk.model.kubernetes_update_cluster_response import KubernetesUpdateClusterResponse as KubernetesUpdateClusterResponseSchema
from digital_ocean_python_sdk.model.cluster_update import ClusterUpdate as ClusterUpdateSchema
from digital_ocean_python_sdk.model.cluster_update_tags import ClusterUpdateTags as ClusterUpdateTagsSchema

from digital_ocean_python_sdk.type.kubernetes_update_cluster_response import KubernetesUpdateClusterResponse
...
from digital_ocean_python_sdk.type.cluster_update_tags import ClusterUpdateTags
from digital_ocean_python_sdk.type.cluster_update import ClusterUpdate

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.kubernetes_update_cluster_response import KubernetesUpdateClusterResponse as KubernetesUpdateClusterResponsePydantic
...
from digital_ocean_python_sdk.pydantic.cluster_update_tags import ClusterUpdateTags as ClusterUpdateTagsPydantic
from digital_ocean_python_sdk.pydantic.cluster_update import ClusterUpdate as ClusterUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ClusterUpdateSchema


request_body_cluster_update = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = KubernetesUpdateClusterResponseSchema
...
class ApiResponseFor202(api_client.ApiResponse):
    body: KubernetesUpdateClusterResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_cluster_mapped_args(
        self,
        name: str,
        cluster_id: str,
        tags: typing.Optional[ClusterUpdateTags] = None,
    ...
    async def _aupdate_cluster_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_cluster_update.serialize(body, content_type)
...
class UpdateClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_cluster(
        self,
        name: str,
        cluster_id: str,
        tags: typing.Optional[ClusterUpdateTags] = None,
        ...
        **kwargs,
        ...
        args = self._update_cluster_mapped_args(
            name=name,
        ...
        return await self._aupdate_cluster_oapg(
            body=args.body,
...
class UpdateCluster(BaseApi):
    ...
    async def aupdate_cluster(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesUpdateClusterResponsePydantic:
        raw_response = await self.raw.aupdate_cluster(
            name=name,
            cluster_id=cluster_id,
            tags=tags,
            maintenance_policy=maintenance_policy,
        ...
        if validate:
            return KubernetesUpdateClusterResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesUpdateClusterResponsePydantic, raw_response.body)
    ...
    def update_cluster(
        ...
        raw_response = self.raw.update_cluster(
            name=name,
            cluster_id=cluster_id,
            tags=tags,
            maintenance_policy=maintenance_policy,
