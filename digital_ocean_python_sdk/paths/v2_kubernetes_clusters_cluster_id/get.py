...
from digital_ocean_python_sdk.model.kubernetes_get_cluster_info_response import KubernetesGetClusterInfoResponse as KubernetesGetClusterInfoResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.kubernetes_get_cluster_info_response import KubernetesGetClusterInfoResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.kubernetes_get_cluster_info_response import KubernetesGetClusterInfoResponse as KubernetesGetClusterInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = KubernetesGetClusterInfoResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: KubernetesGetClusterInfoResponse
...
class GetClusterInfo(BaseApi):
    ...
    async def aget_cluster_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesGetClusterInfoResponsePydantic:
        raw_response = await self.raw.aget_cluster_info(
            cluster_id=cluster_id,
            **kwargs,
        )
        if validate:
            return KubernetesGetClusterInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesGetClusterInfoResponsePydantic, raw_response.body)
