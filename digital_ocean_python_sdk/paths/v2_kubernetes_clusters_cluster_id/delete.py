...
class BaseApi(api_client.Api):
    ...
    def _delete_cluster_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _adelete_cluster_oapg(
        self,
...
class DeleteClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_cluster(
        self,
        cluster_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_cluster_mapped_args(
            cluster_id=cluster_id,
        )
        return await self._adelete_cluster_oapg(
...
class DeleteCluster(BaseApi):
    ...
    async def adelete_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_cluster(
            cluster_id=cluster_id,
            **kwargs,
        )
    ...
    def delete_cluster(
        ...
        raw_response = self.raw.delete_cluster(
            cluster_id=cluster_id,
        )
