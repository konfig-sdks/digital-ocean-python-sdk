...
from digital_ocean_python_sdk.model.load_balancers_list_response import LoadBalancersListResponse as LoadBalancersListResponseSchema

from digital_ocean_python_sdk.type.load_balancers_list_response import LoadBalancersListResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.load_balancers_list_response import LoadBalancersListResponse as LoadBalancersListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LoadBalancersListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: LoadBalancersListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LoadBalancersListResponsePydantic:
        ...
        if validate:
            return RootModel[LoadBalancersListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LoadBalancersListResponsePydantic, raw_response.body)
