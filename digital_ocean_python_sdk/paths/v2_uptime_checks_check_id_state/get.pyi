...
from digital_ocean_python_sdk.model.uptime_get_check_state_response import UptimeGetCheckStateResponse as UptimeGetCheckStateResponseSchema

from digital_ocean_python_sdk.type.uptime_get_check_state_response import UptimeGetCheckStateResponse
...
from digital_ocean_python_sdk.pydantic.uptime_get_check_state_response import UptimeGetCheckStateResponse as UptimeGetCheckStateResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UptimeGetCheckStateResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: UptimeGetCheckStateResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_check_state_mapped_args(
        self,
        check_id: str,
    ...
    async def _aget_check_state_oapg(
        self,
...
class GetCheckStateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_check_state(
        self,
        check_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_check_state_mapped_args(
            check_id=check_id,
        )
        return await self._aget_check_state_oapg(
    ...
    def get_check_state(
        ...
        return self._get_check_state_oapg(
            path_params=args.path,
        )

class GetCheckState(BaseApi):
    ...
    async def aget_check_state(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UptimeGetCheckStateResponsePydantic:
        raw_response = await self.raw.aget_check_state(
            check_id=check_id,
            **kwargs,
        )
        if validate:
            return UptimeGetCheckStateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UptimeGetCheckStateResponsePydantic, raw_response.body)
    ...
    def get_check_state(
        ...
        raw_response = self.raw.get_check_state(
            check_id=check_id,
        )
        if validate:
            return UptimeGetCheckStateResponsePydantic(**raw_response.body)
