...
class BaseApi(api_client.Api):
    ...
    def _delete_alert_policy_mapped_args(
        self,
        alert_uuid: str,
    ...
    async def _adelete_alert_policy_oapg(
        self,
...
class DeleteAlertPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_alert_policy(
        self,
        alert_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_alert_policy_mapped_args(
            alert_uuid=alert_uuid,
        )
        return await self._adelete_alert_policy_oapg(
...
class DeleteAlertPolicy(BaseApi):
    ...
    async def adelete_alert_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_alert_policy(
            alert_uuid=alert_uuid,
            **kwargs,
        )
    ...
    def delete_alert_policy(
        ...
        raw_response = self.raw.delete_alert_policy(
            alert_uuid=alert_uuid,
        )
