...
class BaseApi(api_client.Api):
    ...
    def _get_existing_alert_policy_mapped_args(
        self,
        alert_uuid: str,
    ...
    async def _aget_existing_alert_policy_oapg(
        self,
    ...
    def _get_existing_alert_policy_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExistingAlertPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_existing_alert_policy(
        self,
        alert_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_existing_alert_policy_mapped_args(
            alert_uuid=alert_uuid,
        )
        return await self._aget_existing_alert_policy_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_existing_alert_policy(
        self,
        alert_uuid: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_existing_alert_policy_oapg(
            path_params=args.path,
        )

class GetExistingAlertPolicy(BaseApi):
    ...
    async def aget_existing_alert_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_existing_alert_policy(
            alert_uuid=alert_uuid,
            **kwargs,
        )
        if validate:
    ...
    def get_existing_alert_policy(
        ...
        raw_response = self.raw.get_existing_alert_policy(
            alert_uuid=alert_uuid,
        )
        if validate:
            return Dictionary(**raw_response.body)
