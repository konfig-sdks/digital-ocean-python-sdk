...
from digital_ocean_python_sdk.model.alerts import Alerts as AlertsSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.alert_policy_request import AlertPolicyRequest as AlertPolicyRequestSchema
from digital_ocean_python_sdk.model.alert_policy_request_entities import AlertPolicyRequestEntities as AlertPolicyRequestEntitiesSchema
from digital_ocean_python_sdk.model.alert_policy_request_tags import AlertPolicyRequestTags as AlertPolicyRequestTagsSchema

from digital_ocean_python_sdk.type.alert_policy_request import AlertPolicyRequest
from digital_ocean_python_sdk.type.alert_policy_request_tags import AlertPolicyRequestTags
from digital_ocean_python_sdk.type.alert_policy_request_entities import AlertPolicyRequestEntities
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.alerts import Alerts

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.alert_policy_request_entities import AlertPolicyRequestEntities as AlertPolicyRequestEntitiesPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.alert_policy_request_tags import AlertPolicyRequestTags as AlertPolicyRequestTagsPydantic
from digital_ocean_python_sdk.pydantic.alerts import Alerts as AlertsPydantic
from digital_ocean_python_sdk.pydantic.alert_policy_request import AlertPolicyRequest as AlertPolicyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AlertPolicyRequestSchema


request_body_alert_policy_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_alert_policy_mapped_args(
        self,
        ...
        if compare is not None:
            _body["compare"] = compare
        if enabled is not None:
            _body["enabled"] = enabled
        if entities is not None:
            _body["entities"] = entities
        if type is not None:
            _body["type"] = type
    ...
    async def _aupdate_alert_policy_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_alert_policy_request.serialize(body, content_type)
...
class UpdateAlertPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_alert_policy(
        self,
        tags: AlertPolicyRequestTags,
        description: str,
        alerts: Alerts,
        ...
        **kwargs,
        ...
        args = self._update_alert_policy_mapped_args(
            tags=tags,
        ...
        return await self._aupdate_alert_policy_oapg(
            body=args.body,
...
class UpdateAlertPolicy(BaseApi):
    ...
    async def aupdate_alert_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_alert_policy(
            tags=tags,
            description=description,
            alerts=alerts,
            compare=compare,
    ...
    def update_alert_policy(
        ...
        raw_response = self.raw.update_alert_policy(
            tags=tags,
            description=description,
            alerts=alerts,
            compare=compare,
