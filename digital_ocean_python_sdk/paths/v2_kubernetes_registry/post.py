...
from digital_ocean_python_sdk.model.cluster_registries import ClusterRegistries as ClusterRegistriesSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.cluster_registries_cluster_uuids import ClusterRegistriesClusterUuids as ClusterRegistriesClusterUuidsSchema

from digital_ocean_python_sdk.type.cluster_registries import ClusterRegistries
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.cluster_registries_cluster_uuids import ClusterRegistriesClusterUuids

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.cluster_registries_cluster_uuids import ClusterRegistriesClusterUuids as ClusterRegistriesClusterUuidsPydantic
from digital_ocean_python_sdk.pydantic.cluster_registries import ClusterRegistries as ClusterRegistriesPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ClusterRegistriesSchema


request_body_cluster_registries = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_container_registry_to_clusters_mapped_args(
        self,
        cluster_uuids: typing.Optional[ClusterRegistriesClusterUuids] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if cluster_uuids is not None:
            _body["cluster_uuids"] = cluster_uuids
        args.body = _body
        return args

    async def _aadd_container_registry_to_clusters_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_cluster_registries.serialize(body, content_type)
    ...
    def _add_container_registry_to_clusters_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddContainerRegistryToClustersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_container_registry_to_clusters(
        self,
        cluster_uuids: typing.Optional[ClusterRegistriesClusterUuids] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._add_container_registry_to_clusters_mapped_args(
            cluster_uuids=cluster_uuids,
        )
        return await self._aadd_container_registry_to_clusters_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_container_registry_to_clusters(
        self,
        cluster_uuids: typing.Optional[ClusterRegistriesClusterUuids] = None,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._add_container_registry_to_clusters_oapg(
            body=args.body,
        )

class AddContainerRegistryToClusters(BaseApi):
    ...
    async def aadd_container_registry_to_clusters(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_container_registry_to_clusters(
            cluster_uuids=cluster_uuids,
            **kwargs,
        )
    ...
    def add_container_registry_to_clusters(
        ...
        raw_response = self.raw.add_container_registry_to_clusters(
            cluster_uuids=cluster_uuids,
        )
