...
class BaseApi(api_client.Api):
    ...
    def _remove_registry_mapped_args(
        self,
    ...
    async def _aremove_registry_oapg(
        self,
...
class RemoveRegistryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_registry(
        self,
        cluster_uuids: typing.Optional[ClusterRegistriesClusterUuids] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_registry_mapped_args(
            cluster_uuids=cluster_uuids,
        )
        return await self._aremove_registry_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def remove_registry(
        ...
        return self._remove_registry_oapg(
            body=args.body,
        )

class RemoveRegistry(BaseApi):
    ...
    async def aremove_registry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_registry(
            cluster_uuids=cluster_uuids,
            **kwargs,
        )
    ...
    def remove_registry(
        ...
        raw_response = self.raw.remove_registry(
            cluster_uuids=cluster_uuids,
        )
