...
class BaseApi(api_client.Api):
    ...
    def _delete_cluster_associated_resources_dangerous_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _adelete_cluster_associated_resources_dangerous_oapg(
        self,
    ...
    def _delete_cluster_associated_resources_dangerous_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteClusterAssociatedResourcesDangerousRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_cluster_associated_resources_dangerous(
        self,
        cluster_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_cluster_associated_resources_dangerous_mapped_args(
            cluster_id=cluster_id,
        )
        return await self._adelete_cluster_associated_resources_dangerous_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_cluster_associated_resources_dangerous(
        self,
        cluster_id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_cluster_associated_resources_dangerous_oapg(
            path_params=args.path,
        )

class DeleteClusterAssociatedResourcesDangerous(BaseApi):
    ...
    async def adelete_cluster_associated_resources_dangerous(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_cluster_associated_resources_dangerous(
            cluster_id=cluster_id,
            **kwargs,
        )
    ...
    def delete_cluster_associated_resources_dangerous(
        ...
        raw_response = self.raw.delete_cluster_associated_resources_dangerous(
            cluster_id=cluster_id,
        )
