...
from digital_ocean_python_sdk.model.one_clicks_list_response import OneClicksListResponse as OneClicksListResponseSchema

from digital_ocean_python_sdk.type.one_clicks_list_response import OneClicksListResponse
...
from digital_ocean_python_sdk.pydantic.one_clicks_list_response import OneClicksListResponse as OneClicksListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OneClicksListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OneClicksListResponsePydantic:
        raw_response = await self.raw.alist(
            type=type,
            **kwargs,
        )
        if validate:
            return OneClicksListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OneClicksListResponsePydantic, raw_response.body)
