...
from digital_ocean_python_sdk.model.container_registry_list_repository_tags_response import ContainerRegistryListRepositoryTagsResponse as ContainerRegistryListRepositoryTagsResponseSchema
...
from digital_ocean_python_sdk.type.container_registry_list_repository_tags_response import ContainerRegistryListRepositoryTagsResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.container_registry_list_repository_tags_response import ContainerRegistryListRepositoryTagsResponse as ContainerRegistryListRepositoryTagsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListRepositoryTagsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListRepositoryTagsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_repository_tags_mapped_args(
        self,
        registry_name: str,
        repository_name: str,
    ...
    async def _alist_repository_tags_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/registry/{registry_name}/repositories/{repository_name}/tags',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_repository_tags_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListRepositoryTagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_repository_tags(
        self,
        registry_name: str,
        repository_name: str,
        per_page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_repository_tags_mapped_args(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
        )
        return await self._alist_repository_tags_oapg(
    ...
    def list_repository_tags(
        ...
        return self._list_repository_tags_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRepositoryTags(BaseApi):
    ...
    async def alist_repository_tags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListRepositoryTagsResponsePydantic:
        raw_response = await self.raw.alist_repository_tags(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
        ...
        if validate:
            return RootModel[ContainerRegistryListRepositoryTagsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContainerRegistryListRepositoryTagsResponsePydantic, raw_response.body)
    ...
    def list_repository_tags(
        ...
        raw_response = self.raw.list_repository_tags(
            registry_name=registry_name,
            repository_name=repository_name,
            per_page=per_page,
            page=page,
