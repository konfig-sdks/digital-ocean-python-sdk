...
from digital_ocean_python_sdk.model.apps_create_deployment_request import AppsCreateDeploymentRequest as AppsCreateDeploymentRequestSchema
...
from digital_ocean_python_sdk.type.apps_create_deployment_request import AppsCreateDeploymentRequest
...
from digital_ocean_python_sdk.pydantic.apps_create_deployment_request import AppsCreateDeploymentRequest as AppsCreateDeploymentRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AppsCreateDeploymentRequestSchema


request_body_apps_create_deployment_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_deployment_mapped_args(
        self,
        app_id: str,
        force_build: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if force_build is not None:
            _body["force_build"] = force_build
        args.body = _body
    ...
    async def _acreate_deployment_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_apps_create_deployment_request.serialize(body, content_type)
