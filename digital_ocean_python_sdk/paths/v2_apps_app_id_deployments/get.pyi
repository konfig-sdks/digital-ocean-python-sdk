...
from digital_ocean_python_sdk.model.apps_deployments_response import AppsDeploymentsResponse as AppsDeploymentsResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.apps_deployments_response import AppsDeploymentsResponse
...
from digital_ocean_python_sdk.pydantic.apps_deployments_response import AppsDeploymentsResponse as AppsDeploymentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsDeploymentsResponseSchema
...
class ListDeployments(BaseApi):
    ...
    async def alist_deployments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsDeploymentsResponsePydantic:
        ...
        if validate:
            return RootModel[AppsDeploymentsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AppsDeploymentsResponsePydantic, raw_response.body)
