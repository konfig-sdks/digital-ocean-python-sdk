...
from digital_ocean_python_sdk.model.kubernetes_get_available_upgrades_response import KubernetesGetAvailableUpgradesResponse as KubernetesGetAvailableUpgradesResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.kubernetes_get_available_upgrades_response import KubernetesGetAvailableUpgradesResponse
...
from digital_ocean_python_sdk.pydantic.kubernetes_get_available_upgrades_response import KubernetesGetAvailableUpgradesResponse as KubernetesGetAvailableUpgradesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = KubernetesGetAvailableUpgradesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: KubernetesGetAvailableUpgradesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_available_upgrades_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _aget_available_upgrades_oapg(
        self,
    ...
    def _get_available_upgrades_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAvailableUpgradesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_available_upgrades(
        self,
        cluster_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_available_upgrades_mapped_args(
            cluster_id=cluster_id,
        )
        return await self._aget_available_upgrades_oapg(
    ...
    def get_available_upgrades(
        ...
        return self._get_available_upgrades_oapg(
            path_params=args.path,
        )

class GetAvailableUpgrades(BaseApi):
    ...
    async def aget_available_upgrades(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesGetAvailableUpgradesResponsePydantic:
        raw_response = await self.raw.aget_available_upgrades(
            cluster_id=cluster_id,
            **kwargs,
        )
        if validate:
            return KubernetesGetAvailableUpgradesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesGetAvailableUpgradesResponsePydantic, raw_response.body)
    ...
    def get_available_upgrades(
        ...
        raw_response = self.raw.get_available_upgrades(
            cluster_id=cluster_id,
        )
        if validate:
            return KubernetesGetAvailableUpgradesResponsePydantic(**raw_response.body)
