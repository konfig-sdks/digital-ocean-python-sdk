...
class BaseApi(api_client.Api):
    ...
    def _get_aggregate_deployment_logs_mapped_args(
        self,
        app_id: str,
        deployment_id: str,
        type: str,
    ...
    async def _aget_aggregate_deployment_logs_oapg(
        self,
    ...
    def _get_aggregate_deployment_logs_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAggregateDeploymentLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_aggregate_deployment_logs(
        self,
        app_id: str,
        deployment_id: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._get_aggregate_deployment_logs_mapped_args(
            app_id=app_id,
        ...
        return await self._aget_aggregate_deployment_logs_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_aggregate_deployment_logs(
        self,
        app_id: str,
        deployment_id: str,
        type: str,
        ...
        return self._get_aggregate_deployment_logs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAggregateDeploymentLogs(BaseApi):
    ...
    async def aget_aggregate_deployment_logs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_aggregate_deployment_logs(
            app_id=app_id,
            deployment_id=deployment_id,
            type=type,
            follow=follow,
    ...
    def get_aggregate_deployment_logs(
        ...
        raw_response = self.raw.get_aggregate_deployment_logs(
            app_id=app_id,
            deployment_id=deployment_id,
            type=type,
            follow=follow,
