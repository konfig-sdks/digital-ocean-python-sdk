...
from digital_ocean_python_sdk.model.container_registry_list_repositories_v2_response import ContainerRegistryListRepositoriesV2Response as ContainerRegistryListRepositoriesV2ResponseSchema

from digital_ocean_python_sdk.type.container_registry_list_repositories_v2_response import ContainerRegistryListRepositoriesV2Response
...
from digital_ocean_python_sdk.pydantic.container_registry_list_repositories_v2_response import ContainerRegistryListRepositoriesV2Response as ContainerRegistryListRepositoriesV2ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListRepositoriesV2ResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListRepositoriesV2Response
...
class BaseApi(api_client.Api):
    ...
    def _list_repositories_v2_mapped_args(
        self,
        registry_name: str,
    ...
    async def _alist_repositories_v2_oapg(
        self,
    ...
    def _list_repositories_v2_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListRepositoriesV2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_repositories_v2(
        self,
        registry_name: str,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_repositories_v2_mapped_args(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
            page_token=page_token,
        )
        return await self._alist_repositories_v2_oapg(
    ...
    def list_repositories_v2(
        ...
        return self._list_repositories_v2_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRepositoriesV2(BaseApi):
    ...
    async def alist_repositories_v2(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListRepositoriesV2ResponsePydantic:
        raw_response = await self.raw.alist_repositories_v2(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
            page_token=page_token,
        ...
        if validate:
            return RootModel[ContainerRegistryListRepositoriesV2ResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContainerRegistryListRepositoriesV2ResponsePydantic, raw_response.body)
    ...
    def list_repositories_v2(
        ...
        raw_response = self.raw.list_repositories_v2(
            registry_name=registry_name,
            per_page=per_page,
            page=page,
            page_token=page_token,
