...
from digital_ocean_python_sdk.model.purge_cache import PurgeCache as PurgeCacheSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.purge_cache_files import PurgeCacheFiles as PurgeCacheFilesSchema

from digital_ocean_python_sdk.type.purge_cache import PurgeCache
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.purge_cache_files import PurgeCacheFiles

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.purge_cache_files import PurgeCacheFiles as PurgeCacheFilesPydantic
from digital_ocean_python_sdk.pydantic.purge_cache import PurgeCache as PurgeCachePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PurgeCacheSchema


request_body_purge_cache = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purge_cache_mapped_args(
        self,
        files: PurgeCacheFiles,
        cdn_id: str,
    ...
    async def _apurge_cache_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_purge_cache.serialize(body, content_type)
...
class PurgeCacheRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurge_cache(
        self,
        files: PurgeCacheFiles,
        cdn_id: str,
        **kwargs,
        ...
        args = self._purge_cache_mapped_args(
            files=files,
            cdn_id=cdn_id,
        )
        return await self._apurge_cache_oapg(
            body=args.body,
    ...
    def purge_cache(
        ...
        return self._purge_cache_oapg(
            body=args.body,
            path_params=args.path,
        )

class PurgeCache(BaseApi):
    ...
    async def apurge_cache(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurge_cache(
            files=files,
            cdn_id=cdn_id,
            **kwargs,
        )
    ...
    def purge_cache(
        ...
        raw_response = self.raw.purge_cache(
            files=files,
            cdn_id=cdn_id,
        )
