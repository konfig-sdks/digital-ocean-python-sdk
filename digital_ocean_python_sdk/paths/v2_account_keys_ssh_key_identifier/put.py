...
from digital_ocean_python_sdk.model.ssh_keys_update_request import SshKeysUpdateRequest as SshKeysUpdateRequestSchema

from digital_ocean_python_sdk.type.ssh_keys_update_request import SshKeysUpdateRequest
...
from digital_ocean_python_sdk.pydantic.ssh_keys_update_request import SshKeysUpdateRequest as SshKeysUpdateRequestPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'ssh_key_identifier': typing.Union[SshKeyIdentifierSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    }
)
...
request_path_ssh_key_identifier = api_client.PathParameter(
    name="ssh_key_identifier",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SshKeyIdentifierSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = SshKeysUpdateRequestSchema


request_body_ssh_keys_update_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_mapped_args(
        self,
        ssh_key_identifier: typing.Union[int, str],
        ...
        if name is not None:
            _body["name"] = name
        args.body = _body
        if ssh_key_identifier is not None:
            _path_params["ssh_key_identifier"] = ssh_key_identifier
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_ssh_key_identifier,
        ):
        ...
        serialized_data = request_body_ssh_keys_update_request.serialize(body, content_type)
