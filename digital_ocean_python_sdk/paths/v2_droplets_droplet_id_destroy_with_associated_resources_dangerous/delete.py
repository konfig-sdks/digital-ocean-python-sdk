...
# Header params
XDangerousSchema = schemas.BoolSchema
RequestRequiredHeaderParams = typing_extensions.TypedDict(
    'RequestRequiredHeaderParams',
    {
        'X-Dangerous': typing.Union[XDangerousSchema, bool, ],
    }
)
...
request_header_x_dangerous = api_client.HeaderParameter(
    name="X-Dangerous",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XDangerousSchema,
    required=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _delete_dangerous_mapped_args(
        self,
        droplet_id: int,
        x_dangerous: bool,
        ...
        _header_params = {}
        _path_params = {}
        if x_dangerous is not None:
            _header_params["X-Dangerous"] = x_dangerous
    ...
    async def _adelete_dangerous_oapg(
        self,
...
class DeleteDangerousRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_dangerous(
        self,
        droplet_id: int,
        x_dangerous: bool,
        **kwargs,
        ...
        args = self._delete_dangerous_mapped_args(
            droplet_id=droplet_id,
            x_dangerous=x_dangerous,
        )
        return await self._adelete_dangerous_oapg(
    ...
    def delete_dangerous(
        ...
        return self._delete_dangerous_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class DeleteDangerous(BaseApi):
    ...
    async def adelete_dangerous(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_dangerous(
            droplet_id=droplet_id,
            x_dangerous=x_dangerous,
            **kwargs,
        )
    ...
    def delete_dangerous(
        ...
        raw_response = self.raw.delete_dangerous(
            droplet_id=droplet_id,
            x_dangerous=x_dangerous,
        )
