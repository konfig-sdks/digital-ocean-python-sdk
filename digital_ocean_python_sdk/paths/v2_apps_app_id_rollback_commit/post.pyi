...
class BaseApi(api_client.Api):
    ...
    def _commit_rollback_mapped_args(
        self,
        app_id: str,
    ...
    async def _acommit_rollback_oapg(
        self,
...
class CommitRollbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acommit_rollback(
        self,
        app_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._commit_rollback_mapped_args(
            app_id=app_id,
        )
        return await self._acommit_rollback_oapg(
    ...
    def commit_rollback(
        ...
        return self._commit_rollback_oapg(
            path_params=args.path,
        )

class CommitRollback(BaseApi):
    ...
    async def acommit_rollback(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acommit_rollback(
            app_id=app_id,
            **kwargs,
        )
    ...
    def commit_rollback(
        ...
        raw_response = self.raw.commit_rollback(
            app_id=app_id,
        )
