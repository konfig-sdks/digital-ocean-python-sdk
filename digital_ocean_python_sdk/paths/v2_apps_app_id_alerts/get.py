...
from digital_ocean_python_sdk.model.apps_list_alerts_response import AppsListAlertsResponse as AppsListAlertsResponseSchema

from digital_ocean_python_sdk.type.apps_list_alerts_response import AppsListAlertsResponse
...
from digital_ocean_python_sdk.pydantic.apps_list_alerts_response import AppsListAlertsResponse as AppsListAlertsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsListAlertsResponseSchema
...
class ListAlerts(BaseApi):
    ...
    async def alist_alerts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsListAlertsResponsePydantic:
        raw_response = await self.raw.alist_alerts(
            app_id=app_id,
            **kwargs,
        )
        if validate:
            return AppsListAlertsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListAlertsResponsePydantic, raw_response.body)
