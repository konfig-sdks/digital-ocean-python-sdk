...
from digital_ocean_python_sdk.model.monitoring_list_alert_policies_response import MonitoringListAlertPoliciesResponse as MonitoringListAlertPoliciesResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.monitoring_list_alert_policies_response import MonitoringListAlertPoliciesResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.monitoring_list_alert_policies_response import MonitoringListAlertPoliciesResponse as MonitoringListAlertPoliciesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MonitoringListAlertPoliciesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: MonitoringListAlertPoliciesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_alert_policies_mapped_args(
        self,
    ...
    async def _alist_alert_policies_oapg(
        self,
...
class ListAlertPoliciesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_alert_policies(
        self,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_alert_policies_mapped_args(
            per_page=per_page,
            page=page,
        )
        return await self._alist_alert_policies_oapg(
...
class ListAlertPolicies(BaseApi):
    ...
    async def alist_alert_policies(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MonitoringListAlertPoliciesResponsePydantic:
        raw_response = await self.raw.alist_alert_policies(
            per_page=per_page,
            page=page,
            **kwargs,
        )
        if validate:
            return RootModel[MonitoringListAlertPoliciesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(MonitoringListAlertPoliciesResponsePydantic, raw_response.body)
    ...
    def list_alert_policies(
        ...
        raw_response = self.raw.list_alert_policies(
            per_page=per_page,
            page=page,
        )
        if validate:
