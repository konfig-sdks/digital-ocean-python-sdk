...
class BaseApi(api_client.Api):
    ...
    def _create_alert_policy_mapped_args(
        self,
    ...
    async def _acreate_alert_policy_oapg(
        self,
...
class CreateAlertPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_alert_policy(
        self,
        tags: AlertPolicyRequestTags,
        description: str,
        alerts: Alerts,
        ...
        **kwargs,
        ...
        args = self._create_alert_policy_mapped_args(
            tags=tags,
        ...
        return await self._acreate_alert_policy_oapg(
            body=args.body,
            **kwargs,
        )
...
class CreateAlertPolicy(BaseApi):
    ...
    async def acreate_alert_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_alert_policy(
            tags=tags,
            description=description,
            alerts=alerts,
            compare=compare,
    ...
    def create_alert_policy(
        ...
        raw_response = self.raw.create_alert_policy(
            tags=tags,
            description=description,
            alerts=alerts,
            compare=compare,
