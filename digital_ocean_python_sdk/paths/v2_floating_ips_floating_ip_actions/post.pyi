...
from digital_ocean_python_sdk.model.floating_ips_action_post_request import FloatingIPsActionPostRequest as FloatingIPsActionPostRequestSchema
from digital_ocean_python_sdk.model.floating_ips_action_post_response import FloatingIPsActionPostResponse as FloatingIPsActionPostResponseSchema

from digital_ocean_python_sdk.type.floating_ips_action_post_response import FloatingIPsActionPostResponse
from digital_ocean_python_sdk.type.floating_ips_action_post_request import FloatingIPsActionPostRequest
...
from digital_ocean_python_sdk.pydantic.floating_ips_action_post_response import FloatingIPsActionPostResponse as FloatingIPsActionPostResponsePydantic
from digital_ocean_python_sdk.pydantic.floating_ips_action_post_request import FloatingIPsActionPostRequest as FloatingIPsActionPostRequestPydantic

# Path params


class FloatingIpSchema(
    schemas.StrSchema
):
    pass
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'floating_ip': typing.Union[FloatingIpSchema, str, ],
    }
)
...
request_path_floating_ip = api_client.PathParameter(
    name="floating_ip",
...
# body param
SchemaForRequestBodyApplicationJson = FloatingIPsActionPostRequestSchema


request_body_floating_ips_action_post_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FloatingIPsActionPostResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: FloatingIPsActionPostResponse
...
class BaseApi(api_client.Api):
    ...
    def _post_mapped_args(
        ...
        body: typing.Optional[FloatingIPsActionPostRequest] = None,
        ...
        if floating_ip is not None:
            _path_params["floating_ip"] = floating_ip
    ...
    async def _apost_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_floating_ips_action_post_request.serialize(body, content_type)
...
class Post(BaseApi):
    ...
    async def apost(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsActionPostResponsePydantic:
        ...
        if validate:
            return FloatingIPsActionPostResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FloatingIPsActionPostResponsePydantic, raw_response.body)
