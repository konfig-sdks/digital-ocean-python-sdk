...
from digital_ocean_python_sdk.model.floating_ips_action_list_response import FloatingIPsActionListResponse as FloatingIPsActionListResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.floating_ips_action_list_response import FloatingIPsActionListResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.floating_ips_action_list_response import FloatingIPsActionListResponse as FloatingIPsActionListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FloatingIPsActionListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FloatingIPsActionListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FloatingIPsActionListResponsePydantic:
        raw_response = await self.raw.alist(
            floating_ip=floating_ip,
            **kwargs,
        )
        if validate:
            return RootModel[FloatingIPsActionListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FloatingIPsActionListResponsePydantic, raw_response.body)
