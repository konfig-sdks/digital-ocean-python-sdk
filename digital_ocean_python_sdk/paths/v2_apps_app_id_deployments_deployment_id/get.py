...
class BaseApi(api_client.Api):
    ...
    def _get_deployment_info_mapped_args(
        self,
        app_id: str,
        deployment_id: str,
    ...
    async def _aget_deployment_info_oapg(
        self,
...
class GetDeploymentInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_deployment_info(
        self,
        app_id: str,
        deployment_id: str,
        **kwargs,
        ...
        args = self._get_deployment_info_mapped_args(
            app_id=app_id,
            deployment_id=deployment_id,
        )
        return await self._aget_deployment_info_oapg(
    ...
    def get_deployment_info(
        ...
        return self._get_deployment_info_oapg(
            path_params=args.path,
        )

class GetDeploymentInfo(BaseApi):
    ...
    async def aget_deployment_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_deployment_info(
            app_id=app_id,
            deployment_id=deployment_id,
            **kwargs,
        )
    ...
    def get_deployment_info(
        ...
        raw_response = self.raw.get_deployment_info(
            app_id=app_id,
            deployment_id=deployment_id,
        )
        if validate:
