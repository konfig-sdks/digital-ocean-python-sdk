...
from digital_ocean_python_sdk.model.version2 import Version2 as Version2Schema

from digital_ocean_python_sdk.type.version2 import Version2
...
from digital_ocean_python_sdk.pydantic.version2 import Version2 as Version2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = Version2Schema


request_body_version2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upgrade_major_version_mapped_args(
        self,
    ...
    async def _aupgrade_major_version_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_version2.serialize(body, content_type)
    ...
    def _upgrade_major_version_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpgradeMajorVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupgrade_major_version(
        self,
        database_cluster_uuid: str,
        version: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._upgrade_major_version_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            version=version,
        )
        return await self._aupgrade_major_version_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def upgrade_major_version(
        self,
        database_cluster_uuid: str,
        version: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._upgrade_major_version_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpgradeMajorVersion(BaseApi):
    ...
    async def aupgrade_major_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupgrade_major_version(
            database_cluster_uuid=database_cluster_uuid,
            version=version,
            **kwargs,
        )
    ...
    def upgrade_major_version(
        ...
        raw_response = self.raw.upgrade_major_version(
            database_cluster_uuid=database_cluster_uuid,
            version=version,
        )
