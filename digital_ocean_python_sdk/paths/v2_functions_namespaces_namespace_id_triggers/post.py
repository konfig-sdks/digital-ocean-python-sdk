...
from digital_ocean_python_sdk.model.create_trigger import CreateTrigger as CreateTriggerSchema

from digital_ocean_python_sdk.type.create_trigger import CreateTrigger
...
from digital_ocean_python_sdk.pydantic.create_trigger import CreateTrigger as CreateTriggerPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateTriggerSchema


request_body_create_trigger = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_trigger_in_namespace_mapped_args(
        self,
        name: str,
        function: str,
        type: str,
    ...
    async def _acreate_trigger_in_namespace_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_create_trigger.serialize(body, content_type)
    ...
    def _create_trigger_in_namespace_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateTriggerInNamespaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_trigger_in_namespace(
        self,
        name: str,
        function: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._create_trigger_in_namespace_mapped_args(
            name=name,
            function=function,
            type=type,
        ...
        return await self._acreate_trigger_in_namespace_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_trigger_in_namespace(
        self,
        name: str,
        function: str,
        type: str,
        ...
        return self._create_trigger_in_namespace_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateTriggerInNamespace(BaseApi):
    ...
    async def acreate_trigger_in_namespace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_trigger_in_namespace(
            name=name,
            function=function,
            type=type,
            is_enabled=is_enabled,
    ...
    def create_trigger_in_namespace(
        ...
        raw_response = self.raw.create_trigger_in_namespace(
            name=name,
            function=function,
            type=type,
            is_enabled=is_enabled,
