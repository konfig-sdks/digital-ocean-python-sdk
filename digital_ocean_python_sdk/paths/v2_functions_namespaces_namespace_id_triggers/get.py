...
from digital_ocean_python_sdk.model.functions_list_triggers_response import FunctionsListTriggersResponse as FunctionsListTriggersResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.functions_list_triggers_response import FunctionsListTriggersResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.functions_list_triggers_response import FunctionsListTriggersResponse as FunctionsListTriggersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FunctionsListTriggersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FunctionsListTriggersResponse
...
class ListTriggers(BaseApi):
    ...
    async def alist_triggers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FunctionsListTriggersResponsePydantic:
        raw_response = await self.raw.alist_triggers(
            namespace_id=namespace_id,
            **kwargs,
        )
        if validate:
            return RootModel[FunctionsListTriggersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FunctionsListTriggersResponsePydantic, raw_response.body)
