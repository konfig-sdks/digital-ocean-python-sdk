...
from digital_ocean_python_sdk.model.certificates_get_response import CertificatesGetResponse as CertificatesGetResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.certificates_get_response import CertificatesGetResponse
...
from digital_ocean_python_sdk.pydantic.certificates_get_response import CertificatesGetResponse as CertificatesGetResponsePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'certificate_id': typing.Union[CertificateIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_certificate_id = api_client.PathParameter(
    name="certificate_id",
...
SchemaFor200ResponseBodyApplicationJson = CertificatesGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CertificatesGetResponsePydantic:
        raw_response = await self.raw.aget(
            certificate_id=certificate_id,
            **kwargs,
        )
        if validate:
            return CertificatesGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CertificatesGetResponsePydantic, raw_response.body)
