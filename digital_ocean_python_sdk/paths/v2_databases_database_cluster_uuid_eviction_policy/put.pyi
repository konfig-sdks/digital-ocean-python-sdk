...
from digital_ocean_python_sdk.model.eviction_policy_model import EvictionPolicyModel as EvictionPolicyModelSchema
from digital_ocean_python_sdk.model.databases_configure_eviction_policy_request import DatabasesConfigureEvictionPolicyRequest as DatabasesConfigureEvictionPolicyRequestSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.eviction_policy_model import EvictionPolicyModel
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.databases_configure_eviction_policy_request import DatabasesConfigureEvictionPolicyRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.databases_configure_eviction_policy_request import DatabasesConfigureEvictionPolicyRequest as DatabasesConfigureEvictionPolicyRequestPydantic
from digital_ocean_python_sdk.pydantic.eviction_policy_model import EvictionPolicyModel as EvictionPolicyModelPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabasesConfigureEvictionPolicyRequestSchema


request_body_databases_configure_eviction_policy_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _configure_eviction_policy_mapped_args(
        self,
        ...
        if eviction_policy is not None:
            _body["eviction_policy"] = eviction_policy
        args.body = _body
    ...
    async def _aconfigure_eviction_policy_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_databases_configure_eviction_policy_request.serialize(body, content_type)
    ...
    def _configure_eviction_policy_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ConfigureEvictionPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aconfigure_eviction_policy(
        self,
        eviction_policy: EvictionPolicyModel,
        database_cluster_uuid: str,
        **kwargs,
        ...
        args = self._configure_eviction_policy_mapped_args(
            eviction_policy=eviction_policy,
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aconfigure_eviction_policy_oapg(
            body=args.body,
    ...
    def configure_eviction_policy(
        ...
        return self._configure_eviction_policy_oapg(
            body=args.body,
            path_params=args.path,
        )

class ConfigureEvictionPolicy(BaseApi):
    ...
    async def aconfigure_eviction_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aconfigure_eviction_policy(
            eviction_policy=eviction_policy,
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
    ...
    def configure_eviction_policy(
        ...
        raw_response = self.raw.configure_eviction_policy(
            eviction_policy=eviction_policy,
            database_cluster_uuid=database_cluster_uuid,
        )
