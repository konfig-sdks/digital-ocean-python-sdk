...
from digital_ocean_python_sdk.model.databases_get_eviction_policy_response import DatabasesGetEvictionPolicyResponse as DatabasesGetEvictionPolicyResponseSchema

from digital_ocean_python_sdk.type.databases_get_eviction_policy_response import DatabasesGetEvictionPolicyResponse
...
from digital_ocean_python_sdk.pydantic.databases_get_eviction_policy_response import DatabasesGetEvictionPolicyResponse as DatabasesGetEvictionPolicyResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesGetEvictionPolicyResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesGetEvictionPolicyResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_eviction_policy_mapped_args(
        self,
    ...
    async def _aget_eviction_policy_oapg(
        self,
...
class GetEvictionPolicyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_eviction_policy(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_eviction_policy_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._aget_eviction_policy_oapg(
    ...
    def get_eviction_policy(
        ...
        return self._get_eviction_policy_oapg(
            path_params=args.path,
        )

class GetEvictionPolicy(BaseApi):
    ...
    async def aget_eviction_policy(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesGetEvictionPolicyResponsePydantic:
        raw_response = await self.raw.aget_eviction_policy(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesGetEvictionPolicyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesGetEvictionPolicyResponsePydantic, raw_response.body)
    ...
    def get_eviction_policy(
        ...
        raw_response = self.raw.get_eviction_policy(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesGetEvictionPolicyResponsePydantic(**raw_response.body)
