...
class BaseApi(api_client.Api):
    ...
    def _get_app_daily_bandwidth_metrics_mapped_args(
        self,
        app_id: str,
    ...
    async def _aget_app_daily_bandwidth_metrics_oapg(
        self,
    ...
    def _get_app_daily_bandwidth_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAppDailyBandwidthMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_app_daily_bandwidth_metrics(
        self,
        app_id: str,
        date: typing.Optional[datetime] = None,
        **kwargs,
        ...
        args = self._get_app_daily_bandwidth_metrics_mapped_args(
            app_id=app_id,
            date=date,
        )
        return await self._aget_app_daily_bandwidth_metrics_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_app_daily_bandwidth_metrics(
        self,
        app_id: str,
        date: typing.Optional[datetime] = None,
    ) -> typing.Union[
        ...
        return self._get_app_daily_bandwidth_metrics_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAppDailyBandwidthMetrics(BaseApi):
    ...
    async def aget_app_daily_bandwidth_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_app_daily_bandwidth_metrics(
            app_id=app_id,
            date=date,
            **kwargs,
        )
    ...
    def get_app_daily_bandwidth_metrics(
        ...
        raw_response = self.raw.get_app_daily_bandwidth_metrics(
            app_id=app_id,
            date=date,
        )
        if validate:
