...
from digital_ocean_python_sdk.model.domains_create_response import DomainsCreateResponse as DomainsCreateResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.domain import Domain as DomainSchema

from digital_ocean_python_sdk.type.domains_create_response import DomainsCreateResponse
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.domain import Domain

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.domain import Domain as DomainPydantic
from digital_ocean_python_sdk.pydantic.domains_create_response import DomainsCreateResponse as DomainsCreateResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = DomainsCreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_mapped_args(
        ...
        ttl: typing.Optional[typing.Optional[int]] = None,
        zone_file: typing.Optional[typing.Optional[str]] = None,
        ...
        if ip_address is not None:
            _body["ip_address"] = ip_address
        if ttl is not None:
            _body["ttl"] = ttl
        if zone_file is not None:
            _body["zone_file"] = zone_file
        args.body = _body
        return args
...
class Create(BaseApi):
    ...
    async def acreate(
        ...
        **kwargs,
        ...
        if validate:
            return DomainsCreateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainsCreateResponsePydantic, raw_response.body)
