...
from digital_ocean_python_sdk.model.domains_list_response import DomainsListResponse as DomainsListResponseSchema

from digital_ocean_python_sdk.type.domains_list_response import DomainsListResponse
...
from digital_ocean_python_sdk.pydantic.domains_list_response import DomainsListResponse as DomainsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DomainsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[DomainsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DomainsListResponsePydantic, raw_response.body)
