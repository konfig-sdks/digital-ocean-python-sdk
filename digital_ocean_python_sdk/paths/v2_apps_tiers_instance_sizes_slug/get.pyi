...
from digital_ocean_python_sdk.model.apps_get_instance_size_response import AppsGetInstanceSizeResponse as AppsGetInstanceSizeResponseSchema

from digital_ocean_python_sdk.type.apps_get_instance_size_response import AppsGetInstanceSizeResponse
...
from digital_ocean_python_sdk.pydantic.apps_get_instance_size_response import AppsGetInstanceSizeResponse as AppsGetInstanceSizeResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsGetInstanceSizeResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: AppsGetInstanceSizeResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_instance_size_mapped_args(
        self,
        slug: str,
    ...
    async def _aget_instance_size_oapg(
        self,
...
class GetInstanceSizeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instance_size(
        self,
        slug: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_instance_size_mapped_args(
            slug=slug,
        )
        return await self._aget_instance_size_oapg(
    ...
    def get_instance_size(
        ...
        return self._get_instance_size_oapg(
            path_params=args.path,
        )

class GetInstanceSize(BaseApi):
    ...
    async def aget_instance_size(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsGetInstanceSizeResponsePydantic:
        raw_response = await self.raw.aget_instance_size(
            slug=slug,
            **kwargs,
        )
        if validate:
            return AppsGetInstanceSizeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsGetInstanceSizeResponsePydantic, raw_response.body)
    ...
    def get_instance_size(
        ...
        raw_response = self.raw.get_instance_size(
            slug=slug,
        )
        if validate:
            return AppsGetInstanceSizeResponsePydantic(**raw_response.body)
