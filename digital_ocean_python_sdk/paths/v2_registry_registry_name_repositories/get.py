...
from digital_ocean_python_sdk.model.container_registry_list_repositories_response import ContainerRegistryListRepositoriesResponse as ContainerRegistryListRepositoriesResponseSchema

from digital_ocean_python_sdk.type.container_registry_list_repositories_response import ContainerRegistryListRepositoriesResponse
...
from digital_ocean_python_sdk.pydantic.container_registry_list_repositories_response import ContainerRegistryListRepositoriesResponse as ContainerRegistryListRepositoriesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContainerRegistryListRepositoriesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContainerRegistryListRepositoriesResponse
...
class ListRepositoriesRaw(BaseApi):
    ...
    @api_client.DeprecationWarningOnce(prefix="container_registry")
...
class ListRepositories(BaseApi):
    ...
    async def alist_repositories(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContainerRegistryListRepositoriesResponsePydantic:
        ...
        if validate:
            return RootModel[ContainerRegistryListRepositoriesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContainerRegistryListRepositoriesResponsePydantic, raw_response.body)
