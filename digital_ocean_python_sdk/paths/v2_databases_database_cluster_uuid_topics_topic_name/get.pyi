...
class BaseApi(api_client.Api):
    ...
    def _get_topic_kafka_cluster_mapped_args(
        self,
    ...
    async def _aget_topic_kafka_cluster_oapg(
        self,
    ...
    def _get_topic_kafka_cluster_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTopicKafkaClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_topic_kafka_cluster(
        self,
        database_cluster_uuid: str,
        topic_name: str,
        **kwargs,
        ...
        args = self._get_topic_kafka_cluster_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
        )
        return await self._aget_topic_kafka_cluster_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_topic_kafka_cluster(
        self,
        database_cluster_uuid: str,
        topic_name: str,
    ) -> typing.Union[
        ...
        return self._get_topic_kafka_cluster_oapg(
            path_params=args.path,
        )

class GetTopicKafkaCluster(BaseApi):
    ...
    async def aget_topic_kafka_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_topic_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
            **kwargs,
        )
    ...
    def get_topic_kafka_cluster(
        ...
        raw_response = self.raw.get_topic_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
        )
        if validate:
