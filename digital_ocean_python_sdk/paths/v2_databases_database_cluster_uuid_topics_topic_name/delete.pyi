...
class BaseApi(api_client.Api):
    ...
    def _delete_topic_kafka_cluster_mapped_args(
        self,
    ...
    async def _adelete_topic_kafka_cluster_oapg(
        self,
    ...
    def _delete_topic_kafka_cluster_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteTopicKafkaClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_topic_kafka_cluster(
        self,
        database_cluster_uuid: str,
        topic_name: str,
        **kwargs,
        ...
        args = self._delete_topic_kafka_cluster_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
        )
        return await self._adelete_topic_kafka_cluster_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_topic_kafka_cluster(
        self,
        database_cluster_uuid: str,
        topic_name: str,
    ) -> typing.Union[
        ...
        return self._delete_topic_kafka_cluster_oapg(
            path_params=args.path,
        )

class DeleteTopicKafkaCluster(BaseApi):
    ...
    async def adelete_topic_kafka_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_topic_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
            **kwargs,
        )
    ...
    def delete_topic_kafka_cluster(
        ...
        raw_response = self.raw.delete_topic_kafka_cluster(
            database_cluster_uuid=database_cluster_uuid,
            topic_name=topic_name,
        )
