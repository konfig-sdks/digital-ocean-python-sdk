...
from digital_ocean_python_sdk.model.credentials import Credentials as CredentialsSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.credentials import Credentials

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.credentials import Credentials as CredentialsPydantic
...
SchemaFor200ResponseBodyApplicationJson = CredentialsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_credentials_by_cluster_id_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _aget_credentials_by_cluster_id_oapg(
        self,
    ...
    def _get_credentials_by_cluster_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCredentialsByClusterIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_credentials_by_cluster_id(
        self,
        cluster_id: str,
        expiry_seconds: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_credentials_by_cluster_id_mapped_args(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
        )
        return await self._aget_credentials_by_cluster_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_credentials_by_cluster_id(
        self,
        cluster_id: str,
        expiry_seconds: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._get_credentials_by_cluster_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCredentialsByClusterId(BaseApi):
    ...
    async def aget_credentials_by_cluster_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_credentials_by_cluster_id(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
            **kwargs,
        )
        if validate:
            return CredentialsPydantic(**raw_response.body)
        return api_client.construct_model_instance(CredentialsPydantic, raw_response.body)
    ...
    def get_credentials_by_cluster_id(
        ...
        raw_response = self.raw.get_credentials_by_cluster_id(
            cluster_id=cluster_id,
            expiry_seconds=expiry_seconds,
        )
        if validate:
