...
from digital_ocean_python_sdk.model.kubernetes_list_clusters_response import KubernetesListClustersResponse as KubernetesListClustersResponseSchema

from digital_ocean_python_sdk.type.kubernetes_list_clusters_response import KubernetesListClustersResponse
...
from digital_ocean_python_sdk.pydantic.kubernetes_list_clusters_response import KubernetesListClustersResponse as KubernetesListClustersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = KubernetesListClustersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: KubernetesListClustersResponse
...
class ListClusters(BaseApi):
    ...
    async def alist_clusters(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesListClustersResponsePydantic:
        ...
        if validate:
            return RootModel[KubernetesListClustersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(KubernetesListClustersResponsePydantic, raw_response.body)
