...
from digital_ocean_python_sdk.model.neighbor_ids import NeighborIds as NeighborIdsSchema

from digital_ocean_python_sdk.type.neighbor_ids import NeighborIds
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.neighbor_ids import NeighborIds as NeighborIdsPydantic
...
SchemaFor200ResponseBodyApplicationJson = NeighborIdsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_droplet_neighbors_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_droplet_neighbors_oapg(
        self,
    ...
    def _list_droplet_neighbors_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListDropletNeighborsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_droplet_neighbors(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_droplet_neighbors_mapped_args(
        )
        return await self._alist_droplet_neighbors_oapg(
            **kwargs,
        )
    ...
    def list_droplet_neighbors(
        ...
        return self._list_droplet_neighbors_oapg(
        )

class ListDropletNeighbors(BaseApi):
    ...
    async def alist_droplet_neighbors(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_droplet_neighbors(
            **kwargs,
        )
        if validate:
            return NeighborIdsPydantic(**raw_response.body)
        return api_client.construct_model_instance(NeighborIdsPydantic, raw_response.body)
    ...
    def list_droplet_neighbors(
        ...
        raw_response = self.raw.list_droplet_neighbors(
        )
        if validate:
            return NeighborIdsPydantic(**raw_response.body)
        return api_client.construct_model_instance(NeighborIdsPydantic, raw_response.body)
