...
class BaseApi(api_client.Api):
    ...
    def _destroy_readonly_replica_mapped_args(
        self,
    ...
    async def _adestroy_readonly_replica_oapg(
        self,
    ...
    def _destroy_readonly_replica_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DestroyReadonlyReplicaRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adestroy_readonly_replica(
        self,
        database_cluster_uuid: str,
        replica_name: str,
        **kwargs,
        ...
        args = self._destroy_readonly_replica_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
        return await self._adestroy_readonly_replica_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def destroy_readonly_replica(
        self,
        database_cluster_uuid: str,
        replica_name: str,
    ) -> typing.Union[
        ...
        return self._destroy_readonly_replica_oapg(
            path_params=args.path,
        )

class DestroyReadonlyReplica(BaseApi):
    ...
    async def adestroy_readonly_replica(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adestroy_readonly_replica(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
            **kwargs,
        )
    ...
    def destroy_readonly_replica(
        ...
        raw_response = self.raw.destroy_readonly_replica(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
