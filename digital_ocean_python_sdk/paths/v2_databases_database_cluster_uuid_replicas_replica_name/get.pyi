...
request_path_replica_name = api_client.PathParameter(
    name="replica_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReplicaNameSchema,
    required=True,
)
RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = DatabasesCreateReadOnlyReplicaResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_existing_read_only_replica_mapped_args(
        self,
        ...
        if replica_name is not None:
            _path_params["replica_name"] = replica_name
        args.path = _path_params
        return args

    async def _aget_existing_read_only_replica_oapg(
        self,
    ...
    def _get_existing_read_only_replica_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExistingReadOnlyReplicaRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_existing_read_only_replica(
        self,
        database_cluster_uuid: str,
        replica_name: str,
        **kwargs,
        ...
        args = self._get_existing_read_only_replica_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
        return await self._aget_existing_read_only_replica_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_existing_read_only_replica(
        self,
        database_cluster_uuid: str,
        replica_name: str,
    ) -> typing.Union[
        ...
        return self._get_existing_read_only_replica_oapg(
            path_params=args.path,
        )

class GetExistingReadOnlyReplica(BaseApi):
    ...
    async def aget_existing_read_only_replica(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_existing_read_only_replica(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
            **kwargs,
        )
    ...
    def get_existing_read_only_replica(
        ...
        raw_response = self.raw.get_existing_read_only_replica(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
        if validate:
