...
from digital_ocean_python_sdk.model.apps_validate_rollback_response import AppsValidateRollbackResponse as AppsValidateRollbackResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.apps_rollback_app_request import AppsRollbackAppRequest as AppsRollbackAppRequestSchema

from digital_ocean_python_sdk.type.apps_rollback_app_request import AppsRollbackAppRequest
from digital_ocean_python_sdk.type.apps_validate_rollback_response import AppsValidateRollbackResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.apps_rollback_app_request import AppsRollbackAppRequest as AppsRollbackAppRequestPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.apps_validate_rollback_response import AppsValidateRollbackResponse as AppsValidateRollbackResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = AppsRollbackAppRequestSchema


request_body_apps_rollback_app_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppsValidateRollbackResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: AppsValidateRollbackResponse
...
class BaseApi(api_client.Api):
    ...
    def _validate_rollback_mapped_args(
        self,
        app_id: str,
        deployment_id: typing.Optional[str] = None,
        skip_pin: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if deployment_id is not None:
            _body["deployment_id"] = deployment_id
        if skip_pin is not None:
            _body["skip_pin"] = skip_pin
        args.body = _body
    ...
    async def _avalidate_rollback_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_apps_rollback_app_request.serialize(body, content_type)
...
class ValidateRollbackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_rollback(
        self,
        app_id: str,
        deployment_id: typing.Optional[str] = None,
        skip_pin: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._validate_rollback_mapped_args(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
        )
        return await self._avalidate_rollback_oapg(
            body=args.body,
    ...
    def validate_rollback(
        ...
        return self._validate_rollback_oapg(
            body=args.body,
            path_params=args.path,
        )

class ValidateRollback(BaseApi):
    ...
    async def avalidate_rollback(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsValidateRollbackResponsePydantic:
        raw_response = await self.raw.avalidate_rollback(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
            **kwargs,
        ...
        if validate:
            return AppsValidateRollbackResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsValidateRollbackResponsePydantic, raw_response.body)
    ...
    def validate_rollback(
        ...
        raw_response = self.raw.validate_rollback(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
        )
