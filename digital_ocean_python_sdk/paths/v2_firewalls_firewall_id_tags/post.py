...
from digital_ocean_python_sdk.model.firewalls_add_tags_request import FirewallsAddTagsRequest as FirewallsAddTagsRequestSchema

from digital_ocean_python_sdk.type.firewalls_add_tags_request import FirewallsAddTagsRequest
...
from digital_ocean_python_sdk.pydantic.firewalls_add_tags_request import FirewallsAddTagsRequest as FirewallsAddTagsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FirewallsAddTagsRequestSchema


request_body_firewalls_add_tags_request = api_client.RequestBody(
    content={
    ...
    async def _aadd_tags_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_add_tags_request.serialize(body, content_type)
