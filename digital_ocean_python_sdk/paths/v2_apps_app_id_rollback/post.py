...
from digital_ocean_python_sdk.model.apps_deployment_response import AppsDeploymentResponse as AppsDeploymentResponseSchema
...
from digital_ocean_python_sdk.type.apps_deployment_response import AppsDeploymentResponse
...
from digital_ocean_python_sdk.pydantic.apps_deployment_response import AppsDeploymentResponse as AppsDeploymentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsDeploymentResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _rollback_deployment_mapped_args(
        self,
        app_id: str,
    ...
    async def _arollback_deployment_oapg(
        self,
...
class RollbackDeploymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arollback_deployment(
        self,
        app_id: str,
        deployment_id: typing.Optional[str] = None,
        skip_pin: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._rollback_deployment_mapped_args(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
        )
        return await self._arollback_deployment_oapg(
            body=args.body,
    ...
    def rollback_deployment(
        ...
        return self._rollback_deployment_oapg(
            body=args.body,
            path_params=args.path,
        )

class RollbackDeployment(BaseApi):
    ...
    async def arollback_deployment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsDeploymentResponsePydantic:
        raw_response = await self.raw.arollback_deployment(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
            **kwargs,
        ...
        if validate:
            return AppsDeploymentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsDeploymentResponsePydantic, raw_response.body)
    ...
    def rollback_deployment(
        ...
        raw_response = self.raw.rollback_deployment(
            app_id=app_id,
            deployment_id=deployment_id,
            skip_pin=skip_pin,
        )
