...
from digital_ocean_python_sdk.model.vpcs_list_response import VpcsListResponse as VpcsListResponseSchema

from digital_ocean_python_sdk.type.vpcs_list_response import VpcsListResponse
...
from digital_ocean_python_sdk.pydantic.vpcs_list_response import VpcsListResponse as VpcsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VpcsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[VpcsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VpcsListResponsePydantic, raw_response.body)
