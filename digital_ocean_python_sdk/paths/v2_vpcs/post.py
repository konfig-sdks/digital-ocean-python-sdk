...
from digital_ocean_python_sdk.model.vpcs_create_request import VpcsCreateRequest as VpcsCreateRequestSchema

from digital_ocean_python_sdk.type.vpcs_create_request import VpcsCreateRequest
...
from digital_ocean_python_sdk.pydantic.vpcs_create_request import VpcsCreateRequest as VpcsCreateRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = VpcsCreateRequestSchema


request_body_vpcs_create_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VpcsCreateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_vpcs_create_request.serialize(body, content_type)
