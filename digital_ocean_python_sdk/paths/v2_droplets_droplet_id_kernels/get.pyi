...
from digital_ocean_python_sdk.model.droplets_list_kernels_response import DropletsListKernelsResponse as DropletsListKernelsResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.droplets_list_kernels_response import DropletsListKernelsResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.droplets_list_kernels_response import DropletsListKernelsResponse as DropletsListKernelsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListKernelsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListKernelsResponse
...
class ListKernelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_kernels(
        self,
        droplet_id: int,
        per_page: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_kernels_mapped_args(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
        )
        return await self._alist_kernels_oapg(
    ...
    def list_kernels(
        ...
        return self._list_kernels_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListKernels(BaseApi):
    ...
    async def alist_kernels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListKernelsResponsePydantic:
        raw_response = await self.raw.alist_kernels(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
            **kwargs,
        ...
        if validate:
            return RootModel[DropletsListKernelsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListKernelsResponsePydantic, raw_response.body)
    ...
    def list_kernels(
        ...
        raw_response = self.raw.list_kernels(
            droplet_id=droplet_id,
            per_page=per_page,
            page=page,
        )
