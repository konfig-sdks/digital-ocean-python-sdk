...
from digital_ocean_python_sdk.model.kubernetes_list_node_pools_response import KubernetesListNodePoolsResponse as KubernetesListNodePoolsResponseSchema

from digital_ocean_python_sdk.type.kubernetes_list_node_pools_response import KubernetesListNodePoolsResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.kubernetes_list_node_pools_response import KubernetesListNodePoolsResponse as KubernetesListNodePoolsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = KubernetesListNodePoolsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: KubernetesListNodePoolsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_node_pools_mapped_args(
        self,
        cluster_id: str,
    ...
    async def _alist_node_pools_oapg(
        self,
...
class ListNodePoolsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_node_pools(
        self,
        cluster_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_node_pools_mapped_args(
            cluster_id=cluster_id,
        )
        return await self._alist_node_pools_oapg(
    ...
    def list_node_pools(
        ...
        return self._list_node_pools_oapg(
            path_params=args.path,
        )

class ListNodePools(BaseApi):
    ...
    async def alist_node_pools(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesListNodePoolsResponsePydantic:
        raw_response = await self.raw.alist_node_pools(
            cluster_id=cluster_id,
            **kwargs,
        )
        if validate:
            return KubernetesListNodePoolsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesListNodePoolsResponsePydantic, raw_response.body)
    ...
    def list_node_pools(
        ...
        raw_response = self.raw.list_node_pools(
            cluster_id=cluster_id,
        )
        if validate:
            return KubernetesListNodePoolsResponsePydantic(**raw_response.body)
