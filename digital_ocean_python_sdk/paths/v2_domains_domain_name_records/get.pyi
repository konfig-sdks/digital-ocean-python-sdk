...
from digital_ocean_python_sdk.model.domain_records_list_all_records_response import DomainRecordsListAllRecordsResponse as DomainRecordsListAllRecordsResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.domain_records_list_all_records_response import DomainRecordsListAllRecordsResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.domain_records_list_all_records_response import DomainRecordsListAllRecordsResponse as DomainRecordsListAllRecordsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DomainRecordsListAllRecordsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DomainRecordsListAllRecordsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_all_records_mapped_args(
        self,
        domain_name: str,
    ...
    async def _alist_all_records_oapg(
        self,
...
class ListAllRecordsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_records(
        self,
        domain_name: str,
        name: typing.Optional[str] = None,
        type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_all_records_mapped_args(
        ...
        return await self._alist_all_records_oapg(
    ...
    def list_all_records(
        ...
        return self._list_all_records_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListAllRecords(BaseApi):
    ...
    async def alist_all_records(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainRecordsListAllRecordsResponsePydantic:
        raw_response = await self.raw.alist_all_records(
            domain_name=domain_name,
            name=name,
            type=type,
            per_page=per_page,
        ...
        if validate:
            return RootModel[DomainRecordsListAllRecordsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DomainRecordsListAllRecordsResponsePydantic, raw_response.body)
    ...
    def list_all_records(
        ...
        raw_response = self.raw.list_all_records(
            domain_name=domain_name,
            name=name,
            type=type,
            per_page=per_page,
