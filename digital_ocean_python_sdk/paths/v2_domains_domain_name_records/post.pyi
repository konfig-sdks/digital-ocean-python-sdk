...
from digital_ocean_python_sdk.model.domain_records_create_new_record_request import DomainRecordsCreateNewRecordRequest as DomainRecordsCreateNewRecordRequestSchema
from digital_ocean_python_sdk.model.domain_records_create_new_record_response import DomainRecordsCreateNewRecordResponse as DomainRecordsCreateNewRecordResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.domain_records_create_new_record_response import DomainRecordsCreateNewRecordResponse
from digital_ocean_python_sdk.type.domain_records_create_new_record_request import DomainRecordsCreateNewRecordRequest

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.domain_records_create_new_record_response import DomainRecordsCreateNewRecordResponse as DomainRecordsCreateNewRecordResponsePydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.domain_records_create_new_record_request import DomainRecordsCreateNewRecordRequest as DomainRecordsCreateNewRecordRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainRecordsCreateNewRecordRequestSchema


request_body_domain_records_create_new_record_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DomainRecordsCreateNewRecordResponseSchema
...
class ApiResponseFor201(api_client.ApiResponse):
    body: DomainRecordsCreateNewRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_record_mapped_args(
        ...
        body: typing.Optional[DomainRecordsCreateNewRecordRequest] = None,
    ...
    async def _acreate_new_record_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_domain_records_create_new_record_request.serialize(body, content_type)
...
class CreateNewRecord(BaseApi):
    ...
    async def acreate_new_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainRecordsCreateNewRecordResponsePydantic:
        ...
        if validate:
            return DomainRecordsCreateNewRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainRecordsCreateNewRecordResponsePydantic, raw_response.body)
