...
from digital_ocean_python_sdk.model.apps_list_regions_response import AppsListRegionsResponse as AppsListRegionsResponseSchema

from digital_ocean_python_sdk.type.apps_list_regions_response import AppsListRegionsResponse
...
from digital_ocean_python_sdk.pydantic.apps_list_regions_response import AppsListRegionsResponse as AppsListRegionsResponsePydantic

RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = AppsListRegionsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_regions_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_regions_oapg(
        self,
...
class ListRegionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_regions(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_regions_mapped_args(
        )
        return await self._alist_regions_oapg(
            **kwargs,
        )
...
class ListRegions(BaseApi):
    ...
    async def alist_regions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsListRegionsResponsePydantic:
        raw_response = await self.raw.alist_regions(
            **kwargs,
        )
        if validate:
            return AppsListRegionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListRegionsResponsePydantic, raw_response.body)
    ...
    def list_regions(
        ...
        raw_response = self.raw.list_regions(
        )
        if validate:
            return AppsListRegionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListRegionsResponsePydantic, raw_response.body)
