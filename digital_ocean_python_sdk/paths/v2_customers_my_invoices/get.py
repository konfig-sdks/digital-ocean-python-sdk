...
from digital_ocean_python_sdk.model.invoices_list_response import InvoicesListResponse as InvoicesListResponseSchema

from digital_ocean_python_sdk.type.invoices_list_response import InvoicesListResponse
...
from digital_ocean_python_sdk.pydantic.invoices_list_response import InvoicesListResponse as InvoicesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = InvoicesListResponseSchema
...
class List0(BaseApi):
    ...
    async def alist_0(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[InvoicesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(InvoicesListResponsePydantic, raw_response.body)
