...
from digital_ocean_python_sdk.model.databases_update_firewall_rules_request import DatabasesUpdateFirewallRulesRequest as DatabasesUpdateFirewallRulesRequestSchema

from digital_ocean_python_sdk.type.databases_update_firewall_rules_request import DatabasesUpdateFirewallRulesRequest
...
from digital_ocean_python_sdk.pydantic.databases_update_firewall_rules_request import DatabasesUpdateFirewallRulesRequest as DatabasesUpdateFirewallRulesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabasesUpdateFirewallRulesRequestSchema


request_body_databases_update_firewall_rules_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_firewall_rules_mapped_args(
        self,
    ...
    async def _aupdate_firewall_rules_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_databases_update_firewall_rules_request.serialize(body, content_type)
    ...
    def _update_firewall_rules_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFirewallRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_firewall_rules(
        self,
        database_cluster_uuid: str,
        rules: typing.Optional[typing.List[FirewallRule]] = None,
        **kwargs,
        ...
        args = self._update_firewall_rules_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            rules=rules,
        )
        return await self._aupdate_firewall_rules_oapg(
            body=args.body,
    ...
    def update_firewall_rules(
        ...
        return self._update_firewall_rules_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFirewallRules(BaseApi):
    ...
    async def aupdate_firewall_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_firewall_rules(
            database_cluster_uuid=database_cluster_uuid,
            rules=rules,
            **kwargs,
        )
    ...
    def update_firewall_rules(
        ...
        raw_response = self.raw.update_firewall_rules(
            database_cluster_uuid=database_cluster_uuid,
            rules=rules,
        )
