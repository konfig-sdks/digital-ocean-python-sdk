...
from digital_ocean_python_sdk.model.databases_list_firewall_rules_response import DatabasesListFirewallRulesResponse as DatabasesListFirewallRulesResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.databases_list_firewall_rules_response import DatabasesListFirewallRulesResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.databases_list_firewall_rules_response import DatabasesListFirewallRulesResponse as DatabasesListFirewallRulesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListFirewallRulesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListFirewallRulesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_firewall_rules_mapped_args(
        self,
    ...
    async def _alist_firewall_rules_oapg(
        self,
...
class ListFirewallRulesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_firewall_rules(
        self,
        database_cluster_uuid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_firewall_rules_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
        )
        return await self._alist_firewall_rules_oapg(
    ...
    def list_firewall_rules(
        ...
        return self._list_firewall_rules_oapg(
            path_params=args.path,
        )

class ListFirewallRules(BaseApi):
    ...
    async def alist_firewall_rules(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListFirewallRulesResponsePydantic:
        raw_response = await self.raw.alist_firewall_rules(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListFirewallRulesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListFirewallRulesResponsePydantic, raw_response.body)
    ...
    def list_firewall_rules(
        ...
        raw_response = self.raw.list_firewall_rules(
            database_cluster_uuid=database_cluster_uuid,
        )
        if validate:
            return DatabasesListFirewallRulesResponsePydantic(**raw_response.body)
