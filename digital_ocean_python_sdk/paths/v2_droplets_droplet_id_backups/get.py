...
from digital_ocean_python_sdk.model.droplets_list_backups_response import DropletsListBackupsResponse as DropletsListBackupsResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.droplets_list_backups_response import DropletsListBackupsResponse
...
from digital_ocean_python_sdk.pydantic.droplets_list_backups_response import DropletsListBackupsResponse as DropletsListBackupsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DropletsListBackupsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DropletsListBackupsResponse
...
class ListBackups(BaseApi):
    ...
    async def alist_backups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DropletsListBackupsResponsePydantic:
        ...
        if validate:
            return RootModel[DropletsListBackupsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(DropletsListBackupsResponsePydantic, raw_response.body)
