...
from digital_ocean_python_sdk.model.regions_list_response import RegionsListResponse as RegionsListResponseSchema

from digital_ocean_python_sdk.type.regions_list_response import RegionsListResponse
...
from digital_ocean_python_sdk.pydantic.regions_list_response import RegionsListResponse as RegionsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = RegionsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[RegionsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(RegionsListResponsePydantic, raw_response.body)
