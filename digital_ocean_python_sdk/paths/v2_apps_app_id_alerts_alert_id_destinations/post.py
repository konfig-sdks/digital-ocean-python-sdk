...
from digital_ocean_python_sdk.model.apps_alert_response import AppsAlertResponse as AppsAlertResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema
from digital_ocean_python_sdk.model.app_alert_slack_webhook import AppAlertSlackWebhook as AppAlertSlackWebhookSchema
from digital_ocean_python_sdk.model.apps_assign_app_alert_destinations_request import AppsAssignAppAlertDestinationsRequest as AppsAssignAppAlertDestinationsRequestSchema

from digital_ocean_python_sdk.type.apps_assign_app_alert_destinations_request import AppsAssignAppAlertDestinationsRequest
from digital_ocean_python_sdk.type.app_alert_slack_webhook import AppAlertSlackWebhook
from digital_ocean_python_sdk.type.apps_alert_response import AppsAlertResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.apps_assign_app_alert_destinations_request import AppsAssignAppAlertDestinationsRequest as AppsAssignAppAlertDestinationsRequestPydantic
from digital_ocean_python_sdk.pydantic.app_alert_slack_webhook import AppAlertSlackWebhook as AppAlertSlackWebhookPydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.apps_alert_response import AppsAlertResponse as AppsAlertResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = AppsAssignAppAlertDestinationsRequestSchema


request_body_apps_assign_app_alert_destinations_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppsAlertResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_destinations_for_alerts_mapped_args(
        self,
        app_id: str,
        alert_id: str,
        emails: typing.Optional[typing.List[str]] = None,
        slack_webhooks: typing.Optional[typing.List[AppAlertSlackWebhook]] = None,
        ...
        if slack_webhooks is not None:
            _body["slack_webhooks"] = slack_webhooks
        args.body = _body
    ...
    async def _aupdate_destinations_for_alerts_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_apps_assign_app_alert_destinations_request.serialize(body, content_type)
    ...
    def _update_destinations_for_alerts_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDestinationsForAlertsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_destinations_for_alerts(
        self,
        app_id: str,
        alert_id: str,
        emails: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._update_destinations_for_alerts_mapped_args(
            app_id=app_id,
            alert_id=alert_id,
            emails=emails,
            slack_webhooks=slack_webhooks,
        )
        return await self._aupdate_destinations_for_alerts_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_destinations_for_alerts(
        self,
        app_id: str,
        alert_id: str,
        emails: typing.Optional[typing.List[str]] = None,
        ...
        return self._update_destinations_for_alerts_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDestinationsForAlerts(BaseApi):
    ...
    async def aupdate_destinations_for_alerts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsAlertResponsePydantic:
        raw_response = await self.raw.aupdate_destinations_for_alerts(
            app_id=app_id,
            alert_id=alert_id,
            emails=emails,
            slack_webhooks=slack_webhooks,
        ...
        if validate:
            return AppsAlertResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsAlertResponsePydantic, raw_response.body)
    ...
    def update_destinations_for_alerts(
        ...
        raw_response = self.raw.update_destinations_for_alerts(
            app_id=app_id,
            alert_id=alert_id,
            emails=emails,
            slack_webhooks=slack_webhooks,
