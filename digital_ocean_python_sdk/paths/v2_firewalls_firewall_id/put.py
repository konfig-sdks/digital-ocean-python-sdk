...
from digital_ocean_python_sdk.model.firewall_rules_inbound_rules import FirewallRulesInboundRules as FirewallRulesInboundRulesSchema
...
from digital_ocean_python_sdk.model.firewalls_update_response import FirewallsUpdateResponse as FirewallsUpdateResponseSchema
from digital_ocean_python_sdk.model.firewalls_update_request import FirewallsUpdateRequest as FirewallsUpdateRequestSchema
from digital_ocean_python_sdk.model.firewall_rules_outbound_rules import FirewallRulesOutboundRules as FirewallRulesOutboundRulesSchema

from digital_ocean_python_sdk.type.firewalls_update_request import FirewallsUpdateRequest
from digital_ocean_python_sdk.type.tags_array import TagsArray
from digital_ocean_python_sdk.type.firewalls_update_response import FirewallsUpdateResponse
from digital_ocean_python_sdk.type.firewall_rules_inbound_rules import FirewallRulesInboundRules
from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.firewall_rules_outbound_rules import FirewallRulesOutboundRules

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.firewalls_update_response import FirewallsUpdateResponse as FirewallsUpdateResponsePydantic
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.firewall_rules_outbound_rules import FirewallRulesOutboundRules as FirewallRulesOutboundRulesPydantic
from digital_ocean_python_sdk.pydantic.tags_array import TagsArray as TagsArrayPydantic
from digital_ocean_python_sdk.pydantic.firewalls_update_request import FirewallsUpdateRequest as FirewallsUpdateRequestPydantic
from digital_ocean_python_sdk.pydantic.firewall_rules_inbound_rules import FirewallRulesInboundRules as FirewallRulesInboundRulesPydantic

from . import path

# Path params
FirewallIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'firewall_id': typing.Union[FirewallIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_firewall_id = api_client.PathParameter(
    name="firewall_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FirewallIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = FirewallsUpdateRequestSchema


request_body_firewalls_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FirewallsUpdateResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_mapped_args(
        ...
        pending_changes: typing.Optional[typing.List[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]] = None,
        droplet_ids: typing.Optional[typing.Optional[typing.List[int]]] = None,
        inbound_rules: typing.Optional[FirewallRulesInboundRules] = None,
        outbound_rules: typing.Optional[FirewallRulesOutboundRules] = None,
        body: typing.Optional[FirewallsUpdateRequest] = None,
        ...
        if pending_changes is not None:
            _body["pending_changes"] = pending_changes
        if name is not None:
            _body["name"] = name
        if droplet_ids is not None:
            _body["droplet_ids"] = droplet_ids
        if inbound_rules is not None:
            _body["inbound_rules"] = inbound_rules
        if outbound_rules is not None:
            _body["outbound_rules"] = outbound_rules
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_firewalls_update_request.serialize(body, content_type)
...
class Update(BaseApi):
    ...
    async def aupdate(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsUpdateResponsePydantic:
        ...
        if validate:
            return FirewallsUpdateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsUpdateResponsePydantic, raw_response.body)
