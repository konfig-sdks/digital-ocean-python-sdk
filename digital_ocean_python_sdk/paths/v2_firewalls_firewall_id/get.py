...
from digital_ocean_python_sdk.model.firewalls_get_response import FirewallsGetResponse as FirewallsGetResponseSchema

from digital_ocean_python_sdk.type.firewalls_get_response import FirewallsGetResponse
...
from digital_ocean_python_sdk.pydantic.firewalls_get_response import FirewallsGetResponse as FirewallsGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FirewallsGetResponseSchema
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FirewallsGetResponsePydantic:
        raw_response = await self.raw.aget(
            firewall_id=firewall_id,
            **kwargs,
        )
        if validate:
            return FirewallsGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FirewallsGetResponsePydantic, raw_response.body)
