...
from digital_ocean_python_sdk.model.user_settings import UserSettings as UserSettingsSchema
from digital_ocean_python_sdk.model.databases_add_user_request import DatabasesAddUserRequest as DatabasesAddUserRequestSchema

from digital_ocean_python_sdk.type.mysql_settings import MysqlSettings
from digital_ocean_python_sdk.type.databases_add_user_request import DatabasesAddUserRequest
from digital_ocean_python_sdk.type.databases_add_user_response import DatabasesAddUserResponse
from digital_ocean_python_sdk.type.user_settings import UserSettings
...
from digital_ocean_python_sdk.pydantic.databases_add_user_request import DatabasesAddUserRequest as DatabasesAddUserRequestPydantic
from digital_ocean_python_sdk.pydantic.mysql_settings import MysqlSettings as MysqlSettingsPydantic
from digital_ocean_python_sdk.pydantic.user_settings import UserSettings as UserSettingsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabasesAddUserRequestSchema


request_body_databases_add_user_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DatabasesAddUserResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_user_mapped_args(
        ...
        access_cert: typing.Optional[str] = None,
    ...
    async def _aadd_user_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_databases_add_user_request.serialize(body, content_type)
