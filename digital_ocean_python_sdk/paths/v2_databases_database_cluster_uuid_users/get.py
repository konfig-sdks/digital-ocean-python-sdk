...
from digital_ocean_python_sdk.model.databases_list_users_response import DatabasesListUsersResponse as DatabasesListUsersResponseSchema

from digital_ocean_python_sdk.type.databases_list_users_response import DatabasesListUsersResponse
from digital_ocean_python_sdk.type.error import Error

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.databases_list_users_response import DatabasesListUsersResponse as DatabasesListUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DatabasesListUsersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: DatabasesListUsersResponse
...
class ListUsers(BaseApi):
    ...
    async def alist_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DatabasesListUsersResponsePydantic:
        raw_response = await self.raw.alist_users(
            database_cluster_uuid=database_cluster_uuid,
            **kwargs,
        )
        if validate:
            return DatabasesListUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DatabasesListUsersResponsePydantic, raw_response.body)
