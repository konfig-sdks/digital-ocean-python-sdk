...
from digital_ocean_python_sdk.model.apps_delete_app_response import AppsDeleteAppResponse as AppsDeleteAppResponseSchema

from digital_ocean_python_sdk.type.apps_delete_app_response import AppsDeleteAppResponse
...
from digital_ocean_python_sdk.pydantic.apps_delete_app_response import AppsDeleteAppResponse as AppsDeleteAppResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsDeleteAppResponseSchema
...
class Delete(BaseApi):
    ...
    async def adelete(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppsDeleteAppResponsePydantic:
        raw_response = await self.raw.adelete(
            id=id,
            **kwargs,
        )
        if validate:
            return AppsDeleteAppResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsDeleteAppResponsePydantic, raw_response.body)
