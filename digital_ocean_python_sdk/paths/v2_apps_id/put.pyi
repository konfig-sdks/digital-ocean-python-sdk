...
from digital_ocean_python_sdk.model.app_response import AppResponse as AppResponseSchema
...
from digital_ocean_python_sdk.model.apps_update_app_request import AppsUpdateAppRequest as AppsUpdateAppRequestSchema

from digital_ocean_python_sdk.type.app_response import AppResponse
from digital_ocean_python_sdk.type.apps_update_app_request import AppsUpdateAppRequest
...
from digital_ocean_python_sdk.pydantic.apps_update_app_request import AppsUpdateAppRequest as AppsUpdateAppRequestPydantic
from digital_ocean_python_sdk.pydantic.app_response import AppResponse as AppResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = AppsUpdateAppRequestSchema


request_body_apps_update_app_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_apps_update_app_request.serialize(body, content_type)
...
class Update(BaseApi):
    ...
    async def aupdate(
        ...
        **kwargs,
        ...
        if validate:
            return AppResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppResponsePydantic, raw_response.body)
