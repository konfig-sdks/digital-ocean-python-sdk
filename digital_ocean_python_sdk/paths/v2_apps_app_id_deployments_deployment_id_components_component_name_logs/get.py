...
class BaseApi(api_client.Api):
    ...
    def _get_deployment_logs_mapped_args(
        self,
        app_id: str,
        deployment_id: str,
        component_name: str,
    ...
    async def _aget_deployment_logs_oapg(
        self,
...
class GetDeploymentLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_deployment_logs(
        self,
        app_id: str,
        deployment_id: str,
        component_name: str,
        ...
        **kwargs,
        ...
        args = self._get_deployment_logs_mapped_args(
            app_id=app_id,
        ...
        return await self._aget_deployment_logs_oapg(
    ...
    def get_deployment_logs(
        ...
        return self._get_deployment_logs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetDeploymentLogs(BaseApi):
    ...
    async def aget_deployment_logs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_deployment_logs(
            app_id=app_id,
            deployment_id=deployment_id,
            component_name=component_name,
            type=type,
    ...
    def get_deployment_logs(
        ...
        raw_response = self.raw.get_deployment_logs(
            app_id=app_id,
            deployment_id=deployment_id,
            component_name=component_name,
            type=type,
