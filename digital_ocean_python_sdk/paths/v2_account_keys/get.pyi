...
from digital_ocean_python_sdk.model.ssh_keys_list_response import SshKeysListResponse as SshKeysListResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.ssh_keys_list_response import SshKeysListResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.ssh_keys_list_response import SshKeysListResponse as SshKeysListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SshKeysListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[SshKeysListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(SshKeysListResponsePydantic, raw_response.body)
