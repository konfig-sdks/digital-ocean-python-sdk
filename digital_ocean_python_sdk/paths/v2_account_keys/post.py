...
from digital_ocean_python_sdk.model.ssh_keys import SshKeys as SshKeysSchema

from digital_ocean_python_sdk.type.ssh_keys import SshKeys
...
from digital_ocean_python_sdk.pydantic.ssh_keys import SshKeys as SshKeysPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = SshKeysSchema


request_body_ssh_keys = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_ssh_keys.serialize(body, content_type)
