...
from digital_ocean_python_sdk.model.projects_list_response import ProjectsListResponse as ProjectsListResponseSchema
from digital_ocean_python_sdk.model.error import Error as ErrorSchema

from digital_ocean_python_sdk.type.projects_list_response import ProjectsListResponse
...
from digital_ocean_python_sdk.pydantic.projects_list_response import ProjectsListResponse as ProjectsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ProjectsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProjectsListResponsePydantic, raw_response.body)
