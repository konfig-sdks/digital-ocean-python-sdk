...
from digital_ocean_python_sdk.model.project_base import ProjectBase as ProjectBaseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.project_base import ProjectBase

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.project_base import ProjectBase as ProjectBasePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ProjectBaseSchema


request_body_project_base = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_project_base.serialize(body, content_type)
