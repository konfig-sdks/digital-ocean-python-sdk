...
from digital_ocean_python_sdk.model.apps_list_instance_sizes_response import AppsListInstanceSizesResponse as AppsListInstanceSizesResponseSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.apps_list_instance_sizes_response import AppsListInstanceSizesResponse

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.apps_list_instance_sizes_response import AppsListInstanceSizesResponse as AppsListInstanceSizesResponsePydantic

RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = AppsListInstanceSizesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: AppsListInstanceSizesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_instance_sizes_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_instance_sizes_oapg(
        self,
...
class ListInstanceSizesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_instance_sizes(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_instance_sizes_mapped_args(
        )
        return await self._alist_instance_sizes_oapg(
            **kwargs,
        )
    ...
    def list_instance_sizes(
        ...
        return self._list_instance_sizes_oapg(
        )

class ListInstanceSizes(BaseApi):

    async def alist_instance_sizes(
        self,
        validate: bool = False,
        **kwargs,
    ) -> AppsListInstanceSizesResponsePydantic:
        raw_response = await self.raw.alist_instance_sizes(
            **kwargs,
        )
        if validate:
            return AppsListInstanceSizesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListInstanceSizesResponsePydantic, raw_response.body)
    ...
    def list_instance_sizes(
        ...
        raw_response = self.raw.list_instance_sizes(
        )
        if validate:
            return AppsListInstanceSizesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AppsListInstanceSizesResponsePydantic, raw_response.body)
