...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'host_id': typing.Union[HostIdSchema, str, ],
        'interface': typing.Union[InterfaceSchema, str, ],
...
request_query_interface = api_client.QueryParameter(
    name="interface",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _get_droplet_bandwidth_metrics_mapped_args(
        self,
        host_id: str,
        interface: str,
        direction: str,
        ...
        if host_id is not None:
            _query_params["host_id"] = host_id
        if interface is not None:
            _query_params["interface"] = interface
    ...
    async def _aget_droplet_bandwidth_metrics_oapg(
        self,
    ...
    def _get_droplet_bandwidth_metrics_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDropletBandwidthMetricsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_droplet_bandwidth_metrics(
        self,
        host_id: str,
        interface: str,
        direction: str,
        ...
        **kwargs,
        ...
        args = self._get_droplet_bandwidth_metrics_mapped_args(
            host_id=host_id,
            interface=interface,
            direction=direction,
            start=start,
        ...
        return await self._aget_droplet_bandwidth_metrics_oapg(
    ...
    def get_droplet_bandwidth_metrics(
        ...
        return self._get_droplet_bandwidth_metrics_oapg(
            query_params=args.query,
        )

class GetDropletBandwidthMetrics(BaseApi):
    ...
    async def aget_droplet_bandwidth_metrics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_droplet_bandwidth_metrics(
            host_id=host_id,
            interface=interface,
            direction=direction,
            start=start,
    ...
    def get_droplet_bandwidth_metrics(
        ...
        raw_response = self.raw.get_droplet_bandwidth_metrics(
            host_id=host_id,
            interface=interface,
            direction=direction,
            start=start,
