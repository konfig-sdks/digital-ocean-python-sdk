...
from digital_ocean_python_sdk.model.database_cluster_resize import DatabaseClusterResize as DatabaseClusterResizeSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.database_cluster_resize import DatabaseClusterResize

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.database_cluster_resize import DatabaseClusterResize as DatabaseClusterResizePydantic
...
# body param
SchemaForRequestBodyApplicationJson = DatabaseClusterResizeSchema


request_body_database_cluster_resize = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _resize_cluster_mapped_args(
        self,
        size: str,
        num_nodes: int,
    ...
    async def _aresize_cluster_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_database_cluster_resize.serialize(body, content_type)
...
class ResizeClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresize_cluster(
        self,
        size: str,
        num_nodes: int,
        database_cluster_uuid: str,
        ...
        **kwargs,
        ...
        args = self._resize_cluster_mapped_args(
            size=size,
            num_nodes=num_nodes,
            database_cluster_uuid=database_cluster_uuid,
            storage_size_mib=storage_size_mib,
        )
        return await self._aresize_cluster_oapg(
            body=args.body,
    ...
    def resize_cluster(
        ...
        return self._resize_cluster_oapg(
            body=args.body,
            path_params=args.path,
        )

class ResizeCluster(BaseApi):
    ...
    async def aresize_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aresize_cluster(
            size=size,
            num_nodes=num_nodes,
            database_cluster_uuid=database_cluster_uuid,
            storage_size_mib=storage_size_mib,
    ...
    def resize_cluster(
        ...
        raw_response = self.raw.resize_cluster(
            size=size,
            num_nodes=num_nodes,
            database_cluster_uuid=database_cluster_uuid,
            storage_size_mib=storage_size_mib,
