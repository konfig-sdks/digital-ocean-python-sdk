...
from digital_ocean_python_sdk.model.kubernetes_options import KubernetesOptions as KubernetesOptionsSchema

from digital_ocean_python_sdk.type.error import Error
from digital_ocean_python_sdk.type.kubernetes_options import KubernetesOptions

from ...api_client import Dictionary
from digital_ocean_python_sdk.pydantic.error import Error as ErrorPydantic
from digital_ocean_python_sdk.pydantic.kubernetes_options import KubernetesOptions as KubernetesOptionsPydantic

RatelimitLimitSchema = schemas.IntSchema
RatelimitRemainingSchema = schemas.IntSchema
RatelimitResetSchema = schemas.IntSchema
SchemaFor200ResponseBodyApplicationJson = KubernetesOptionsSchema
...
class ListOptions(BaseApi):
    ...
    async def alist_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> KubernetesOptionsPydantic:
        raw_response = await self.raw.alist_options(
            **kwargs,
        )
        if validate:
            return KubernetesOptionsPydantic(**raw_response.body)
        return api_client.construct_model_instance(KubernetesOptionsPydantic, raw_response.body)
