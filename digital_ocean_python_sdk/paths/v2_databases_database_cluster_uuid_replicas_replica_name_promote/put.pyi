...
class BaseApi(api_client.Api):
    ...
    def _promote_readonly_replica_to_primary_mapped_args(
        self,
    ...
    async def _apromote_readonly_replica_to_primary_oapg(
        self,
    ...
    def _promote_readonly_replica_to_primary_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PromoteReadonlyReplicaToPrimaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apromote_readonly_replica_to_primary(
        self,
        database_cluster_uuid: str,
        replica_name: str,
        **kwargs,
        ...
        args = self._promote_readonly_replica_to_primary_mapped_args(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
        return await self._apromote_readonly_replica_to_primary_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def promote_readonly_replica_to_primary(
        self,
        database_cluster_uuid: str,
        replica_name: str,
    ) -> typing.Union[
        ...
        return self._promote_readonly_replica_to_primary_oapg(
            path_params=args.path,
        )

class PromoteReadonlyReplicaToPrimary(BaseApi):
    ...
    async def apromote_readonly_replica_to_primary(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apromote_readonly_replica_to_primary(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
            **kwargs,
        )
    ...
    def promote_readonly_replica_to_primary(
        ...
        raw_response = self.raw.promote_readonly_replica_to_primary(
            database_cluster_uuid=database_cluster_uuid,
            replica_name=replica_name,
        )
