...
class NetworkV6(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip_address", "netmask", "gateway", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip_address", "netmask", "gateway", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        netmask: typing.Union[MetaOapg.properties.netmask, decimal.Decimal, int, schemas.Unset] = schemas.unset,
