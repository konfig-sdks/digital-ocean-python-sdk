...
class UserSettingsAclItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class permission(
                ...
                @schemas.classproperty
                def PRODUCECONSUME(cls):
                    return cls("produceconsume")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["topic", "permission", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["topic", "permission", "id", ], str]):
