...
class SshKeys(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public_key", "name", "id", "fingerprint", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public_key", "name", "id", "fingerprint", ], str]):
