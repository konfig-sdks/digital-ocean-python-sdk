...
class DropletNetworks(
        ...
        class properties:
            ...
            class v4(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NetworkV4']:
                        return NetworkV4
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NetworkV4'], typing.List['NetworkV4']],
                ...
                def __getitem__(self, i: int) -> 'NetworkV4':
            ...
            class v6(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NetworkV6']:
                        return NetworkV6
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NetworkV6'], typing.List['NetworkV6']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'v6':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NetworkV6':
                    return super().__getitem__(i)
            __annotations__ = {
                "v4": v4,
                "v6": v6,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["v4"]) -> MetaOapg.properties.v4: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["v6"]) -> MetaOapg.properties.v6: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["v4", "v6", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["v4"]) -> typing.Union[MetaOapg.properties.v4, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["v6"]) -> typing.Union[MetaOapg.properties.v6, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["v4", "v6", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        v4: typing.Union[MetaOapg.properties.v4, list, tuple, schemas.Unset] = schemas.unset,
        v6: typing.Union[MetaOapg.properties.v6, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
