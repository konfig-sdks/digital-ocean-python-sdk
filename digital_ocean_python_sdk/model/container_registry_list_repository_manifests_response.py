...
class ContainerRegistryListRepositoryManifestsResponse(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class manifests(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['RepositoryManifest']:
                                return RepositoryManifest
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['RepositoryManifest'], typing.List['RepositoryManifest']],
                        ...
                        def __getitem__(self, i: int) -> 'RepositoryManifest':
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["manifests"]) -> MetaOapg.properties.manifests: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["manifests", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["manifests"]) -> typing.Union[MetaOapg.properties.manifests, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["manifests", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                manifests: typing.Union[MetaOapg.properties.manifests, list, tuple, schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
