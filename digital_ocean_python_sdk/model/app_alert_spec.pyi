...
class AppAlertSpec(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def rule() -> typing.Type['AppAlertSpecRule']:
                return AppAlertSpecRule
            disabled = schemas.BoolSchema
        
            @staticmethod
            def operator() -> typing.Type['AppAlertSpecOperator']:
                return AppAlertSpecOperator
            value = schemas.Float32Schema
        
            @staticmethod
            def window() -> typing.Type['AppAlertSpecWindow']:
                return AppAlertSpecWindow
            __annotations__ = {
                "rule": rule,
                "disabled": disabled,
                "operator": operator,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rule"]) -> 'AppAlertSpecRule': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["disabled"]) -> MetaOapg.properties.disabled: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["operator"]) -> 'AppAlertSpecOperator': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["value"]) -> MetaOapg.properties.value: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["window"]) -> 'AppAlertSpecWindow': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rule", "disabled", "operator", "value", "window", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rule"]) -> typing.Union['AppAlertSpecRule', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["disabled"]) -> typing.Union[MetaOapg.properties.disabled, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["operator"]) -> typing.Union['AppAlertSpecOperator', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["value"]) -> typing.Union[MetaOapg.properties.value, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["window"]) -> typing.Union['AppAlertSpecWindow', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rule", "disabled", "operator", "value", "window", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        rule: typing.Union['AppAlertSpecRule', schemas.Unset] = schemas.unset,
        disabled: typing.Union[MetaOapg.properties.disabled, bool, schemas.Unset] = schemas.unset,
        operator: typing.Union['AppAlertSpecOperator', schemas.Unset] = schemas.unset,
        value: typing.Union[MetaOapg.properties.value, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        window: typing.Union['AppAlertSpecWindow', schemas.Unset] = schemas.unset,
