...
class KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItemStatus']:
                return KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItemStatus
            droplet_id = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItemStatus': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "status", "droplet_id", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItemStatus', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "status", "droplet_id", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        status: typing.Union['KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItemStatus', schemas.Unset] = schemas.unset,
        droplet_id: typing.Union[MetaOapg.properties.droplet_id, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'KubernetesCreateNewClusterResponseKubernetesClustersNodePoolsItemNodesItem':
