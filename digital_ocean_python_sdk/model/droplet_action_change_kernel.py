...
class DropletActionChangeKernel(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["kernel", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["kernel", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                kernel: typing.Union[MetaOapg.properties.kernel, decimal.Decimal, int, schemas.Unset] = schemas.unset,
