...
class MaintenancePolicy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start_time", "duration", "day", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start_time", "duration", "day", ], str]):
