...
class ReservedIp(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["droplet"]) -> MetaOapg.properties.droplet: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip", "region", "droplet", "locked", "project_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["droplet"]) -> typing.Union[MetaOapg.properties.droplet, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip", "region", "droplet", "locked", "project_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        droplet: typing.Union[MetaOapg.properties.droplet, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
