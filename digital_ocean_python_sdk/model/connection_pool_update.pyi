...
class ConnectionPoolUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode", "size", "db", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode", "size", "db", "user", ], str]):
