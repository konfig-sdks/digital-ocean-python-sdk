...
class AppLogDestinationDefinition(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class name(
                ...
                class MetaOapg:
                    ...
                    min_length = 2
                    regex=[{
                        'pattern': r'^[A-Za-z0-9()\[\]'"][-A-Za-z0-9_. \/()\[\]]{0,40}[A-Za-z0-9()\[\]'"]$',
                    }]
        
            @staticmethod
            def papertrail() -> typing.Type['AppLogDestinationPapertrailSpec']:
                return AppLogDestinationPapertrailSpec
        
            @staticmethod
            def datadog() -> typing.Type['AppLogDestinationDatadogSpec']:
                return AppLogDestinationDatadogSpec
        
            @staticmethod
            def logtail() -> typing.Type['AppLogDestinationLogtailSpec']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["papertrail"]) -> 'AppLogDestinationPapertrailSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["datadog"]) -> 'AppLogDestinationDatadogSpec': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["logtail"]) -> 'AppLogDestinationLogtailSpec': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "papertrail", "datadog", "logtail", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["papertrail"]) -> typing.Union['AppLogDestinationPapertrailSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["datadog"]) -> typing.Union['AppLogDestinationDatadogSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["logtail"]) -> typing.Union['AppLogDestinationLogtailSpec', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "papertrail", "datadog", "logtail", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        papertrail: typing.Union['AppLogDestinationPapertrailSpec', schemas.Unset] = schemas.unset,
        datadog: typing.Union['AppLogDestinationDatadogSpec', schemas.Unset] = schemas.unset,
        logtail: typing.Union['AppLogDestinationLogtailSpec', schemas.Unset] = schemas.unset,
