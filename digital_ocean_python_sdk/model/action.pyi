...
class Action(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "type", "started_at", "completed_at", "resource_id", "resource_type", "region", "region_slug", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "type", "started_at", "completed_at", "resource_id", "resource_type", "region", "region_slug", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        resource_id: typing.Union[MetaOapg.properties.resource_id, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        region_slug: typing.Union[MetaOapg.properties.region_slug, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Action':
        return super().__new__(
