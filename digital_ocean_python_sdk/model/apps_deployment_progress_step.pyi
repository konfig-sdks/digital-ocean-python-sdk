...
class AppsDeploymentProgressStep(
    ...
    class MetaOapg:
        ...
        class properties:
            component_name = schemas.StrSchema
            ended_at = schemas.DateTimeSchema
            message_base = schemas.StrSchema
            name = schemas.StrSchema
        
            @staticmethod
            def reason() -> typing.Type['AppsDeploymentProgressStepReason']:
                return AppsDeploymentProgressStepReason
            started_at = schemas.DateTimeSchema
        
            @staticmethod
            def status() -> typing.Type['AppsDeploymentProgressStepStatus']:
                return AppsDeploymentProgressStepStatus
        
            @staticmethod
            def steps() -> typing.Type['AppsDeploymentProgressStepSteps']:
                return AppsDeploymentProgressStepSteps
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["component_name"]) -> MetaOapg.properties.component_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ended_at"]) -> MetaOapg.properties.ended_at: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["message_base"]) -> MetaOapg.properties.message_base: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> MetaOapg.properties.name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reason"]) -> 'AppsDeploymentProgressStepReason': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["started_at"]) -> MetaOapg.properties.started_at: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'AppsDeploymentProgressStepStatus': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["steps"]) -> 'AppsDeploymentProgressStepSteps': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["component_name", "ended_at", "message_base", "name", "reason", "started_at", "status", "steps", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["component_name"]) -> typing.Union[MetaOapg.properties.component_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ended_at"]) -> typing.Union[MetaOapg.properties.ended_at, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["message_base"]) -> typing.Union[MetaOapg.properties.message_base, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> typing.Union[MetaOapg.properties.name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reason"]) -> typing.Union['AppsDeploymentProgressStepReason', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['AppsDeploymentProgressStepStatus', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["steps"]) -> typing.Union['AppsDeploymentProgressStepSteps', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["component_name", "ended_at", "message_base", "name", "reason", "started_at", "status", "steps", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        component_name: typing.Union[MetaOapg.properties.component_name, str, schemas.Unset] = schemas.unset,
        ended_at: typing.Union[MetaOapg.properties.ended_at, str, datetime, schemas.Unset] = schemas.unset,
        message_base: typing.Union[MetaOapg.properties.message_base, str, schemas.Unset] = schemas.unset,
        name: typing.Union[MetaOapg.properties.name, str, schemas.Unset] = schemas.unset,
        reason: typing.Union['AppsDeploymentProgressStepReason', schemas.Unset] = schemas.unset,
        started_at: typing.Union[MetaOapg.properties.started_at, str, datetime, schemas.Unset] = schemas.unset,
        status: typing.Union['AppsDeploymentProgressStepStatus', schemas.Unset] = schemas.unset,
        steps: typing.Union['AppsDeploymentProgressStepSteps', schemas.Unset] = schemas.unset,
