...
class FirewallRuleBase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protocol", "ports", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["protocol", "ports", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ports: typing.Union[MetaOapg.properties.ports, str, ],
