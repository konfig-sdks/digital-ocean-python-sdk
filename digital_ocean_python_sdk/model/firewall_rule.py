...
class FirewallRule(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "value", "uuid", "cluster_uuid", "created_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "value", "uuid", "cluster_uuid", "created_at", ], str]):
