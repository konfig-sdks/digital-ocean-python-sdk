...
class DomainRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "id", "name", "data", "priority", "port", "ttl", "weight", "flags", "tag", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "id", "name", "data", "priority", "port", "ttl", "weight", "flags", "tag", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        flags: typing.Union[MetaOapg.properties.flags, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
