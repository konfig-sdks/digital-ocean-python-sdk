...
class UpdateEndpoint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ttl", "certificate_id", "custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ttl", "certificate_id", "custom_domain", ], str]):
