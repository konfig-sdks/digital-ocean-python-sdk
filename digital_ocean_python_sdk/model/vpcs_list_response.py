...
class VpcsListResponse(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class vpcs(
                        ...
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['Vpc'], typing.List['Vpc']],
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["vpcs", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["vpcs", ], str]):
