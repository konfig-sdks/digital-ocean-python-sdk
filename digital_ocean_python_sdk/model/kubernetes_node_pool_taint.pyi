...
class KubernetesNodePoolTaint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "value", "effect", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "value", "effect", ], str]):
