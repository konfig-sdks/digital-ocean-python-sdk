...
class AppsStringMatch(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["exact", "prefix", "regex", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["exact", "prefix", "regex", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        exact: typing.Union[MetaOapg.properties.exact, str, schemas.Unset] = schemas.unset,
