...
class DropletsCreateResponse(
    ...
    class MetaOapg:
        ...
        class one_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def droplet() -> typing.Type['Droplet']:
                        return Droplet
                            ...
                            class properties:
                                ...
                                class actions(
                                    ...
                                    class MetaOapg:
                                        ...
                                        @staticmethod
                                        def items() -> typing.Type['ActionLink']:
                                            return ActionLink
                                
                                    def __new__(
                                        cls,
                                        arg: typing.Union[typing.Tuple['ActionLink'], typing.List['ActionLink']],
                                    ...
                                    def __getitem__(self, i: int) -> 'ActionLink':
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["droplet"]) -> 'Droplet': ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["droplet", "links", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["droplet"]) -> 'Droplet': ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["droplet", "links", ], str]):
                return super().get_item_oapg(name)
        ...
        class one_of_1(
                ...
                class properties:
                    ...
                    class droplets(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['Droplet']:
                                return Droplet
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['Droplet'], typing.List['Droplet']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'droplets':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'Droplet':
                            return super().__getitem__(i)
            ...
            droplets: MetaOapg.properties.droplets
            links: MetaOapg.properties.links
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["droplets"]) -> MetaOapg.properties.droplets: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["droplets", "links", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["droplets"]) -> MetaOapg.properties.droplets: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["droplets", "links", ], str]):
                return super().get_item_oapg(name)
            ...
            def __new__(
                cls,
                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                droplets: typing.Union[MetaOapg.properties.droplets, list, tuple, ],
                links: typing.Union[MetaOapg.properties.links, dict, frozendict.frozendict, ],
                _configuration: typing.Optional[schemas.Configuration] = None,
                **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ) -> 'one_of_1':
