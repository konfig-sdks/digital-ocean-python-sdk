    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class options(
                    ...
                    class properties:
                        ...
                        class regions(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['KubernetesRegion']:
                                    return KubernetesRegion
                        
                            def __new__(
                                cls,
                                arg: typing.Union[typing.Tuple['KubernetesRegion'], typing.List['KubernetesRegion']],
                            ...
                            def __getitem__(self, i: int) -> 'KubernetesRegion':
                        ...
                        class versions(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['KubernetesVersion']:
                                    return KubernetesVersion
                        
                            def __new__(
                                cls,
                                arg: typing.Union[typing.Tuple['KubernetesVersion'], typing.List['KubernetesVersion']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'versions':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'KubernetesVersion':
                                return super().__getitem__(i)
                        ...
                        class sizes(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['KubernetesSize']:
                                    return KubernetesSize
                        
                            def __new__(
                                cls,
                                arg: typing.Union[typing.Tuple['KubernetesSize'], typing.List['KubernetesSize']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'sizes':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'KubernetesSize':
                                return super().__getitem__(i)
                        __annotations__ = {
                            "regions": regions,
                            "versions": versions,
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["regions", "versions", "sizes", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["regions", "versions", "sizes", ], str]):
