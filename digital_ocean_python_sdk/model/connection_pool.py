...
class ConnectionPool(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "mode", "size", "db", "user", "connection", "private_connection", "standby_connection", "standby_private_connection", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "mode", "size", "db", "user", "connection", "private_connection", "standby_connection", "standby_private_connection", ], str]):
