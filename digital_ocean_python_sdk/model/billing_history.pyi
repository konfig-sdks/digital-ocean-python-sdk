...
class BillingHistory(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                @schemas.classproperty
                def ATTEMPT_FAILED(cls):
                    return cls("AttemptFailed")
                ...
                @schemas.classproperty
                def CREDIT_EXPIRATION(cls):
                    return cls("CreditExpiration")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "amount", "invoice_id", "invoice_uuid", "date", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "amount", "invoice_id", "invoice_uuid", "date", "type", ], str]):
