...
class AssociatedKubernetesResources(
        ...
        class properties:
            ...
            class load_balancers(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AssociatedKubernetesResource']:
                        return AssociatedKubernetesResource
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AssociatedKubernetesResource'], typing.List['AssociatedKubernetesResource']],
                ...
                def __getitem__(self, i: int) -> 'AssociatedKubernetesResource':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["load_balancers", "volumes", "volume_snapshots", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["load_balancers", "volumes", "volume_snapshots", ], str]):
