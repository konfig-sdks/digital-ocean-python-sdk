...
class SourceDatabaseSource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host", "port", "dbname", "username", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host", "port", "dbname", "username", "password", ], str]):
