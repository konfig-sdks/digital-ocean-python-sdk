...
class InvoicesListResponse(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class invoices(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['InvoicePreview']:
                                return InvoicePreview
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['InvoicePreview'], typing.List['InvoicePreview']],
                        ...
                        def __getitem__(self, i: int) -> 'InvoicePreview':
                            return super().__getitem__(i)
                
                    @staticmethod
                    def invoice_preview() -> typing.Type['InvoicePreview']:
                        return InvoicePreview
                    __annotations__ = {
                        "invoices": invoices,
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["invoice_preview"]) -> 'InvoicePreview': ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["invoices", "invoice_preview", ], str]):
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["invoice_preview"]) -> typing.Union['InvoicePreview', schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["invoices", "invoice_preview", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                invoice_preview: typing.Union['InvoicePreview', schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
