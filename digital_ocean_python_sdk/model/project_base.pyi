...
class ProjectBase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "owner_uuid", "owner_id", "name", "purpose", "environment", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "owner_uuid", "owner_id", "name", "purpose", "environment", "created_at", "updated_at", ], str]):
