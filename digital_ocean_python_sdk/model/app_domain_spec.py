...
class AppDomainSpec(
        ...
        class properties:
            ...
            class domain(
                ...
                class MetaOapg:
                    ...
                    min_length = 4
                    regex=[{
                        'pattern': r'^((xn--)?[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*\.)+[a-zA-Z]{2,}\.?$',
                    }]
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "type", "wildcard", "zone", "minimum_tls_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "type", "wildcard", "zone", "minimum_tls_version", ], str]):
