...
class CdnEndpoint(
            ...
            class ttl(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        600: "POSITIVE_600",
                        3600: "POSITIVE_3600",
                        86400: "POSITIVE_86400",
                        604800: "POSITIVE_604800",
                    }
                ...
                @schemas.classproperty
                def POSITIVE_3600(cls):
                    return cls(3600)
                
                @schemas.classproperty
                def POSITIVE_86400(cls):
                    return cls(86400)
                
                @schemas.classproperty
                def POSITIVE_604800(cls):
                    return cls(604800)
            certificate_id = schemas.UUIDSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["origin", "id", "endpoint", "ttl", "certificate_id", "custom_domain", "created_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["origin", "id", "endpoint", "ttl", "certificate_id", "custom_domain", "created_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        certificate_id: typing.Union[MetaOapg.properties.certificate_id, str, uuid.UUID, schemas.Unset] = schemas.unset,
