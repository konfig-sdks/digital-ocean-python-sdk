...
class ProductUsageCharges(
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProductChargeItem']:
                        return ProductChargeItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ProductChargeItem'], typing.List['ProductChargeItem']],
                ...
                def __getitem__(self, i: int) -> 'ProductChargeItem':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "amount", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "amount", "items", ], str]):
