...
class DropletCreate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tags() -> typing.Type['DropletCreateTags']:
                return DropletCreateTags
            region = schemas.StrSchema
        
            @staticmethod
            def ssh_keys() -> typing.Type['DropletCreateSshKeys']:
                return DropletCreateSshKeys
            backups = schemas.BoolSchema
            ipv6 = schemas.BoolSchema
            monitoring = schemas.BoolSchema
            user_data = schemas.StrSchema
            private_networking = schemas.BoolSchema
        
            @staticmethod
            def volumes() -> typing.Type['DropletCreateVolumes']:
                return DropletCreateVolumes
            vpc_uuid = schemas.StrSchema
            with_droplet_agent = schemas.BoolSchema
            __annotations__ = {
                "size": size,
                "image": image,
                "tags": tags,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'DropletCreateTags': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["region"]) -> MetaOapg.properties.region: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ssh_keys"]) -> 'DropletCreateSshKeys': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["monitoring"]) -> MetaOapg.properties.monitoring: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user_data"]) -> MetaOapg.properties.user_data: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["private_networking"]) -> MetaOapg.properties.private_networking: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["volumes"]) -> 'DropletCreateVolumes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vpc_uuid"]) -> MetaOapg.properties.vpc_uuid: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["with_droplet_agent"]) -> MetaOapg.properties.with_droplet_agent: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["size", "image", "tags", "region", "ssh_keys", "backups", "ipv6", "monitoring", "user_data", "private_networking", "volumes", "vpc_uuid", "with_droplet_agent", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> typing.Union['DropletCreateTags', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["region"]) -> typing.Union[MetaOapg.properties.region, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ssh_keys"]) -> typing.Union['DropletCreateSshKeys', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["monitoring"]) -> typing.Union[MetaOapg.properties.monitoring, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user_data"]) -> typing.Union[MetaOapg.properties.user_data, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["private_networking"]) -> typing.Union[MetaOapg.properties.private_networking, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["volumes"]) -> typing.Union['DropletCreateVolumes', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vpc_uuid"]) -> typing.Union[MetaOapg.properties.vpc_uuid, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["with_droplet_agent"]) -> typing.Union[MetaOapg.properties.with_droplet_agent, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["size", "image", "tags", "region", "ssh_keys", "backups", "ipv6", "monitoring", "user_data", "private_networking", "volumes", "vpc_uuid", "with_droplet_agent", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tags: typing.Union['DropletCreateTags', schemas.Unset] = schemas.unset,
        region: typing.Union[MetaOapg.properties.region, str, schemas.Unset] = schemas.unset,
        ssh_keys: typing.Union['DropletCreateSshKeys', schemas.Unset] = schemas.unset,
        backups: typing.Union[MetaOapg.properties.backups, bool, schemas.Unset] = schemas.unset,
        ipv6: typing.Union[MetaOapg.properties.ipv6, bool, schemas.Unset] = schemas.unset,
        monitoring: typing.Union[MetaOapg.properties.monitoring, bool, schemas.Unset] = schemas.unset,
        user_data: typing.Union[MetaOapg.properties.user_data, str, schemas.Unset] = schemas.unset,
        private_networking: typing.Union[MetaOapg.properties.private_networking, bool, schemas.Unset] = schemas.unset,
        volumes: typing.Union['DropletCreateVolumes', schemas.Unset] = schemas.unset,
        vpc_uuid: typing.Union[MetaOapg.properties.vpc_uuid, str, schemas.Unset] = schemas.unset,
        with_droplet_agent: typing.Union[MetaOapg.properties.with_droplet_agent, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'DropletCreate':
        return super().__new__(
