...
class AppDatabaseSpec(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["db_user"]) -> MetaOapg.properties.db_user: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "version", "cluster_name", "db_name", "db_user", "engine", "production", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["db_user"]) -> typing.Union[MetaOapg.properties.db_user, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "version", "cluster_name", "db_name", "db_user", "engine", "production", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        db_user: typing.Union[MetaOapg.properties.db_user, str, schemas.Unset] = schemas.unset,
        engine: typing.Union[MetaOapg.properties.engine, str, schemas.Unset] = schemas.unset,
        production: typing.Union[MetaOapg.properties.production, bool, schemas.Unset] = schemas.unset,
