...
class DatabasesListReadOnlyReplicasResponseReplicasItemPrivateConnection(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uri", "database", "host", "port", "user", "password", "ssl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uri", "database", "host", "port", "user", "password", "ssl", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ssl: typing.Union[MetaOapg.properties.ssl, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'DatabasesListReadOnlyReplicasResponseReplicasItemPrivateConnection':
