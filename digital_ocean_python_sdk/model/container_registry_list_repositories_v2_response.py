...
class ContainerRegistryListRepositoriesV2Response(
                ...
                class properties:
                    ...
                    class repositories(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['RepositoryV2']:
                                return RepositoryV2
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['RepositoryV2'], typing.List['RepositoryV2']],
                        ...
                        def __getitem__(self, i: int) -> 'RepositoryV2':
