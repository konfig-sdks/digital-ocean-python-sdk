...
class SnapshotsBase(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def regions() -> typing.Type['SnapshotsBaseRegions']:
                return SnapshotsBaseRegions
            min_disk_size = schemas.IntSchema
            size_gigabytes = schemas.Float32Schema
            __annotations__ = {
                "name": name,
    ...
    min_disk_size: MetaOapg.properties.min_disk_size
    regions: 'SnapshotsBaseRegions'
    name: MetaOapg.properties.name
    created_at: MetaOapg.properties.created_at
    size_gigabytes: MetaOapg.properties.size_gigabytes
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["regions"]) -> 'SnapshotsBaseRegions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "created_at", "regions", "min_disk_size", "size_gigabytes", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["regions"]) -> 'SnapshotsBaseRegions': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["min_disk_size"]) -> MetaOapg.properties.min_disk_size: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["size_gigabytes"]) -> MetaOapg.properties.size_gigabytes: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "created_at", "regions", "min_disk_size", "size_gigabytes", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        min_disk_size: typing.Union[MetaOapg.properties.min_disk_size, decimal.Decimal, int, ],
        regions: 'SnapshotsBaseRegions',
        name: typing.Union[MetaOapg.properties.name, str, ],
        created_at: typing.Union[MetaOapg.properties.created_at, str, datetime, ],
        size_gigabytes: typing.Union[MetaOapg.properties.size_gigabytes, decimal.Decimal, int, float, ],
