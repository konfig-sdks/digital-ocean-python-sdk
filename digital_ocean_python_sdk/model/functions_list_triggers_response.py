...
class FunctionsListTriggersResponse(
                ...
                class properties:
                    ...
                    class triggers(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['TriggerInfo']:
                                return TriggerInfo
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['TriggerInfo'], typing.List['TriggerInfo']],
                        ...
                        def __getitem__(self, i: int) -> 'TriggerInfo':
