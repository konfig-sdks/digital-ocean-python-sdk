...
class AppsAssignAppAlertDestinationsRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["emails", "slack_webhooks", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["emails", "slack_webhooks", ], str]):
