...
class TagsResourceResources(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class resource_type(
                        ...
                        @schemas.classproperty
                        def VOLUME_SNAPSHOT(cls):
                            return cls("volume_snapshot")
                    __annotations__ = {
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["resource_id", "resource_type", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resource_id", "resource_type", ], str]):
