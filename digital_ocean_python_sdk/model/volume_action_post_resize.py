...
class VolumeActionPostResize(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["size_gigabytes", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["size_gigabytes", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                size_gigabytes: typing.Union[MetaOapg.properties.size_gigabytes, decimal.Decimal, int, ],
