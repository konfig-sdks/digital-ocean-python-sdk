    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class autovacuum_freeze_max_age(
                ...
                class MetaOapg:
                    inclusive_maximum = 1500000000
                    inclusive_minimum = 200000000
            ...
            class log_line_prefix(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "pid=%p,user=%u,db=%d,app=%a,client=%h": "PIDPUSERUDBDAPPACLIENTH",
                        "%m [%p] %q[user=%u,db=%d,app=%a]": "M_P_QUSERUDBDAPPA",
                        "%t [%p]: [%l-1] user=%u,db=%d,app=%a,client=%h": "T_P_L1_USERUDBDAPPACLIENTH",
                    }
            ...
            class max_stack_depth(
                ...
                class MetaOapg:
                    inclusive_maximum = 6291456
                    inclusive_minimum = 2097152
            ...
            class pg_partman_bgw_role(
                ...
                class MetaOapg:
                    max_length = 64
                    regex=[{
                        'pattern': r'^[_A-Za-z0-9][-._A-Za-z0-9]{0,63}$',
                    }]
