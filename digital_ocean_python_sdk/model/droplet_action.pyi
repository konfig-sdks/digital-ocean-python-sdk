    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def ENABLE_BACKUPS(cls):
                    return cls("enable_backups")
                
                @schemas.classproperty
                def DISABLE_BACKUPS(cls):
                    return cls("disable_backups")
                ...
                @schemas.classproperty
                def CHANGE_KERNEL(cls):
                    return cls("change_kernel")
                
                @schemas.classproperty
                def ENABLE_IPV6(cls):
                    return cls("enable_ipv6")
