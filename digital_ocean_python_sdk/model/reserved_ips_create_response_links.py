...
class ReservedIPsCreateResponseLinks(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["droplets", "actions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["droplets", "actions", ], str]):
