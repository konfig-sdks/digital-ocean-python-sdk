...
class KafkaTopicCreate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            partitions = schemas.NumberSchema
            replication = schemas.NumberSchema
        
            @staticmethod
            def config() -> typing.Type['KafkaTopicCreateConfig']:
                return KafkaTopicCreateConfig
            __annotations__ = {
                "name": name,
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def config() -> typing.Type['KafkaTopicConfig']:
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["config"]) -> 'KafkaTopicConfig': ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["config"]) -> typing.Union['KafkaTopicConfig', schemas.Unset]: ...
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                config: typing.Union['KafkaTopicConfig', schemas.Unset] = schemas.unset,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["config"]) -> 'KafkaTopicCreateConfig': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "partitions", "replication", "config", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["config"]) -> typing.Union['KafkaTopicCreateConfig', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "partitions", "replication", "config", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        partitions: typing.Union[MetaOapg.properties.partitions, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        replication: typing.Union[MetaOapg.properties.replication, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        config: typing.Union['KafkaTopicCreateConfig', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'KafkaTopicCreate':
        return super().__new__(
