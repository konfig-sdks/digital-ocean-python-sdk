...
class AppVariableDefinition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class scope(
                ...
                @schemas.classproperty
                def RUN_AND_BUILD_TIME(cls):
                    return cls("RUN_AND_BUILD_TIME")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "scope", "type", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "scope", "type", "value", ], str]):
