...
class EventsLogs(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class event_type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "cluster_maintenance_perform": "MAINTENANCE_PERFORM",
                        "cluster_master_promotion": "MASTER_PROMOTION",
                        "cluster_create": "CREATE",
                        "cluster_update": "UPDATE",
                        "cluster_delete": "DELETE",
                        "cluster_poweron": "POWERON",
                        "cluster_poweroff": "POWEROFF",
                    }
                
                @schemas.classproperty
                def MAINTENANCE_PERFORM(cls):
                    return cls("cluster_maintenance_perform")
                
                @schemas.classproperty
                def MASTER_PROMOTION(cls):
                    return cls("cluster_master_promotion")
                
                @schemas.classproperty
                def CREATE(cls):
                    return cls("cluster_create")
                
                @schemas.classproperty
                def UPDATE(cls):
                    return cls("cluster_update")
                
                @schemas.classproperty
                def DELETE(cls):
                    return cls("cluster_delete")
                
                @schemas.classproperty
                def POWERON(cls):
                    return cls("cluster_poweron")
                
                @schemas.classproperty
                def POWEROFF(cls):
                    return cls("cluster_poweroff")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "cluster_name", "event_type", "create_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "cluster_name", "event_type", "create_time", ], str]):
