...
class BillingAddress(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            country_iso2_code = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["country_iso2_code"]) -> MetaOapg.properties.country_iso2_code: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address_line1", "address_line2", "city", "region", "postal_code", "country_iso2_code", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["country_iso2_code"]) -> typing.Union[MetaOapg.properties.country_iso2_code, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address_line1", "address_line2", "city", "region", "postal_code", "country_iso2_code", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        country_iso2_code: typing.Union[MetaOapg.properties.country_iso2_code, str, schemas.Unset] = schemas.unset,
