...
class SizesListResponse(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["sizes", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sizes", ], str]):
