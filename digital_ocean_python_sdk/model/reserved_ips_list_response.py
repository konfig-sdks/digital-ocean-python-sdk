...
class ReservedIPsListResponse(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class reserved_ips(
                        ...
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['ReservedIp'], typing.List['ReservedIp']],
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["reserved_ips", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["reserved_ips", ], str]):
