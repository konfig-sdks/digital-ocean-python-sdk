...
class ReservedIpCreate(
    ...
    class MetaOapg:
        ...
        class one_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["region", "project_id", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["region", "project_id", ], str]):
                return super().get_item_oapg(name)
