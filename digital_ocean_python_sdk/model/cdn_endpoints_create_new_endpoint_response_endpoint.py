...
class CdnEndpointsCreateNewEndpointResponseEndpoint(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            ttl = schemas.NumberSchema
            certificate_id = schemas.StrSchema
            custom_domain = schemas.StrSchema
            __annotations__ = {
                "id": id,
                "origin": origin,
                "endpoint": endpoint,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "origin", "endpoint", "created_at", "ttl", "certificate_id", "custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "origin", "endpoint", "created_at", "ttl", "certificate_id", "custom_domain", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ttl: typing.Union[MetaOapg.properties.ttl, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        certificate_id: typing.Union[MetaOapg.properties.certificate_id, str, schemas.Unset] = schemas.unset,
        custom_domain: typing.Union[MetaOapg.properties.custom_domain, str, schemas.Unset] = schemas.unset,
