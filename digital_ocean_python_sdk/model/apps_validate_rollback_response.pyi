...
class AppsValidateRollbackResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class warnings(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AppRollbackValidationCondition']:
                        return AppRollbackValidationCondition
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AppRollbackValidationCondition'], typing.List['AppRollbackValidationCondition']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'warnings':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AppRollbackValidationCondition':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["valid", "error", "warnings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["valid", "error", "warnings", ], str]):
