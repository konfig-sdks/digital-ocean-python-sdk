...
from digital_ocean_python_sdk.exceptions_base import ApiValueError
from digital_ocean_python_sdk.exceptions import ClientConfigurationError
from digital_ocean_python_sdk.exceptions import InvalidHostConfigurationError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.digitalocean.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("digital_ocean_python_sdk")
